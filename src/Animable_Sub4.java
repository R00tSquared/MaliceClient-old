...
final class Animable_Sub4 extends Animable
{
	...
	public Model getRotatedModel()
	{
		...
		if (model == null)
			return null;
		Animation animDef = aSpotAnim_1592.animDef;
		int j = animDef != null ? animDef.getFrame(anInt1593):-1;//;//animDef != null ? animDef.anIntArray353[anInt1593]:-1;
		//if (j != -1 && Skeleton.get(animDef.anIntArray353[0]) == null)
		//	return null;
		...
		model_1.method479(64 + aSpotAnim_1592.anInt413, 850 + aSpotAnim_1592.anInt414, -30, -50, -30, true, false);
		return model_1;
	}
	...
	{
		aBoolean1579 = false;
		aSpotAnim_1592 = StillGraphics.get(l2);
		anInt1597 = k1;
		anInt1580 = j2;
		anInt1581 = i2;
		anInt1582 = l1;
	...
	public void method456(int i)
	{
		...
		if (aSpotAnim_1592.animDef != null)
			for (anInt1594 += i; anInt1594 > aSpotAnim_1592.animDef.method258(anInt1593);)
			{
				anInt1594 -= aSpotAnim_1592.animDef.method258(anInt1593) + 1;
				anInt1593++;
				if (anInt1593 >= aSpotAnim_1592.animDef.anInt352)
					anInt1593 = 0;
			}
	}
	...
	private final StillGraphics aSpotAnim_1592;
