...
public class Client extends RSApplet {
	...
	private String getTitle(int title) {
		switch (title) {
		case 2:
			return "@or1@Old School@whi@ ";
		case 3:
			return "@or2@Iron Man@whi@ ";
		case 4:
			return "@or3@Ultimate Iron Man@whi@ ";
		}
		return "";
	}

	public boolean isBank(int npcType) {
		switch (npcType) {
		case 495:
		case 497:
		case 2568:
	...
	public boolean isGE(int npcType) {
		switch (npcType) {
		case 2593:
		case 2241:
		case 2240:
	...
	private void loadCustomObjectSpawns() {// TODO check if in area before
											// loading object spawns
		/*
		 * for (int i = 0; i < 4; i++) addObject(3107 + i, 3509, 1631, 1, 0, 0);
		 * for (int i = 0; i < 4; i++) addObject(3107 + i, 3518, 1631, 3, 0, 0);
		 * for (int i = 0; i < 8; i++) addObject(3106, 3517 - i, 1631, 2, 0, 0);
		 */

		addObject(3107, 3509, 3045, 0, 10, 0);
		addObject(3110, 3509, 3045, 0, 10, 0);

		addObject(3106, 3510, 3045, 1, 10, 0);
		addObject(3106, 3511, 3045, 1, 10, 0);
		addObject(3106, 3512, 3045, 1, 10, 0);
		addObject(3106, 3515, 3045, 1, 10, 0);
		addObject(3106, 3516, 3045, 1, 10, 0);
		addObject(3106, 3517, 3045, 1, 10, 0);

		addObject(3107, 3518, 3045, 2, 10, 0);
		addObject(3110, 3518, 3045, 2, 10, 0);

		addObject(3108, 3509, 45238, 0, 10, 0);

		addObject(3106, 3513, 45238, 1, 10, 0);

		addObject(3108, 3518, 45238, 2, 10, 0);

		addObject(3111, 3513, 3045, 3, 10, 0);
		addObject(3111, 3514, 3045, 3, 10, 0);
		// front booths
		addObject(3111, 3517, 36787, 1, 10, 0);
		addObject(3111, 3516, 36787, 1, 10, 0);
		addObject(3111, 3515, 36787, 1, 10, 0);
		addObject(3111, 3512, 36787, 1, 10, 0);
		addObject(3111, 3511, 36787, 1, 10, 0);
		addObject(3111, 3510, 36787, 1, 10, 0);
		// corners
		addObject(3106, 3509, 8955, 0, 10, 0);
		addObject(3106, 3518, 8955, 0, 10, 0);
		addObject(3111, 3509, 8955, 0, 10, 0);
		addObject(3111, 3518, 8955, 0, 10, 0);
		// fence 23849
		/*
		 * for (int i = 0; i < 5; i++) addObject(3107 + i, 3509, 23849, 1, 0,
		 * 0); for (int i = 0; i < 5; i++) addObject(3107 + i, 3518, 23849, 3,
		 * 0, 0); for (int i = 0; i < 8; i++) addObject(3106, 3517 - i, 23849,
		 * 2, 0, 0); for (int i = 0; i < 8; i++) addObject(3112, 3517 - i,
		 * 23849, 0, 0, 0);
		 */

		// addObject(3107, 3509, 30212, 1, 10, 0);

		// objects inside
		addObject(3108, 3516, -1, 2, 10, 0);// desk spot
		addObject(3108, 3511, -1, 0, 10, 0);// desk spot
		addObject(3108, 3513, 375, 2, 10, 0);
		addObject(3109, 3513, 375, 2, 10, 0);
		addObject(3108, 3514, 354, 2, 10, 0);
		addObject(3109, 3514, 355, 2, 10, 0);

		// remove invisible obj and flowses/rocks
		addObject(3105, 3503, -1, -1, 10, 0);
		addObject(3106, 3503, -1, -1, 10, 0);
		addObject(3093, 3506, -1, -1, 10, 0);
		addObject(3096, 3506, -1, -1, 10, 0);
		addObject(3097, 3506, -1, -1, 10, 0);
		addObject(3098, 3506, -1, -1, 10, 0);
		addObject(3089, 3505, -1, -1, 10, 0);
		addObject(3108, 3508, -1, -1, 10, 0);
		addObject(3110, 3508, -1, -1, 10, 0);
		addObject(3104, 3511, -1, -1, 10, 0);
		addObject(3112, 3518, 1189, -1, 11, 0);
		addObject(3112, 3517, 1187, -1, 11, 0);
		addObject(3112, 3516, 1197, -1, 11, 0);
		addObject(3112, 3515, 436, -1, 11, 0);
		addObject(3112, 3512, 439, -1, 11, 0);
		addObject(3112, 3511, 1188, -1, 11, 0);
		addObject(3112, 3510, 1187, -1, 11, 0);
		addObject(3112, 3509, 1189, -1, 11, 0);

		// missing edgeville walls

		addObject(3095, 3500, 1632, 3, 0, 0);
		// addObject(3095, 3499, 9556, 1, 0, 0);

		addObject(3092, 3506, 1631, 1, 0, 0);
		addObject(3099, 3506, 1631, 1, 0, 0);
		addObject(3090, 3507, 1631, 2, 0, 0);
		addObject(3091, 3506, 1631, 1, 0, 0);
		addObject(3090, 3506, 1631, 1, 3, 0);// corner type
		addObject(3091, 3507, 9839, -1, 10, 0);

		addObject(3213, 3261, -1, -1, 0, 0);
		addObject(3213, 3262, -1, -1, 0, 0);

		// addObject(3088, 3517, 38786, 0, 10, 0);

	}

	public void clearPlayersInterface() {
		for (int i = 8145; i < 8348; i++) {
			sendFrame126("", (i < 8196) ? i : i + 3978);
		}
	};
	...
	public Sprite[] combatIcons = new Sprite[15];
	...
	public static boolean npcDataOn = false;
	public static String lastInput = "N/A";
	...
	public void repackCacheIndex(int cacheIndex) {
		...
		try {
			for (int index = 0; index < indexLength; index++) {
				if(getFileNameWithoutExtension(file[index].toString()).equalsIgnoreCase("gzip"))
						continue;
	...
	public static boolean GEBuyEnabled = true;
	public static boolean GESearchVisible = false;
	public boolean GEneedsupdate;
	public static boolean giantMode = false;
	...
	public void itemSearch(String n) {
		...
		label0: for (int id = 0; id < ItemDef.totalItems; id++) {
			...
			Boolean acceptable;
			if (searchGE)
				acceptable = item.lendTemplateID <= 0
						&& !item.name.toLowerCase().contains("coin")
						&& !item.name.toLowerCase().contains("cash")
						&& !item.name.toLowerCase().contains("cash")
						&& !item.name.toLowerCase().contains("clue")
						&& !item.name.toLowerCase().contains("casket")
						&& !invalidItem(item.modelID + item.name);
			else
				acceptable = (item.acceptable() && item.lendTemplateID <= 0);
			for (int idx = 0; idx < totalResults; idx++)
				if (result.indexOf(searchParts[idx]) == -1 || !acceptable)
					continue label0;
			itemResultNames[totalItemResults] = (Configuration.displayGEItemIds ? itemResultIDs[totalItemResults]
					+ " - "
					: "")
					+ result;
	...
	HashMap<String, Boolean> usedModels = new HashMap<String, Boolean>();

	public boolean invalidItem(String data) {
		if (usedModels.get(data) != null)
			return true;
		else
			usedModels.put(data, true);
		return false;
	}

	public boolean displayScrollbar;
	public Sprite originalChatArea;
	public boolean searchGE = false;

	public void displayItemSearch(Boolean type) {
		try {
			searchGE = type;
			currentSpawnEnter = -1;
			currentSpawn = -1;
			...
			amountOrNameInput = "";
			// GEBuyEnabled = true;
			GESearchVisible = true;

			DrawingArea.setDrawingArea(121, 8, 512, 7);

			chatArea = new Sprite("Interfaces/GrandExchange/buyback");
			// .drawSprite(18, 18);
	...
	public void searchOver() {
		totalItemResults = 0;
		amountOrNameInput = "";
		GESearchVisible = false;
		chatArea = originalChatArea;
	}

	/*
	 * private void buildItemSearch(int mouseY) { int y = 0; for (int idx = 0;
	 * idx < 100; idx++) { if (amountOrNameInput.length() == 0 ||
	 * amountOrNameInput == "" || totalItemResults == 0) return; String name =
	 * capitalizeFirstChar(itemResultNames[idx]); for (int i = 0; i <= 20; i++)
	 * if (name.contains(" <img=" + i + ">")) name = name.replaceAll(" <img=" +
	 * i + ">", ""); int textY = (21 + y * 14) - itemResultScrollPos; if (mouseY
	 * > textY - 14 && mouseY <= textY && super.mouseX > 74 && super.mouseX <
	 * 495) { //if (myPrivilege >= 1) { menuActionName[1] = "@red@Spawn" + name;
	 * menuActionID[1] = 1250; menuActionRow = 2; //}
	 * /*menuActionName[menuActionRow] = "Info" + name;
	 * menuActionID[menuActionRow] = 1250; menuActionRow++; } y++; } }
	 */

	public void drawClose(int x, int y, int x2, int y2, int x3, int y3) {
		/*
		 * close[0].drawSprite(x, y);//normal if (super.mouseX >= x2 &&
		 * super.mouseX <= x3 && super.mouseY >= y2 && super.mouseY <= y3) {
		 * close[1].drawSprite(x, y);//hover }
		 */
	}

	public void drawOnBankInterface() {
		if (RSInterface.interfaceCache[27003].message.equalsIgnoreCase("1")) {
			displayItemSearch(false);
			RSInterface.interfaceCache[27003].message = "0";
			return;
		}
		// try {
		if (openInterfaceID == 5292
				&& RSInterface.interfaceCache[27000].message.equals("1")) {// Sent
																			...
																			// tabs
			int tabs = Integer
					.parseInt(RSInterface.interfaceCache[27001].message);// # of
																			// tabs
																			// used
			int tab = Integer
			...
			for (int i = 0; i <= tabs; i++) {
				RSInterface.interfaceCache[22025 + i].disabledSprite = new Sprite(
						"Bank/TAB 3");
				RSInterface.interfaceCache[22025 + i].tooltip = "Click here to select tab "
						+ (int) (i + 1);
			}
			for (int i = tabs + 1; i <= 8; i++) {
				RSInterface.interfaceCache[22024 + i].disabledSprite = new Sprite(
						"");
				RSInterface.interfaceCache[22024 + i].tooltip = "";
			}
			if (tabs != 8) {
				RSInterface.interfaceCache[22025 + tabs].disabledSprite = new Sprite(
						"Bank/TAB 4");
				RSInterface.interfaceCache[22025 + tabs].tooltip = "Drag an item here to create a new tab";
			}
			// System.out.println(tab);
			if (tab == -1)// searching
				RSInterface.interfaceCache[22024].disabledSprite = new Sprite(
						"Bank/TAB 1");
			else if (tab > 0) {
				RSInterface.interfaceCache[22024 + tab].disabledSprite = new Sprite(
						"Bank/TAB 2");
				RSInterface.interfaceCache[22024].disabledSprite = new Sprite(
						"Bank/TAB 1");
			} else
	...
	public void drawOnGEInterfaces() {// for item state / item progress bar
		try {
			if (openInterfaceID == 16000
					&& !RSInterface.interfaceCache[12009].message.equals("0")) {
				if (RSInterface.interfaceCache[12009].message.equals("5")) {
					displayItemSearch(true);
				} else if (RSInterface.interfaceCache[12009].message
						.equals("6")) {
					searchOver();
				}
				RSInterface.interfaceCache[12009].message = "0";
			}
		} catch (Exception e) {
			// do w.e
		}
		if (Client.openInterfaceID == 16000
				&& !RSInterface.interfaceCache[12008].message.equals("0")) {
			if (RSInterface.interfaceCache[12009].message.equals("6")) {
				searchOver();
				RSInterface.interfaceCache[12009].message = "0";
			}
			/* Check if in progress - has abort option ? */
			try {
				if (RSInterface.interfaceCache[12008].message.equals("1")) {
					int percent = Integer
							.parseInt(RSInterface.interfaceCache[12001].message);
					int bId = 2;
					if (percent != -1 && percent != 100) {
						RSInterface.interfaceCache[18077].disabledSprite = new Sprite(
								"Interfaces/GrandExchange/btn 0");
						RSInterface.interfaceCache[18077].width = 20;
					} else {
						RSInterface.interfaceCache[18077].disabledSprite = new Sprite(
								"");
						RSInterface.interfaceCache[18077].width = 0;
					}
					if (percent == -1)
						bId = 0;
					else if (percent < 100)
						bId = 1;
					RSInterface.interfaceCache[18082].disabledSprite = new Sprite(
							"Interfaces/GrandExchange/Bbar " + bId);
					if (percent > -1)
						RSInterface.interfaceCache[18082].disabledSprite.myWidth = (int) (percent * 3.07);

					for (int x = 1; x < 4; x++) {
						RSInterface.interfaceCache[16700 + (4 * x)].disabledSprite = new Sprite(
								"" + 0);
						RSInterface.interfaceCache[16700 + (4 * x)].width = 0;
					}
					for (int x = 16; x < 31 && x != 25; x++) {
						RSInterface.interfaceCache[16700 + x].disabledSprite = new Sprite(
								"" + 0);
						RSInterface.interfaceCache[16700 + x].width = 0;
					}
					RSInterface.interfaceCache[16703].disabledSprite = new Sprite(
							"" + 0);
					RSInterface.interfaceCache[16703].width = 0;
					RSInterface.interfaceCache[16729].disabledSprite = new Sprite(
							"" + 0);
					RSInterface.interfaceCache[16729].width = 0;
					RSInterface.interfaceCache[16728].disabledSprite = new Sprite(
							"" + 0);
					RSInterface.interfaceCache[16728].width = 0;
					RSInterface.interfaceCache[16730].disabledSprite = new Sprite(
							"" + 0);
					RSInterface.interfaceCache[16730].width = 0;
					RSInterface.interfaceCache[18074].disabledSprite = new Sprite(
							"Interfaces/GrandExchange/tab " + 2);
					RSInterface.interfaceCache[16740].disabledSprite = new Sprite(
							"" + 0);
					RSInterface.interfaceCache[16740].width = 0;
					RSInterface.interfaceCache[16742].disabledSprite = new Sprite(
							"" + 0);
					RSInterface.interfaceCache[16742].width = 0;
					RSInterface.interfaceCache[16773].width = 0;
					RSInterface.interfaceCache[16727].message = "";
					RSInterface.interfaceCache[16707].message = "";
					RSInterface.interfaceCache[16711].message = "";
					RSInterface.interfaceCache[16715].message = "";
					RSInterface.interfaceCache[16752].message = "";
					RSInterface.interfaceCache[16755].message = "";
					RSInterface.interfaceCache[16763].message = "";
					RSInterface.interfaceCache[16760].message = "";

				} else {

					RSInterface.interfaceCache[18082].disabledSprite = new Sprite(
							"" + 0);
					RSInterface.interfaceCache[18082].width = 0;
					RSInterface.interfaceCache[18077].disabledSprite = new Sprite(
							"" + 0);
					RSInterface.interfaceCache[18077].width = 0;
					RSInterface.interfaceCache[18074].disabledSprite = new Sprite(
							"" + 0);
					RSInterface.interfaceCache[16703].disabledSprite = new Sprite(
							"Interfaces/GrandExchange/GrandExchangeOffer/1152");
					RSInterface.interfaceCache[16703].width = 13;
					RSInterface.interfaceCache[16729].disabledSprite = new Sprite(
							"Interfaces/GrandExchange/GrandExchangeOffer/1152");
					RSInterface.interfaceCache[16729].width = 13;
					RSInterface.interfaceCache[16728].disabledSprite = new Sprite(
							"Interfaces/GrandExchange/GrandExchangeOffer/1153");
					RSInterface.interfaceCache[16728].width = 13;
					RSInterface.interfaceCache[16730].disabledSprite = new Sprite(
							"Interfaces/GrandExchange/GrandExchangeOffer/1153");
					RSInterface.interfaceCache[16730].width = 13;
					RSInterface.interfaceCache[16740].disabledSprite = new Sprite(
							"Interfaces/GrandExchange/GrandExchangeOffer/setprice");
					RSInterface.interfaceCache[16740].width = 35;
					RSInterface.interfaceCache[16742].disabledSprite = new Sprite(
							"Interfaces/GrandExchange/GrandExchangeOffer/Confirm");
					RSInterface.interfaceCache[16742].width = 120;
					RSInterface.interfaceCache[16773].width = 40;
					for (int x = 1; x < 4; x++) {
						RSInterface.interfaceCache[16700 + (4 * x)].disabledSprite = new Sprite(
								"Interfaces/GrandExchange/GrandExchangeOffer/1146");
						RSInterface.interfaceCache[16700 + (4 * x)].width = 35;
					}
					for (int x = 16; x < 25 && x != 25; x++) {
						RSInterface.interfaceCache[16700 + x].disabledSprite = new Sprite(
								"Interfaces/GrandExchange/GrandExchangeOffer/1146");
						RSInterface.interfaceCache[16700 + x].width = 35;
					}
					RSInterface.interfaceCache[16727].message = "   +1";
					RSInterface.interfaceCache[16707].message = "  +10";
					RSInterface.interfaceCache[16711].message = "  +100";
					RSInterface.interfaceCache[16715].message = "    +1k";
					RSInterface.interfaceCache[16752].message = "      ...";
					RSInterface.interfaceCache[16755].message = "-5%";
					RSInterface.interfaceCache[16763].message = "+5%";
					RSInterface.interfaceCache[16760].message = "   ...";
				}
				RSInterface.interfaceCache[12008].message = "0";
			} catch (Exception e) {
				// do w.e
			}
		}
		if (Client.openInterfaceID == 18000 && GESearchVisible) {
			searchOver();
		}
		if (Client.openInterfaceID == 18000
				&& !RSInterface.interfaceCache[12010].message.equals("0")) {
			/* Check if in progress - has abort option ? */
			try {
				if (RSInterface.interfaceCache[12010].message.equals("1")) {
					...
					for (int x = 1; x < 4; x++) {
						RSInterface.interfaceCache[18000 + (4 * x)].disabledSprite = new Sprite(
								"" + 0);
						RSInterface.interfaceCache[18000 + (4 * x)].width = 0;
					}
					for (int x = 16; x < 31 && x != 25; x++) {
						RSInterface.interfaceCache[18000 + x].disabledSprite = new Sprite(
								"" + 0);
						RSInterface.interfaceCache[18000 + x].width = 0;
					}
					RSInterface.interfaceCache[18003].disabledSprite = new Sprite(
							"" + 0);
					RSInterface.interfaceCache[18003].width = 0;
					RSInterface.interfaceCache[18029].disabledSprite = new Sprite(
							"" + 0);
					RSInterface.interfaceCache[18029].width = 0;
					RSInterface.interfaceCache[18028].disabledSprite = new Sprite(
							"" + 0);
					RSInterface.interfaceCache[18028].width = 0;
					RSInterface.interfaceCache[18030].disabledSprite = new Sprite(
							"" + 0);
					RSInterface.interfaceCache[18030].width = 0;
					RSInterface.interfaceCache[18074].disabledSprite = new Sprite(
							"Interfaces/GrandExchange/tab " + 2);
					RSInterface.interfaceCache[18040].disabledSprite = new Sprite(
							"" + 0);
					RSInterface.interfaceCache[18040].width = 0;
					RSInterface.interfaceCache[18042].disabledSprite = new Sprite(
							"" + 0);
					RSInterface.interfaceCache[18042].width = 0;
					RSInterface.interfaceCache[18027].message = "";
					RSInterface.interfaceCache[18007].message = "";
					RSInterface.interfaceCache[18011].message = "";
					RSInterface.interfaceCache[18015].message = "";
					RSInterface.interfaceCache[18052].message = "";
					RSInterface.interfaceCache[18055].message = "";
					RSInterface.interfaceCache[18063].message = "";
					RSInterface.interfaceCache[18060].message = "";
				} else {
					...
					RSInterface.interfaceCache[18003].disabledSprite = new Sprite(
							"Interfaces/GrandExchange/GrandExchangeOffer/1152");
					RSInterface.interfaceCache[18003].width = 13;
					RSInterface.interfaceCache[18029].disabledSprite = new Sprite(
							"Interfaces/GrandExchange/GrandExchangeOffer/1152");
					RSInterface.interfaceCache[18029].width = 13;
					RSInterface.interfaceCache[18028].disabledSprite = new Sprite(
							"Interfaces/GrandExchange/GrandExchangeOffer/1153");
					RSInterface.interfaceCache[18028].width = 13;
					RSInterface.interfaceCache[18030].disabledSprite = new Sprite(
							"Interfaces/GrandExchange/GrandExchangeOffer/1153");
					RSInterface.interfaceCache[18030].width = 13;
					RSInterface.interfaceCache[18040].disabledSprite = new Sprite(
							"Interfaces/GrandExchange/GrandExchangeOffer/setprice");
					RSInterface.interfaceCache[18040].width = 35;
					RSInterface.interfaceCache[18042].disabledSprite = new Sprite(
							"Interfaces/GrandExchange/GrandExchangeOffer/Confirm");
					RSInterface.interfaceCache[18042].width = 120;
					for (int x = 1; x < 4; x++) {
						RSInterface.interfaceCache[18000 + (4 * x)].disabledSprite = new Sprite(
								"Interfaces/GrandExchange/GrandExchangeOffer/1146");
						RSInterface.interfaceCache[18000 + (4 * x)].width = 35;
					}
					for (int x = 16; x < 25 && x != 25; x++) {
						RSInterface.interfaceCache[18000 + x].disabledSprite = new Sprite(
								"Interfaces/GrandExchange/GrandExchangeOffer/1146");
						RSInterface.interfaceCache[18000 + x].width = 35;
					}
					RSInterface.interfaceCache[18027].message = "    1";
					RSInterface.interfaceCache[18007].message = "   10";
					RSInterface.interfaceCache[18011].message = "   100";
					RSInterface.interfaceCache[18015].message = "    ALL";
					RSInterface.interfaceCache[18052].message = "      ...";
					RSInterface.interfaceCache[18055].message = "-5%";
					RSInterface.interfaceCache[18063].message = "+5%";
					RSInterface.interfaceCache[18060].message = "   ...";
				}
				RSInterface.interfaceCache[12010].message = "0";
			} catch (Exception e) {
				// do w.e
			}
		}
		if (openInterfaceID != 35000
				|| RSInterface.interfaceCache[12011].message.equals("0"))
			return;
		for (int x = 0; x < 6; x++) {
			try {
				int y = 0;
				if (x == 1)
					...
					y = 15;
				int itmid = Integer
						.parseInt(RSInterface.interfaceCache[12012 + x].message);
				if (itmid > 0) {
					/* Hide Buy/Sell Sprites */
					RSInterface.interfaceCache[35012 + (3 * x)].disabledSprite = new Sprite(
							"" + 0);
					RSInterface.interfaceCache[35012 + (3 * x)].width = 0;
					RSInterface.interfaceCache[35030 + y].disabledSprite = new Sprite(
							"" + 0);
					RSInterface.interfaceCache[35030 + y].width = 0;
					/* Show Item Sprites */
					RSInterface.interfaceCache[35048 + (3 * x)].disabledSprite = new Sprite(
							"Interfaces/GrandExchange/tab " + 0);
					RSInterface.interfaceCache[35048 + (3 * x)].width = 140;

					/* Show Progress Bar */
					int percent = Integer
							.parseInt(RSInterface.interfaceCache[12018 + x].message);
					...
					if (percent == -1)
						...
						bId = 1;
					RSInterface.interfaceCache[35068 + x].disabledSprite = new Sprite(
							"Interfaces/GrandExchange/bar " + bId);
					if (percent > -1)
						RSInterface.interfaceCache[35068 + x].disabledSprite.myWidth = (int) (percent * 1.24);

					/*
					 * System.out.println("Yeah, at " + x + " item # " + itmid +
					 * " isn't empty. :)");
					 */
				} else {
					/* Hide Item Sprites */
					RSInterface.interfaceCache[35048 + (3 * x)].disabledSprite = new Sprite(
							"" + 0);
					RSInterface.interfaceCache[35048 + (3 * x)].width = 0;// item
																			// thing
					RSInterface.interfaceCache[35068 + x].disabledSprite = new Sprite(
							"" + 0);
					/* Show Buy/Sell Sprites */
					RSInterface.interfaceCache[35012 + (3 * x)].disabledSprite = new Sprite(
							"Interfaces/GrandExchange/new " + 2);
					RSInterface.interfaceCache[35012 + (3 * x)].width = 50;
					RSInterface.interfaceCache[35030 + y].disabledSprite = new Sprite(
							"Interfaces/GrandExchange/new " + 3);
					RSInterface.interfaceCache[35030 + y].width = 50;
				}
			} catch (Exception e) {
				// do w.e
			}
		}
		RSInterface.interfaceCache[12011].message = "0";// GE has updated
	}
	...
	public int prayerInterfaceType = 22500;
	...
	public void setDetails() {
		...
		try {
			...
			saveValue(details, "server", getServer(), true);
	...
	public boolean[] orbToggle = new boolean[2];
	...
	private void handleQuickAidsActive() {
		if (prayerInterfaceType == 5608) {
			...
			if (getQuickCursesSet() > 0) {
				if (!orbToggle[1]) {
					// System.out.println("togling quickprayers");
					for (int i = 0; i < quickCurses.length; i++) {
						if (quickCurses[i] == 1) {
					...
					turnOffCurses();
					// System.out.println("turning of curses");
				}
				orbToggle[1] = !orbToggle[1];
			} else {
				if (orbToggle[1]) {
					// System.out.println("turning off yuor curses");
					turnOffCurses();
					orbToggle[1] = false;
				} else {
	...
	public void togglePrayerState(int button) {
		...
		if (prayerInterfaceType == 5608) {
			if (getOrbValues(1, null)[1] >= prayerLevelRequirements[index]) {
				...
				pushMessage("You need a Prayer level of at least "
	...
	public static int zoomUpdate = 0;
	...
	public static boolean GFXEffects = true;
	private Sprite HPBarFull;
	private Sprite restIcon;
	...
	static Preferences prefs = Preferences.userRoot().node("Client");

	public void writeSettings() {
		refreshSettings();
		prefs.putBoolean("rememberMe", rememberMe);
		prefs.put("myUsername", myUsername);
		prefs.put("myPassword", myPassword);
		prefs.putBoolean("headhp", headhp);
		prefs.putBoolean("headname", headname);
		prefs.putBoolean("sky", sky);
		prefs.putBoolean("GFXEffects", GFXEffects);
		prefs.putBoolean("customCursor", customCursor);
		prefs.putBoolean("HPBarToggle", HPBarToggle);
		prefs.putBoolean("newDamage", newDamage);
		prefs.put("chatColorHex", chatColorHex);
		prefs.putInt("Zoom", Zoom);
		prefs.putBoolean("highDetail", highDetail);
		prefs.putInt("currentTheme", Configuration.currentTheme);
	}

	public void readSettings() {
		rememberMe = prefs.getBoolean("rememberMe", rememberMe);
		myUsername = prefs.get("myUsername", myUsername);
		myPassword = prefs.get("myPassword", myPassword);
		headhp = prefs.getBoolean("headhp", headhp);
		headname = prefs.getBoolean("headname", headname);
		sky = prefs.getBoolean("sky", sky);
		GFXEffects = prefs.getBoolean("GFXEffects", GFXEffects);
		customCursor = prefs.getBoolean("customCursor", customCursor);
		HPBarToggle = prefs.getBoolean("HPBarToggle", HPBarToggle);
		newDamage = prefs.getBoolean("newDamage", newDamage);
		chatColorHex = prefs.get("chatColorHex", chatColorHex);
		Zoom = prefs.getInt("Zoom", Zoom);
		highDetail = prefs.getBoolean("highDetail", highDetail);
		Configuration.currentTheme = prefs.getInt("currentTheme",
				Configuration.currentTheme);
		Configuration.themeIndex = Configuration.currentTheme;
		refreshThemes(false);
	}

	public float lastPercent;

	public void drawSmoothLoadingText(int i, String s) {
	...
	public void switchGameframe(int revision) {
		if (revision == 474) {
			tabArea = new Sprite("GameFrame/tabarea2");
			needDrawTabArea = true;
			aBoolean1233 = true;
			is474 = true;
			is554 = false;
			...
			is554 = true;
			drawRedStones();
			tabArea = new Sprite("GameFrame/tabarea3");
			is474 = false;
			is483 = false;
			gameFrame554 = true;
			if (isFullScreen && extraWidth >= 237)
	...
	public void updateOrb() {
		if (isFullScreen) {
			...
			sumhover = new Sprite("GameFrame/Orbs/sumhoverFull");
			sumnormal = new Sprite("GameFrame/Orbs/sumnormalFull");
		} else {
	...
	public int loadedSprite = 0;

	public void drawHPOrb() {
		int drawOffsetX = 1;
		int drawOffsetY = 1;
		// String OrbDirectory = Sprite.getSpriteLocation("GameFrame/Orbs/");
		...
		int x = isFullScreen ? 363 + 1 + extraWidth : 0 + 1;
		int y = isFullScreen ? +32 + 2 : 0 + 2;

		int xPos = isFullScreen ? 387 + 1 + extraWidth : 0 + 1;
		int xPosTXT = isFullScreen ? 335 + 1 + extraWidth : 0 + 1;
		int yPos = isFullScreen ? +32 + 2 : 0 + 2;
		// this can be done right though
		// orbFill = new Sprite(OrbDirectory + "Orb 2.PNG", 27,
		// getOrbFill(health));
		orbFill.myHeight = getOrbFill(health);
		/* Draws empty orb */
		emptyOrb.drawAdvancedSprite(170 + x, 13 + y);
		...
		hitPointsFill.drawAdvancedSprite(173 + xPos, 16 + yPos);
		orbFill.drawAdvancedSprite(173 + xPos, 16 + yPos);
		/* Draws inside orb sprites */
		if (i <= 20) {
			if (loopCycle % 20 < 10) {
				hitPointsIcon.drawAdvancedSprite(179 + xPos, 23 + yPos);
			}
		} else {
			hitPointsIcon.drawAdvancedSprite(179 + xPos, 23 + yPos);
		}
	...
	public void drawPrayerOrb() {
		...
		// orbFill = new Sprite(OrbDirectory + "Orb 2.PNG", 27,
		// getOrbFill(prayer));
		orbFill.myHeight = getOrbFill(prayer);
		emptyOrb.drawAdvancedSprite(186 + 1 + x, 49 + 4 + y);
		if (prayer <= 999999 && prayer >= 75) {
			smallText.method382(65280, 229 + 1 + xPosTXT, cP, 75 + 4 + yPos,
					true);
		} else if (prayer <= 74 && prayer >= 50) {
			smallText.method382(0xffff00, 229 + 1 + xPosTXT, cP, 75 + 4 + yPos,
					true);
		} else if (prayer <= 49 && prayer >= 25) {
			smallText.method382(0xfca607, 229 + 1 + xPosTXT, cP, 75 + 4 + yPos,
					true);
		} else if (prayer <= 24 && prayer >= 0) {
			smallText.method382(0xf50d0d, 229 + 1 + xPosTXT, cP, 75 + 4 + yPos,
					true);
		}
		if (!quickPrayerClicked)
			prayerFill.drawAdvancedSprite(189 + 1 + xPos, 52 + 4 + yPos);
		else
			prayerFill2.drawAdvancedSprite(189 + 1 + xPos, 52 + 4 + yPos);
		orbFill.drawAdvancedSprite(189 + 1 + xPos, 52 + 3 + yPos);
		if (prayer <= 25) {
			if (loopCycle % 20 < 10) {
				prayerIcon.drawAdvancedSprite(193 + xPos, 56 + 4 + yPos);
			}
		} else {
			prayerIcon.drawAdvancedSprite(193 + xPos, 56 + 4 + yPos);
		}
		if (super.mouseX > 703 + 1 + x2 && super.mouseX < 765 + 1 + x2
				&& super.mouseY > 45 + 4 + y2 && super.mouseY < 80 + 4 + y2) {
			hoveredEmpty.drawAdvancedSprite(185 + 1 + x, 49 + 4 + y);
		}
	}
	...
	public void drawRunOrb() {
		...
		try {
			runClicked = RSInterface.interfaceCache[2101].message.equals("1");
		} catch (Exception e) {
			runClicked = false;
		}
		Sprite orb = (runClicked ? runOrb2 : runOrb1);
		Sprite icon = (runClicked ? runIcon2 : runIcon1);
		int x = isFullScreen ? drawOffsetX + 356 + extraWidth : drawOffsetX + 0;
		int y = isFullScreen ? drawOffsetY + 30 : drawOffsetY + 0;

		int x2 = isFullScreen ? extraWidth - 158 : 0;
		int y2 = isFullScreen ? +34 : 0;

		int xPos = isFullScreen ? drawOffsetX + 385 + extraWidth - 5
				: drawOffsetX + 0;
		int xPosTXT = isFullScreen ? drawOffsetX + 332 + extraWidth - 5
				: drawOffsetX + 0;
		int yPos = isFullScreen ? drawOffsetY + 30 : drawOffsetY + 0;

		String rP = RSInterface.interfaceCache[149].message;
		rP = rP.replaceAll("%", "");

		emptyOrb.drawAdvancedSprite(185 + 2 + x, 85 + 8 + y);
		orb.drawAdvancedSprite(188 + 2 + xPos, 88 + 8 + yPos);

		if (!resting)
			icon.drawAdvancedSprite(195 + 2 + xPos, 93 + 8 + yPos);
		else
			restIcon.drawAdvancedSprite(194 + 2 + xPos, 93 + 8 + yPos);

		int colour;
		colour = 65280;
		smallText
				.method382(colour, 228 + 2 + xPosTXT, rP, 111 + 8 + yPos, true);
		if (super.mouseX > 703 + 2 + x2 && super.mouseX < 765 + 2 + x2
				&& super.mouseY > 83 + 7 + y2 && super.mouseY < 118 + 8 + y2) {
			hoveredEmpty.drawAdvancedSprite(185 + 4 + x - 2, 85 + 8 + y);
		}
	}
	...
	public void drawSumm() {
		...
		int y = isFullScreen ? +34 : 0;
		int x2 = isFullScreen ? extraWidth - 127 : 0;
		int y2 = isFullScreen ? +38 : 0;
		int xPos = isFullScreen ? 389 + extraWidth - 5 : 0;
		int yPos = isFullScreen ? +32 : 0;
		int sum = 1;// Integer.parseInt(RSInterface.interfaceCache[29801].message);

		if (isFullScreen) {
			sumnormal.drawAdvancedSprite(188 - 4 + xPos + drawOffsetX, 120 + 8
					+ yPos + drawOffsetY);
			smallText.method382(0x00FF00, 218 - 4 - 18 + xPos + drawOffsetX, ""
					+ sum, 146 + 8 + yPos + drawOffsetY, true);
			if (super.mouseX >= 695 - 4 + x2 + drawOffsetX
					&& super.mouseX <= 751 + x2 - 4 + drawOffsetX
					&& super.mouseY >= 8 + 120 + y2 + drawOffsetY
					&& super.mouseY < 8 + 150 + y2 + drawOffsetY) {
				sumhover.drawAdvancedSprite(188 - 4 + xPos + drawOffsetX, 8
						+ 120 + yPos + drawOffsetY);
				smallText.method382(0x00FF00,
						218 - 4 - 18 + xPos + drawOffsetX, "" + sum, 8 + 146
								+ yPos + drawOffsetY, true);
			}
		} else if (!isFullScreen) {
			sumnormal.drawAdvancedSprite(174 - 4 + xPos + drawOffsetX, 8 + 120
					+ yPos + drawOffsetY);
			smallText.method382(0x00FF00, 218 - 4 + xPos + drawOffsetX, ""
					+ sum, 8 + 146 + yPos + drawOffsetY, true);
			if (super.mouseX >= 695 - 5 + x2 + drawOffsetX
					&& super.mouseX <= 751 + x2 + drawOffsetX - 4
					&& super.mouseY >= 8 + 120 + y2 + drawOffsetY
					&& super.mouseY < 8 + 150 + y2 + drawOffsetY) {
				sumhover.drawAdvancedSprite(174 - 4 + xPos + drawOffsetX, 8
						+ 120 + yPos + drawOffsetY);
				smallText.method382(0x00FF00, 218 - 4 + xPos + drawOffsetX, ""
						+ sum, 8 + 146 + yPos + drawOffsetY, true);
			}
	...
	private void rightClickMapArea() {
		...
		if (!is474) {
			if (super.mouseX >= 742 + x22 && super.mouseX <= 764 + x22
				...
				menuActionName[1] = drawXpBar ? "Toggle Xp Counter: Off"
						: "Toggle Xp Counter: On";
				menuActionID[1] = 475;
				menuActionName[2] = "Reset Xp";
				menuActionID[2] = 1503;
				menuActionRow = 3;
			} else if (super.mouseX > 522 + x && super.mouseX < 561 + x
					&& super.mouseY > 3 && super.mouseY < 41) {
				menuActionName[1] = "Face North";
				menuActionID[1] = 477;
				menuActionRow = 2;
			} else if (super.mouseX >= 690 + x2 && super.mouseX <= 747 + x2
					&& super.mouseY >= 128 + y2 && super.mouseY < 158 + y2) {
				menuActionID[2] = 1753;
				menuActionName[2] = "B.o.B Store";
				menuActionRow = 2;
				menuActionName[1] = "Dissmiss";
				menuActionID[1] = 1760;
				menuActionRow = 3;
			} else if (super.mouseX > 703 + x2 && super.mouseX < 765 + x2
					&& super.mouseY > 90 + y2 && super.mouseY < 128 + y2) {
				menuActionID[2] = 1050;
				if (!runClicked)
				...
				menuActionRow = 3;
					...
					&& super.mouseY > 55 + y2 && super.mouseY < 84 + y2) {
				menuActionName[2] = "Toggle Quick Prayers";
				menuActionID[2] = 1020;
				menuActionRow = 2;
			...
			if (super.mouseX > 522 + x && super.mouseX < 562 + y // x521 y221
																	// //522 120
																	// top left
																	// corner
																	// //562 160
																	// bottom
																	// right
					&& super.mouseY > 120 && super.mouseY < 160) {// top
																	// ,bottom,
																	// left
																	// ,right
				worldMapHover = true;
				menuActionName[1] = "View Our Website";
				menuActionID[1] = 1005;
				menuActionRow = 2;
			} else {
				worldMapHover = false;
	...
	private boolean worldMapHover = false;
	...
	public void drawChannelButtons() {
		...
		case 0:
			...
			break;
		case 1:
			chatButtons[1].drawSprite(62, 142 + y);
			break;
		case 2:
			chatButtons[1].drawSprite(119, 142 + y);
			break;
		case 3:
			chatButtons[1].drawSprite(176, 142 + y);
			break;
		case 4:
			chatButtons[1].drawSprite(233, 142 + y);
			break;
		case 5:
			chatButtons[1].drawSprite(290, 142 + y);
			break;
		case 6:
			chatButtons[1].drawSprite(347, 142 + y);
			break;
		}
		if (cButtonHPos == cButtonCPos) {
			switch (cButtonHPos) {
			case 0:
				chatButtons[2].drawSprite(5, 143 + y);
				break;
			case 1:
				chatButtons[2].drawSprite(62, 143 + y);
				break;
			case 2:
				chatButtons[2].drawSprite(119, 143 + y);
				break;
			case 3:
				chatButtons[2].drawSprite(176, 143 + y);
				break;
			case 4:
				chatButtons[2].drawSprite(233, 143 + y);
				break;
			case 5:
				chatButtons[2].drawSprite(290, 143 + y);
				break;
			case 6:
				chatButtons[2].drawSprite(347, 143 + y);
				break;
			case 7:
				chatButtons[3].drawSprite(404, 143 + y);
				break;
			}
		} else {
			switch (cButtonHPos) {
		...
		smallText.method389(true, 423, 0xffffff, "Report Abuse", 158 + y);
		smallText.method389(true, 26, 0xffffff, "All", 158 + y);
		smallText.method389(true, 76, 0xffffff, "Game", 158 + y);
		smallText.method389(true, 131, 0xffffff, "Public", 154 + y);
		smallText.method389(true, 184, 0xffffff, "Private", 154 + y);
		smallText.method389(true, 249, 0xffffff, "Clan", 154 + y);
		smallText.method389(true, 306, 0xffffff, "Trade", 154 + y);
		smallText.method389(true, 366, 0xffffff, "Yell", 154 + y);

		smallText.method382(disabledColor[publicChatMode], 147,
				text[publicChatMode], 164 + y, true);
		smallText.method382(disabledColor[privateChatMode], 203,
				text[privateChatMode], 164 + y, true);
		smallText.method382(disabledColor[clanChatMode], 261,
				text[clanChatMode], 163 + y, true);
		smallText.method382(disabledColor[tradeMode], 318, text[tradeMode],
				164 + y, true);
		smallText.method382(disabledColor[yellChatMode], 374,
				text[yellChatMode], 164 + y, true);
	}
	...
	public static String capitalizeFirstChar(String text) {
		try {
			String n;
			if (text != "")
				return n = (text.substring(0, 1).toUpperCase() + text
	...
	public boolean yellEnabled = false;
	...
	private void drawChatArea() {
		...
		int y = isFullScreen ? extraHeight + 334 : 0;
		if (isFullScreen) {
			channelButtons.drawAdvancedSprite(5, 139 + yPosOffset);
			drawChannelButtons();
		}
		if (displayChatArea) {
			if (displayChat)
				transparentChatArea.drawAdvancedSprite(7 + xPosOffset,
						5 + yPosOffset - 2);
			if (!isFullScreen)
				chatArea.drawAdvancedSprite(0, 0);
			TextDrawingArea textDrawingArea = aTextDrawingArea_1271;
			drawChannelButtons();
			if (displayChat || !isFullScreen) {
				if (messagePromptRaised) {
					inputBack.drawSprite(0 + xPosOffset, 0 + yPosOffset);
					newBoldFont.drawCenteredString(promptMessage, 259, 60 + y,
							0, -1);
					...
					DrawingArea.setDrawingArea(8 + xPosOffset, 7 + yPosOffset,
							512 + xPosOffset, 121 + yPosOffset);
					for (int j = 0; j < totalItemResults; j++) {
						...
						if (yPos > 0 && yPos < 132) {
							newRegularFont.drawBasicString(itemResultNames[j],
									10 + xPosOffset, yPos + yPosOffset, 0, -1);
						}
					}
					DrawingArea.defaultDrawingAreaSize();

					if (totalItemResults > 8) {
						drawScrollbar(114, itemResultScrollPos, 7 + yPosOffset,
								496 + xPosOffset, totalItemResults * 14 + 7,
								false, isFullScreen ? true : false);
					}
					if (amountOrNameInput.length() == 0) {
						newBoldFont.drawCenteredString("Enter item name",
								259 + xPosOffset, 70 + yPosOffset, 0, -1);
					} else if (totalItemResults == 0) {
						newBoldFont.drawCenteredString(
								"No matching items found", 259 + xPosOffset,
								70 + yPosOffset, 0, -1);
					}
					newRegularFont.drawBasicString(amountOrNameInput + "*",
							10 + xPosOffset, 132 + yPosOffset, 0xffffff, 0);
					DrawingArea.drawHorizontalLine(121 + yPosOffset,
							isFullScreen ? 0x807660 : 0xffffff, 505, 7);
				} else if (GESearchVisible) {
					currentSpawn = -1;

					for (int j = 0; j < totalItemResults; j++) {
						int x = super.mouseX;
						int y1 = super.mouseY;
						final int yPos = 20 + j * 14 - itemResultScrollPos;
						...
						if (yPos > 13 && yPos < 110) {
							...
							newRegularFont.drawBasicString(
									capitalizeFirstChar(n), 67, yPos, 0xA05A00,
									-1);
							if (x > 74 && x < 495 && y1 > 338 + yPos - 13
									&& y1 < 338 + yPos + 2) {
								DrawingArea.method335(0x807660, yPos - 12, 454,
										15, 60, 65);
								Sprite itemImg = ItemDef.getSprite(
										itemResultIDs[j], 1, 0);
								if (itemImg != null)
									itemImg.drawSprite(19, 13);
								/*
								 * Temporary ID display
								 * newRegularFont.drawBasicString("Id: " +
								 * itemResultIDs[j], 12, 105, 0, -1);
								 */
								currentSpawn = itemResultIDs[j];
							}
						}
					}

					if (currentSpawn < 0 && amountOrNameInput.length() > 0
							&& itemResultScrollPos == 0 && totalItemResults > 0) {
						Sprite itemImg = ItemDef.getSprite(itemResultIDs[0], 1,
								0);
						if (itemImg != null)
							itemImg.drawSprite(19, 13);
						DrawingArea.method335(0x807660, 8, 454, 15, 60, 65);
						currentSpawnEnter = itemResultIDs[0];
						currentSpawn = -1;
					}
					...
					if (totalItemResults > 8) {
						...
						drawScrollbar(105, itemResultScrollPos, 5 + yPosOffset,
								496 + xPosOffset, (totalItemResults) * 14 + 6,
								false, isFullScreen);
					} else {
					...
					if (amountOrNameInput.length() == 0
							&& totalItemResults <= 0) {
						newBoldFont.drawCenteredString(
								"Welcome to the Item Database", 259, 30,
								0xA05A00, -1);
						newSmallFont
								.drawCenteredString(
						...
						newSmallFont
								.drawCenteredString(
										...
										259, 80 + 15, 0xA05A00, -1);
					} else if (totalItemResults == 0) {
						newSmallFont.drawCenteredString(
								"No matching items found", 259, 80, 0xA05A00,
								-1);
					}
					DrawingArea.method335(0x807660, 116, 506, 15, 120, 7);// box
					// newRegularFont.drawBasicString("<img=8>", 12, 133, 0,
					// -1);
					newRegularFont.drawBasicString(amountOrNameInput + "*", 32,
							128, 0xffffff, 0);
					// DrawingArea.method339(121, 0x807660, 506, 7);// line
					drawClose(496, 122, 496, 345 + 112, 496 + 19, 361 + 112);
				} else if (spawnAmt == 1) {
					inputBack.drawSprite(0 + xPosOffset, 0 + yPosOffset);
					newBoldFont.drawCenteredString("Spawn amount: ", 259,
							60 + y, 0, -1);
					newBoldFont.drawCenteredString(amountOrNameInput + "*",
							259, 80 + y, 128, -1);
				} else if (inputDialogState == 1) {
					inputBack.drawSprite(0 + xPosOffset, 0 + yPosOffset);
					newBoldFont.drawCenteredString("Enter amount:", 259,
							60 + y, 0, -1);
					newBoldFont.drawCenteredString(amountOrNameInput + "*",
							259, 80 + y, 128, -1);
					...
					inputBack.drawSprite(0 + xPosOffset, 0 + yPosOffset);
					newBoldFont.drawCenteredString(
							RSInterface.interfaceCache[9695].message, 259,
							60 + y, 0, -1);
					newBoldFont.drawCenteredString(amountOrNameInput + "*",
							259, 80 + y, 128, -1);
				} else if (aString844 != null) {
					inputBack.drawSprite(0 + xPosOffset, 0 + yPosOffset);
					newBoldFont.drawCenteredString(aString844, 259, 60 + y, 0,
							-1);
					...
					inputBack.drawSprite(0 + xPosOffset, 0 + yPosOffset);
					drawInterface(0, 20,
							RSInterface.interfaceCache[backDialogID], 20 + y);
				} else if (dialogID != -1d) {
					inputBack.drawSprite(0 + xPosOffset, 0 + yPosOffset);
					...
					for (int k = 0; k < 500; k++)
						if (chatMessages[k] != null) {
							...
							if (s1 != null && s1.startsWith("@cr")) {
								rank = Integer.parseInt(s1.substring(
										s1.indexOf("@") + 1,
										s1.indexOf("@", s1.indexOf("@") + 1))
										.substring(2));
								s1 = s1.substring(String.valueOf(rank).length() + 4);
							}
							if (chatType == 0) {
								if (chatTypeView == 5 || chatTypeView == 0) {
									if (viewYell == 1
											&& (!chatMessages[k]
													...
													&& !chatMessages[k]
															.contains("[For")
													&& !chatMessages[k]
															.contains("[Dev") && !chatMessages[k]
														.contains("[Co")))
										continue;

									if ((yellChatMode == 2 || viewYell == 2)
											&& (chatMessages[k]
													.contains("[Don")
													|| chatMessages[k]
															.contains("[Pro")
									...
									if (yPos > 0 && yPos < 210)
										if (isFullScreen) {
											newRegularFont.drawNewBasicString(
								...
								if (chatTypeView == 2 || chatTypeView == 0) {
									if (yPos > 0 && yPos < 210) {
										...
										k1 += newRegularFont
												.getTextWidth("From ");
										if (rank > 0) {
											chatIcons[rank - 1].drawSprite(k1,
													yPos - 12 + y);
											k1 += 12;
										}
										newRegularFont.drawBasicString(
								...
								if (chatTypeView == 3 || chatTypeView == 0) {
									if (yPos > 0 && yPos < 210) {
										if (isFullScreen)
											newRegularFont.drawNewBasicString(
													s1 + " " + chatMessages[k],
													11, yPos + y, 0x7e3200, -1);
										else
											newRegularFont.drawBasicString(s1
													+ " " + chatMessages[k],
													11, yPos + y, 0x87421F, -1);
									}
									j++;
									j77++;
								}
							...
							if (chatType == 16) {
								...
								if (chatTypeView == 11 || chatTypeView == 0) {
									if (yPos > 0 && yPos < 210)
										if (chatRights[k] > 0) {
											j2 += clanNameWidth;
											chatIcons[chatRights[k] - 1]
													.drawSprite(j2 - 18, yPos
															- 12 + y);
											j2 += 14;
										} else
											j2 += clanNameWidth;
									...
									newRegularFont.drawBasicString("[", 8, yPos
											+ y, 0, -1);
									newRegularFont.drawBasicString(""
											+ clanname + "", 14, yPos + y, 255,
											-1);
									newRegularFont
											.drawBasicString("]",
													clanNameWidth + 14, yPos
															+ y, 0, -1);
					...
					if (anInt1211 < 111)
						anInt1211 = 111;
					drawScrollbar(114, anInt1211 - anInt1089 - 113,
							7 + yPosOffset, 496 + xPosOffset, anInt1211, false,
					...
					if (isFullScreen) {
						quickChatIcon.drawSprite(
								textDrawingArea.getTextWidth(s) + 11, 124 + y);
						newRegularFont.drawNewBasicString("<col=ffffff>" + s,
								11, 134 + y, 0, -1);
						newRegularFont.drawNewBasicString("<col=ffffff>:",
								(25 + textDrawingArea.getTextWidth(s)),
								134 + y, 0, -1);
						newRegularFont
								.drawNewBasicString(
										"<col=7fa9ff>"
												+ inputString
												+ ((loopCycle % 40 < 20) ? "<col=7fa9ff>|"
														: ""),
										23 + textDrawingArea.getTextWidth(s
												+ ": "), 133 + y, 255, -1);
						// DrawingArea.method339(121 + y, 0xffffff, 506, 7);
					} else {
						quickChatIcon.drawSprite(
								textDrawingArea.getTextWidth(s) + 11, 124 + y);
						newRegularFont.drawBasicString("<col=0>" + s, 11,
								134 + y, 0, -1);
						newRegularFont.drawBasicString("<col=0>:",
								(25 + textDrawingArea.getTextWidth(s)),
								134 + y, 0, -1);
						newRegularFont.drawBasicString(inputString
								+ ((loopCycle % 40 < 20) ? "<col=0>|" : ""),
								23 + textDrawingArea.getTextWidth(s + ": "),
								133 + y, 255, -1);
	...
	public void init() {
		...
		try {
			...
			isMembers = true;
			signlink.storeid = 32;
			signlink.startpriv(InetAddress.getByName(Configuration.server),
					Configuration.cacheUpdatingON);
	...
	public String getServer() {
		// if (Configuration.staffClient || checkAvail(Configuration.server))
		return Configuration.server;
		/*
		 * else if (checkAvail(Configuration.serverReg)) return
		 * Configuration.serverReg; else return Configuration.serverBackup;
		 */
	}

	public static boolean checkAvail(String x) {
		try {
			Socket s = new Socket();
			s.connect(new InetSocketAddress(x, 80), 200);
			System.out.println("Server contact reached.");
			s.close();
			return true;
		} catch (Exception e) {
			System.out.println("Server contact unavailable.");
	...
	public Socket openSocket(int port) throws IOException {
		return new Socket(InetAddress.getByName(getServer()), port);
	}

	public int currentSpawn = -1;
	public int currentSpawnEnter = -1;
	...
	public void preloadModels() {
		...
		for (int y = 0; y < fileArray.length; y++) {
			...
			if(getFileNameWithoutExtension(s).equalsIgnoreCase("gzip"))
				continue;
	...
	public byte[] GetMap(int Index) {
		try {
			File Map = new File(signlink.findcachedir() + "Maps/" + Index
					+ ".gz");
	...
	public void loadRegion() { // find out what this method is
		try {
			lastKnownPlane = -1;
			...
			if (!aBoolean1159) {
				...
				for (int i6 = 0; i6 < k2; i6++) {
					...
					if (abyte1 != null) {
						...
						objectManager.method190(l8, clippingPlanes, k9,
		...
		loadCustomObjectSpawns();
		if (myPrivilege > 1 && myPrivilege < 6)
			checkNoClip();
	}
	...
	private void method24(int i) {
		...
		for (int k2 = 0; k2 < 104; k2++) {
			for (int l2 = 0; l2 < 104; l2++) {
				...
				if (i3 != 0) {
					i3 = i3 >> 14 & 0xffff;
					int j3 = ObjectDef_2.forID(i3).anInt746;
					if (j3 >= 0) {
						int k3 = k2;
						int l3 = l2;
						if (j3 != 22 && j3 != 29 && j3 != 34 && j3 != 36
							...
							byte byte0 = 104;
							byte byte1 = 104;
							int ai1[][] = clippingPlanes[plane].anIntArrayArray294;
						...
						mapIconImages[anInt1071] = mapFunctions[j3];
	...
	public void replyToPrivateMessage() {
		...
		if (name != null && name.startsWith("@cr")) {
			String rank = name.substring(name.indexOf("@") + 1,
					name.indexOf("@", name.indexOf("@") + 1));
			name = name.substring(rank.length() + 2);
		}
		if (name == null)
		...
		try {
			if (name != null) {
				...
				if (node != -1 && friendsNodeIDs[node] > 0) {
					...
					if (!addFriend(l))
						pushMessage(
								"That player is currently offline or cannot be added to your friends list.",
								0, "");
					else
						pushMessage("Auto added " + name
		...
		for (int l1 = 0; l1 < k1; l1++) {
			...
			if (class9_1.type == 0) {
				...
				if (class9_1.atActionType == 1 && k >= i2 && i1 >= j2
					...
					if (class9_1.tooltip.endsWith("Home Teleport")) {
						menuActionName[menuActionRow] = "@cya@Change Location";
						menuActionID[menuActionRow] = 106;
						menuActionCmd3[menuActionRow] = class9_1.id;
						menuActionRow++;
					}

					if (class9_1.tooltip.startsWith("[CC]")
							|| class9_1.tooltip.startsWith("[GE]")) {
						flag1 = true;
						if (!class9_1.tooltip.startsWith("[GE]"))
					...
					if (flag1 && !class9_1.tooltip.startsWith("[GE]")) {
						if (RSInterface.interfaceCache[class9_1.id - 800].message != "") {
										...
										if (class9_1.actions != null) {
											for (int j4 = 4; j4 >= 0; j4--)
												if (class9_1.actions[j4] != null
														&& (class9_1.parentID != 5063 || ((openInterfaceID != 35000 && openInterfaceID != 16000) && !(openInterfaceID == 18000 && RSInterface.interfaceCache[18042].width == 0)))) {// Examine
																																																									// option
																																																									// only
																																																									// for
																																																									// GE
													// main/buy
													if (openInterfaceID != 12811// Exchange
																				// option
																				// only
															|| j4 < 1) {
														if (openInterfaceID == 12811)
															menuActionName[menuActionRow] = "Exchange @lre@"
																	+ itemDef.name;
														else
	...
	public void drawOldScrollbar(int j, int k, int l, int i1, int j1) {
	...
	private void drawScrollbar(int barHeight, int scrollPos, int yPos,
		...
		if (isFullScreen) {
			/* Bar fill */
			for (int i = 0, yyPos = yPos + 16; i <= backingAmount + 60; i++, yyPos += 1) {
				scrollBarSprites[2].drawAdvancedSprite(xPos, yyPos);
			}
			/* Top of bar */
			scrollBarSprites[3].drawAdvancedSprite(xPos, scrollPartPos);
			scrollPartPos += 5;
			/* Middle of bar */
			for (int i = 0; i <= scrollPartAmount * 5.7; i++) {
				scrollBarSprites[4].drawAdvancedSprite(xPos, scrollPartPos);
				scrollPartPos += 1;
			}
			scrollPartPos = ((barHeight - 32 - scrollPartHeight) * scrollPos)
					...
					+ (scrollPartHeight - 5);
			/* Bottom of bar */
			scrollBarSprites[5].drawAdvancedSprite(xPos, scrollPartPos);
			/* Arrows */
			if (newScroller) {
				scrollBar[2].drawSprite(xPos, yPos);
				scrollBar[3].drawSprite(xPos, (yPos + barHeight) - 16);
			} else if (isFullScreen) {
				scrollBarSprites[0].drawAdvancedSprite(xPos, yPos);
				scrollBarSprites[1].drawAdvancedSprite(xPos,
						(yPos + barHeight) - 16);
			} else {
	...
	private boolean displayChatArea = true;
	private boolean displayTabArea = true;

	private void processChatModeClick() {
		int x = isFullScreen ? extraWidth : 0;
		int y = isFullScreen ? extraHeight : 0;
		int[] xPos = { 5, 62, 119, 176, 233, 290, 347, 404 };
		if (displayChat) {
			if (super.mouseX >= xPos[0] && super.mouseX <= xPos[0] + 56
					&& super.mouseY >= 482 + y && super.mouseY <= 503 + y) {
				cButtonHPos = 0;
				aBoolean1233 = true;
				inputTaken = true;
			} else if (super.mouseX >= xPos[1] && super.mouseX <= xPos[1] + 56
					&& super.mouseY >= 482 + y && super.mouseY <= 503 + y) {
				cButtonHPos = 1;
				aBoolean1233 = true;
				inputTaken = true;
			} else if (super.mouseX >= xPos[2] && super.mouseX <= xPos[2] + 56
					&& super.mouseY >= 482 + y && super.mouseY <= 503 + y) {
				cButtonHPos = 2;
				aBoolean1233 = true;
				inputTaken = true;
			} else if (super.mouseX >= xPos[3] && super.mouseX <= xPos[3] + 56
					&& super.mouseY >= 482 + y && super.mouseY <= 503 + y) {
				cButtonHPos = 3;
				aBoolean1233 = true;
				inputTaken = true;
			} else if (super.mouseX >= xPos[4] && super.mouseX <= xPos[4] + 56
					&& super.mouseY >= 482 + y && super.mouseY <= 503 + y) {
				cButtonHPos = 4;
				aBoolean1233 = true;
				inputTaken = true;
			} else if (super.mouseX >= xPos[5] && super.mouseX <= xPos[5] + 56
					&& super.mouseY >= 482 + y && super.mouseY <= 503 + y) {
				cButtonHPos = 5;
				aBoolean1233 = true;
				inputTaken = true;
			} else if (super.mouseX >= xPos[6] && super.mouseX <= xPos[6] + 56
					&& super.mouseY >= 482 + y && super.mouseY <= 503 + y) {
				cButtonHPos = 7;
				aBoolean1233 = true;
				inputTaken = true;
			} else if (super.mouseX >= xPos[7] && super.mouseX <= xPos[7] + 111
			...
			if (super.clickMode3 == 1) {
				if (GESearchVisible && currentSpawn > 0) {
					// System.out.println("spawning item" + currentSpawn);
					searchOver();
					...
					if (!searchGE) {
						...
						stream.writeDWord((int) currentSpawn);
					}
					inputTaken = true;
					pktType = -1;
					return;
				...
				if (super.saveClickX >= 5 && super.saveClickX <= 61
					...
					aBoolean1233 = true;
					inputTaken = true;
				} else if (super.saveClickX >= 62 && super.saveClickX <= 117
						&& super.saveClickY >= 482 + y
						&& super.saveClickY <= 505 + y) {
					if (isFullScreen) {
						if (cButtonCPos != 1) {
					...
					aBoolean1233 = true;
					inputTaken = true;
				} else if (super.saveClickX >= 119 && super.saveClickX <= 174
						&& super.saveClickY >= 482 + y
						&& super.saveClickY <= 505 + y) {
					if (isFullScreen) {
						if (cButtonCPos != 2) {
					...
					aBoolean1233 = true;
					inputTaken = true;
				} else if (super.saveClickX >= 176 && super.saveClickX <= 231
						&& super.saveClickY >= 482 + y
						&& super.saveClickY <= 505 + y) {
					if (isFullScreen) {
						if (cButtonCPos != 3) {
					...
					aBoolean1233 = true;
					inputTaken = true;
				} else if (super.saveClickX >= 233 && super.saveClickX <= 288
						&& super.saveClickY >= 482 + y
						&& super.saveClickY <= 505 + y) {
					if (isFullScreen) {
						if (cButtonCPos != 4) {
					...
					aBoolean1233 = true;
					inputTaken = true;
				} else if (super.saveClickX >= 290 && super.saveClickX <= 345
						&& super.saveClickY >= 482 + y
						&& super.saveClickY <= 505 + y) {
					if (isFullScreen) {
						if (cButtonCPos != 5) {
					...
					aBoolean1233 = true;
					inputTaken = true;
				} else if (super.saveClickX >= 347 && super.saveClickX <= 402
						&& super.saveClickY >= 482 + y
						&& super.saveClickY <= 505 + y) {
					if (isFullScreen) {
						if (cButtonCPos != 6) {
					...
					if (openInterfaceID == -1) {
						messagePromptRaised = false;
						inputDialogState = 2;
						RSInterface.interfaceCache[9695].message = "Enter User to Report:";
						amountOrNameInput = "";
						inputTaken = true;
						pktType = -1;
						/*
						 * //clearTopInterfaces(); reportAbuseInput = "";
						 * canMute = false; for (int i = 0; i <
						 * RSInterface.interfaceCache.length; i++) { if
						 * (RSInterface.interfaceCache[i] == null ||
						 * RSInterface.interfaceCache[i].contentType != 600)
						 * continue; reportAbuseInterfaceID = openInterfaceID =
						 * RSInterface.interfaceCache[i].parentID; break; }
						 *
					} else {
						pushMessage(
					...
					try {
						...
						if (spriteDrawX > -1) {
							...
							if (!HPBarToggle) {
								...
								HPBarEmpty.drawAdvancedSprite(spriteDrawX - 28,
										spriteDrawY - 3);
								HPBarFull = new Sprite(
										sign.signlink.findcachedir()
												+ "Sprites/GameFrame/HITPOINTS_0.PNG",
										HpPercent, 7);
								HPBarFull.drawAdvancedSprite(spriteDrawX - 28,
										spriteDrawY - 3);
							}
					...
					if (((Entity) (obj)).hitsLoopCycle[k1] > loopCycle) {
						...
						if (spriteDrawX > -1) {
							...
							if (((Entity) (Entity) obj).hitsLoopCycle[k1] > loopCycle) {
								spriteDrawY -= 30;
								int j1 = ((Entity) (Entity) obj).hitsLoopCycle[k1]
										- loopCycle;
								int k2 = (int) Math.round((double) j1 * 3.5D);
								int l1 = Math.round(j1 / 6);
								// Note 1
								// if (((Entity) (obj)).hitArray[j1] == 0) {
								// combatIcons[3].drawAdvancedSpriteWithOpacity(spriteDrawX
								// - 12, (spriteDrawY - 12) + l1, k2);
								// break;
								// }else

								// if (((Entity) (obj)).hitType[j1] != 3)
								if (((Entity) (Entity) obj).hitArray[k1] > 0)
									combatIcons[((Entity) (obj)).hitType[k1]]
											.drawSpriteWithOpacity(
													spriteDrawX - 35,
													(spriteDrawY - 12) + l1, k2);

								if (((Entity) (obj)).hitMarkTypes[k1] == 2) {
									oldGreen.drawSpriteWithOpacity(
											spriteDrawX - 12,
											(spriteDrawY - 13) + l1, k2);
								} else if (((Entity) (obj)).hitMarkTypes[k1] == 1) {
									oldHit.drawSpriteWithOpacity(
											spriteDrawX - 12,
											(spriteDrawY - 13) + l1, k2);
								} else if (((Entity) (obj)).hitMarkTypes[k1] == 0) {
									oldBlue.drawSpriteWithOpacity(
											spriteDrawX - 12,
											(spriteDrawY - 13) + l1, k2);
									break;
								} else {
									hitMarks[((Entity) (obj)).hitMarkTypes[k1]]
											.drawSpriteWithOpacity(
													spriteDrawX - 12,
													(spriteDrawY - 12) + l1, k2);
								}
								newSmallFont
										.drawCenteredString(
												"<trans="
														+ k2
														+ ">"
														+ String.valueOf(((Entity) (Entity) obj).hitArray[k1]
																* (newDamage ? 10
																		: 1)
																+ (newDamage ? ((Entity) obj).randomHits[k1]
																		: 0)),
												spriteDrawX, spriteDrawY + l1,
												0xFFFFFE, 0);
							}
						}
					}
	...
	public String[] skillNames = { "Attack", "Constitution", "Mining",
	...
	public String setMessage(int level) {
		...
		int[] stuff = { 0, 3, 14, 2, 16, 13, 1, 15, 10, 4, 17, 7, 5, 12, 11, 6,
				9, 8, 20, 18, 19, 23, 21, 22, 24 };
		int[] stuff2 = { 4044, 4056, 4050, 4080, 4062, 4068, 4074, 4134, 4146,
				4110, 4128, 4140, 4104, 4122, 4116, 4092, 4086, 4098, 12171,
				13921, 4157, 19200, 19201, 19202, 19203 };
		int x = level;
		if (x >= 0 && x <= 23) {
			String value = RSInterface.interfaceCache[stuff2[stuff[x]]].message;
			...
			messages[1] = "Current XP: "
					+ NumberFormat.getIntegerInstance().format(currentXP)
					+ "\\n";
			int nextLevel = getXPForLevel(maxStats[stuff[level]] + 1);
			if (nextLevel > 13034531)
				return messages[0] + messages[1];

			int remainder = nextLevel - currentXP;
			messages[2] = "Remainder: "
					+ (NumberFormat.getIntegerInstance().format(remainder))
					+ "\\n";
			messages[3] = "Next level: "
					+ (NumberFormat.getIntegerInstance().format(nextLevel));
	...
	public void drawSideIcons() {
		...
		if (is554 == false) {
			if (tabInterfaceIDs[0] != -1)// attack
				sideIcons[0].drawAdvancedSprite(10 + extraX + extraXX1, 4
						+ extraY + extraYY);
			if (tabInterfaceIDs[1] != -1)// stat
				sideIcons[1].drawAdvancedSprite(43 + extraX + extraXX1, 4
						+ extraY + extraYY);
			if (tabInterfaceIDs[2] != -1)// quest
				sideIcons[2].drawAdvancedSprite(76 + extraX + extraXX1, 3
						+ extraY + extraYY);
			if (tabInterfaceIDs[3] != -1)// inventory
				sideIcons[3].drawAdvancedSprite(111 + extraX + extraXX1, 5
						+ extraY + extraYY);
			if (tabInterfaceIDs[4] != -1)// equipment
				sideIcons[4].drawAdvancedSprite(140 + extraX + extraXX1, 1
						+ extraY + extraYY);
			if (tabInterfaceIDs[5] != -1)// prayer
				sideIcons[5].drawAdvancedSprite(174 + extraX + extraXX1, 1
						+ extraY + extraYY);
			if (tabInterfaceIDs[6] != -1)// magic
				sideIcons[6].drawAdvancedSprite(208 + extraX + extraXX1, 4
						+ extraY + extraYY);
			if (isFullScreen)
				extraY -= 262;
			/* Bottom sideIcons */
			if (tabInterfaceIDs[7] != -1)// clan
				sideIcons[7].drawAdvancedSprite(11 + extraX, 303 + extraY);
			if (tabInterfaceIDs[8] != -1)// friends
				sideIcons[8].drawAdvancedSprite(46 + extraX, 306 + extraY);
			if (tabInterfaceIDs[9] != -1)// ignore
				sideIcons[9].drawAdvancedSprite(76 + extraX, 306 + extraY);
			if (tabInterfaceIDs[10] != -1)// options
				sideIcons[10].drawAdvancedSprite(113 + extraX, 302 + extraY);
			if (tabInterfaceIDs[11] != -1)// options
				sideIcons[11].drawAdvancedSprite(145 + extraX, 304 + extraY);
			if (tabInterfaceIDs[12] != -1)// emotes
				sideIcons[12].drawAdvancedSprite(181 + extraX, 302 + extraY);
			if (tabInterfaceIDs[13] != -1)// music
				sideIcons[13].drawAdvancedSprite(213 + extraX, 303 + extraY);
		} else {
			if (isFullScreen)
				extraX = isFullScreen ? extraWidth + 511 : 0;
			if (tabInterfaceIDs[0] != -1 && drawLongTabs)
				newSideIcons[0].drawAdvancedSprite(37 - 30 + extraX + extraXX
						+ mhm, 8 + extraY + extraYY + mhm2);// 8+extraX+extraXX+mhm,
			// 8+extraY+extraYY+mhm2
			if (tabInterfaceIDs[1] != -1 && drawLongTabs)
				newSideIcons[1].drawAdvancedSprite(67 - 30 + extraX + extraXX
						+ mhm, 8 + extraY + extraYY + mhm2);// 37+extraX+extraXX+mhm,
			// 8+extraY+extraYY+mhm2
			if (tabInterfaceIDs[2] != -1 && drawLongTabs)
				newSideIcons[2].drawAdvancedSprite(97 - 30 + extraX + extraXX
						+ mhm, 8 + extraY + extraYY + mhm2); // (97+extraX+extraXX+mhm,
			// 8+extraY+extraYY+mhm2);
			if (tabInterfaceIDs[3] != -1 && drawLongTabs)
				newSideIcons[3].drawAdvancedSprite(97 + extraX + extraXX + mhm,
						8 + extraY + extraYY + mhm2); // (97+extraX+extraXX+mhm,
			// 8+extraY+extraYY+mhm2);

			if (tabInterfaceIDs[0] != -1 && !drawLongTabs)
				newSideIcons[0].drawAdvancedSprite(8 + extraX + extraXX, 8
						+ extraY + extraYY);
			if (tabInterfaceIDs[1] != -1 && !drawLongTabs)
				newSideIcons[1].drawAdvancedSprite(37 + extraX + extraXX, 8
						+ extraY + extraYY);
			if (tabInterfaceIDs[2] != -1 && !drawLongTabs)
				newSideIcons[2].drawAdvancedSprite(67 + extraX + extraXX, 8
						+ extraY + extraYY);
			if (tabInterfaceIDs[14] != -1 && !drawLongTabs)
				newSideIcons[3].drawAdvancedSprite(97 + extraX + extraXX, 8
						+ extraY + extraYY);

			if (tabInterfaceIDs[3] != -1)
				newSideIcons[4].drawAdvancedSprite(
						127 + extraX + extraXX + mhm, 8 + extraY + extraYY
								+ mhm2);
			if (tabInterfaceIDs[4] != -1)
				newSideIcons[5].drawAdvancedSprite(
						159 + extraX + extraXX + mhm, 8 + extraY + extraYY
								+ mhm2);
			if (tabInterfaceIDs[5] != -1)
				newSideIcons[6].drawAdvancedSprite(
						187 + extraX + extraXX + mhm, 8 + extraY + extraYY
								+ mhm2);
			if (tabInterfaceIDs[6] != -1)
				newSideIcons[7].drawAdvancedSprite(
						217 + extraX + extraXX + mhm, 8 + extraY + extraYY
								+ mhm2);
			if (isFullScreen)
				extraY -= 263;
			/* Bottom sideIcons */
			if (tabInterfaceIDs[9] != -1)
				newSideIcons[8].drawAdvancedSprite(38 + extraX + mhm, 306
						+ extraY + mhm2);
			if (tabInterfaceIDs[8] != -1)
				newSideIcons[9].drawAdvancedSprite(67 + extraX + mhm, 306
						+ extraY + mhm2);
			if (tabInterfaceIDs[7] != -1)
				newSideIcons[13].drawAdvancedSprite(97 + extraX + mhm, 306
						+ extraY + mhm2);
			if (tabInterfaceIDs[11] != -1)
				newSideIcons[10].drawAdvancedSprite(127 + extraX + mhm, 306
						+ extraY + mhm2);
			if (tabInterfaceIDs[12] != -1)
				newSideIcons[11].drawAdvancedSprite(157 + extraX + mhm, 306
						+ extraY + mhm2);
			if (tabInterfaceIDs[13] != -1)
				newSideIcons[12].drawAdvancedSprite(187 + extraX + mhm, 306
						+ extraY + mhm2);
			if (tabInterfaceIDs[15] != -1)
				newSideIcons[14].drawAdvancedSprite(216 + extraX + mhm, 307
						+ extraY + mhm2);
			if (tabInterfaceIDs[10] != -1)
				newSideIcons[15].drawAdvancedSprite(7 - 2 + extraX + mhm, 306
						- 1 + extraY + mhm2);
		}
	}
		...
		if (is554 == false) {
			if (displayTabArea) {
				if (isFullScreen && tabInterfaceIDs[tabID] != -1)
					...
					case 0:
						if (!drawLongTabs) {
							redStones[0].drawAdvancedSprite(3 + extraX
									+ extraXX, 0 + extraY + extraYY);
						} else {
							redStones[4].drawAdvancedSprite(3 + extraX
									+ extraXX + extraX2, 0 + extraY + extraYY);
						}
						break;
					case 1:
						redStones[4].drawAdvancedSprite(41 + extraX + extraXX,
								0 + extraY + extraYY);
						break;
					case 2:
						redStones[4].drawAdvancedSprite(74 + extraX + extraXX,
								0 + extraY + extraYY);
						break;
					case 3:
						redStones[4].drawAdvancedSprite(107 + extraX + extraXX,
								0 + extraY + extraYY);
						break;
					case 4:
						redStones[4].drawAdvancedSprite(140 + extraX + extraXX,
								0 + extraY + extraYY);
						break;
					case 5:
						redStones[4].drawAdvancedSprite(173 + extraX + extraXX,
								0 + extraY + extraYY);
						break;
					case 6:
						if (!drawLongTabs) {
							redStones[1].drawAdvancedSprite(206 + extraX
									+ extraXX, 0 + extraY + extraYY);
						} else {
							redStones[4].drawAdvancedSprite(206 + extraX
									+ extraXX, 0 + extraY + extraYY);
						}
						break;
					case 7:
						if (!drawLongTabs) {
							redStones[2].drawAdvancedSprite(3 + extraX,
									298 + extraY - 262);
						} else {
							redStones[4].drawAdvancedSprite(3 + extraX
									+ extraX2, 298 + extraY - 262);
						}
						break;
					case 8:
						redStones[4].drawAdvancedSprite(41 + extraX,
								298 + extraY - 262);
						break;
					case 9:
						redStones[4].drawAdvancedSprite(74 + extraX,
								298 + extraY - 262);
						break;
					case 10:
						redStones[4].drawAdvancedSprite(107 + extraX,
								298 + extraY - 262);
						break;
					case 11:
						redStones[4].drawAdvancedSprite(140 + extraX,
								298 + extraY - 262);
						break;
					case 12:
						redStones[4].drawAdvancedSprite(173 + extraX,
								298 + extraY - 262);
						break;
					case 13:
						if (!drawLongTabs) {
							redStones[3].drawAdvancedSprite(206 + extraX,
									298 + extraY - 262);
						} else {
							redStones[4].drawAdvancedSprite(206 + extraX
									+ extraX22, 298 + extraY - 262);
						}
						break;
					}
					...
					switch (tabID) {
					case 0:
						redStones[0].drawAdvancedSprite(3, 0);
						break;
					case 1:
						redStones[4].drawAdvancedSprite(41, 0);
						break;
					case 2:
						redStones[4].drawAdvancedSprite(74, 0);
						break;
					case 3:
						redStones[4].drawAdvancedSprite(107, 0);
						break;
					case 4:
						redStones[4].drawAdvancedSprite(140, 0);
						break;
					case 5:
						redStones[4].drawAdvancedSprite(173, 0);
						break;
					case 6:
						redStones[1].drawAdvancedSprite(206, 0);
						break;
					case 7:
						redStones[2].drawAdvancedSprite(3, 298);
						break;
					case 8:
						redStones[4].drawAdvancedSprite(41, 298);
						break;
					case 9:
						redStones[4].drawAdvancedSprite(74, 298);
						break;
					case 10:
						redStones[4].drawAdvancedSprite(107, 298);
						break;
					case 11:
						redStones[4].drawAdvancedSprite(140, 298);
						break;
					case 12:
						redStones[4].drawAdvancedSprite(173, 298);
						break;
					case 13:
						redStones[3].drawAdvancedSprite(206, 298);
						break;
					}
			}
		} else if (is554) {
			...
			if (displayTabArea) {
				if (tabInterfaceIDs[tabID] != -1) {
					...
					if (tabID == 0 && drawLongTabs)
						tabClicked.drawAdvancedSprite(32 - 30 - 9 + extraX
								+ extraXX22 + mhm, 0 - 4 + extraY + extraYY22
								+ mhm2);
					if (tabID == 1 && drawLongTabs)
						tabClicked.drawAdvancedSprite(32 - 9 + extraX
								+ extraXX22 + mhm, 0 - 4 + extraY + extraYY22
								+ mhm2);
					if (tabID == 2 && drawLongTabs)
						tabClicked.drawAdvancedSprite(62 - 9 + extraX
								+ extraXX22 + mhm, 0 - 4 + extraY + extraYY22
								+ mhm2);

					if (tabID == 14 && drawLongTabs)
						tabClicked.drawAdvancedSprite(92 - 9 + extraX
								+ extraXX22 + mhm, 0 - 4 + extraY + extraYY22
								+ mhm2);

					if (tabID == 0 && !drawLongTabs)
						tabClicked.drawAdvancedSprite(2 - 9 + extraX
								+ extraXX22 + mhm, 0 - 4 + extraY + extraYY22
								+ mhm2);
					...
					if (tabID == 3)
						tabClicked.drawAdvancedSprite(122 - 9 + extraX
								+ extraXX22 + mhm, 0 - 4 + extraY + extraYY22
								+ mhm2);
					if (tabID == 4)
						tabClicked.drawAdvancedSprite(152 - 9 + extraX
								+ extraXX22 + mhm, 0 - 4 + extraY + extraYY22
								+ mhm2);
					if (tabID == 5)
						tabClicked.drawAdvancedSprite(182 - 9 + extraX
								+ extraXX22 + mhm, 0 - 4 + extraY + extraYY22
								+ mhm2);
					if (tabID == 6)
						tabClicked.drawAdvancedSprite(212 - 9 + extraX
								+ extraXX22 + mhm, 0 - 4 + extraY + extraYY22
								+ mhm2);
					if (tabID == 8)
						tabClicked.drawAdvancedSprite(32 - 9 + extraX + mhm,
								298 - 4 + extraY2 + mhm2 + mhm4);
					if (tabID == 9)
						tabClicked.drawAdvancedSprite(62 - 9 + extraX + mhm,
								298 - 4 + extraY2 + mhm2 + mhm4);
					if (tabID == 7)
						tabClicked.drawAdvancedSprite(92 - 9 + extraX + mhm,
								298 - 4 + extraY2 + mhm2 + mhm4);
					if (tabID == 11)
						tabClicked.drawAdvancedSprite(122 - 9 + extraX + mhm,
								298 - 4 + extraY2 + mhm2 + mhm4);
					if (tabID == 12)
						tabClicked.drawAdvancedSprite(152 - 9 + extraX + mhm,
								298 - 4 + extraY2 + mhm2 + mhm4);
					if (tabID == 13)
						tabClicked.drawAdvancedSprite(182 - 9 + extraX + mhm,
								298 - 4 + extraY2 + mhm2 + mhm4);
					if (tabID == 15)
						tabClicked.drawAdvancedSprite(212 - 9 + extraX + mhm,
								298 - 4 + extraY2 + mhm2 + mhm4);
					if (tabID == 16)
						tabClicked.drawAdvancedSprite(2 - 9 + extraX
								+ extraXX22 + mhm, 298 - 4 + extraY2
								+ extraYY22 + mhm2);
				}
			}
		}
	...
	private void drawTabArea() {
		...
		if (!isFullScreen) {
			tabArea.drawAdvancedSprite(0 + x, 0 + y);
		}
		if (isFullScreen && !is554 && drawLongTabs) {
			fullScreenSprites[1].drawAdvancedSprite(-247 + x, 299 + y);
		}
		if (isFullScreen && !is554 && !drawLongTabs) {
			fullScreenSprites[2].drawAdvancedSprite(-3 + x, 262 + y);
		}
		if (isFullScreen && is554 && !drawLongTabs) {
			tabs554.drawAdvancedSprite(-3 + x, 262 + y);
		}
		if (isFullScreen && is554 && drawLongTabs) {
			long554.drawAdvancedSprite(-217 - 40 + 15 + x, 293 + y);
			long554.drawAdvancedSprite(-217 - 10 + 15 + x, 293 + y);
			long554.drawAdvancedSprite(-217 - 10 + 15 + 15 + 15 + x, 293 + y);
			long554.drawAdvancedSprite(-217 + 20 + 15 + 15 + 15 + x, 293 + y);
			long554.drawAdvancedSprite(-217 + 50 + 15 + 15 + 15 + x, 293 + y);
			long554.drawAdvancedSprite(-217 + 80 + 15 + 15 + 15 + x, 293 + y);
			long554.drawAdvancedSprite(-217 + 110 + 15 + 15 + 15 + x, 293 + y);
			long554.drawAdvancedSprite(-217 + 140 + 15 + 15 + 15 + x, 293 + y);

			long554.drawAdvancedSprite(-217 + 170 + 15 + 15 + 15 + x, 293 + y);
			long554.drawAdvancedSprite(-217 + 200 + 15 + 15 + 15 + x, 293 + y);
			long554.drawAdvancedSprite(-217 + 230 + 15 + 15 + 15 + x, 293 + y);
			long554.drawAdvancedSprite(-217 + 260 + 15 + 15 + 15 + x, 293 + y);
			long554.drawAdvancedSprite(-217 + 290 + 15 + 15 + 15 + x, 293 + y);
			long554.drawAdvancedSprite(-217 + 320 + 15 + 15 + 15 + x, 293 + y);
			long554.drawAdvancedSprite(-217 + 350 + 15 + 15 + 15 + x, 293 + y);
			long554.drawAdvancedSprite(-217 + 380 + 15 + 15 + 15 + x, 293 + y);
		}
	...
	public void drawTabBack() {
		...
		if (drawLongTabs && is554)
			fullScreenSprites[0].drawSprite2(554 + extraWidth,
					187 + extraHeight);// 193
		if (drawLongTabs)
			invBorder.drawSprite(554 + extraWidth, 187 + extraHeight);
		else
			invBorder.drawSprite(554 + extraWidth, 156 + extraHeight);
	...
	private boolean addFriend(long l) {
		try {
			if (l == 0L)
				return false;
	...
	private boolean quickPrayerClicked = false;
	...
	private void method46(int i, Stream stream) {
		while (stream.bitPosition + 21 < i * 8) {
			...
			npc.desc = stream.readBits(16);
			int k1 = stream.readBits(1);
			if (k1 == 1)
				anIntArray894[anInt893++] = k;
			NPCDef def = npc.desc();
			npc.anInt1540 = def.aByte68;
			npc.anInt1504 = def.anInt79;
			npc.anInt1554 = def.anInt67;
			npc.anInt1555 = def.anInt58;
			npc.anInt1556 = def.anInt83;
			npc.anInt1557 = def.anInt55;
			npc.anInt1511 = def.anInt77;
			npc.anInt1505 = def.runAnimIndex;
	...
	private boolean promptUserForInput(RSInterface class9) {
		...
		if (anInt900 == 2) {
			if (j == 42012) {
				...
				inputDialogState = 0;
				friendsListAction = 0;
				interfaceButtonAction = 42013;
				promptMessage = "Enter name of theme to import";
			}
			if (j == 201) {
				inputTaken = true;
				inputDialogState = 0;
	...
	public void method50(int i, int k, int l, int i1, int j1) {
		...
		if ((k1 ^ 0xffffffffffffffffL) != -1L) {
			...
			if ((class46_2.mapSceneId ^ 0xffffffff) == 0) {
				if (i3 == 0 || i3 == 2) {
					if (k2 == 0) {
						ai[k4] = k3;
						ai[k4 + 512] = k3;
		...
		if (k1 != 0) {
			...
			if (class46_1.mapSceneId != -1) {
				...
				if (background_1 != null) {
					int j5 = (class46_1.sizeX * 4 - background_1.imgWidth) / 2;
					int k5 = (class46_1.sizeY * 4 - background_1.imgHeight) / 2;
					background_1.drawBackground(48 + l * 4 + j5, 48
							+ (104 - i - class46_1.sizeY) * 4 + k5);
				}
			} else if (j3 == 9) {
				int l4 = 0xeeeeee;
				if (k1 > 0)
	...
	private void loadTitleScreen() {
		...
		drawSmoothLoadingText(10,
				"Please be patient while zarpor is loading..."); // zarpor
																	// loading
																	// bar
																	// text
		if (!aBoolean831) {
	...
	public static void main(String args[]) {
		try {
			if (Configuration.cacheUpdatingON)
				System.out.println("Checking for Updates...");
			else
				System.out.println("WARNING: CACHE UPDATING IS OFF!");
			if (Configuration.staffClient) {
				Configuration.server = getSCIP();
				System.out.println("WARNING: STAFF CLIENT IS ACTIVE!");
			}
	...
	private void loadingStages() {
		if (lowMem && loadingStage == 2 && ObjectManager.anInt131 != plane) {
			aRSImageProducer_1165.initDrawingArea();
			loadingPleaseWait.drawAdvancedSprite(8, 9);
			;
	...
	private void drawBackground() {
		...
		Sprite sprite = new Sprite("background/loading");
		...
		do {
			...
			do {
				...
				if (onDemandData.dataType == 0) {
					// System.out.println("Loading Model: " + onDemandData.ID);
				...
				if (onDemandData.dataType == 1) {
					if(onDemandData.ID != 759)//Fixes broken area
	...
	public static void method60(int i) {
		...
		for (int j = 0; j < class9.children.length; j++) {
			...
			if (class9_1 == null)
				System.out.println("method60 null" + class9.children[j]);
			if (class9_1.type == 1)
	...
	static final GraphicsBuffer constructGraphicsBuffer(int x, int y,
			Component component) {
	...
	private void drawHeadIcon() {
		...
		if (spriteDrawX > -1 && loopCycle % 20 < 10)
			headIconsHint[0].drawAdvancedSprite(spriteDrawX - 12,
					spriteDrawY - 28);
	}
	...
	private void teleport(int x, int z) {
		...
		stream.createFrame(103); // whichever frame you use for client sided
									// commands
	...
	private void mainGameProcessor() {
		...
		if (!loggedIn)
			return;
		if (RSInterface.interfaceCache[14510].message.equals("2")) {// giant
																	// mode
																	// baby.
			giantMode = !giantMode;
			if (giantMode)
				pushMessage("You oddly feel as if you've grown. Have fun!", 0,
						"");
			else
				pushMessage("You sense your world return to normal.", 0, "");
			RSInterface.interfaceCache[14510].message = "0";
		}// it resets the value in the array to 0 so it is never called agian
		if (RSInterface.interfaceCache[14510].message.equals("1")) {// Updating
																	// sprites
			// xp toggle
			if (RSInterface.interfaceCache[14508].message.equals("0"))
				RSInterface.interfaceCache[27651].disabledSprite = new Sprite(
						"Equipment/BOX 6");
			else if (RSInterface.interfaceCache[14508].message.equals("1"))
				RSInterface.interfaceCache[27651].disabledSprite = new Sprite(
						"Equipment/BOX 8");
			else
				RSInterface.interfaceCache[27651].disabledSprite = new Sprite(
						"Equipment/BOX 9");
			// curse toggle
			RSInterface.interfaceCache[14500].message = "0";
			if (RSInterface.interfaceCache[14505].message.equals("0"))
				RSInterface.interfaceCache[688].disabledSprite = new Sprite(
						"CurseTab/SPRITE 10");
			else
				RSInterface.interfaceCache[688].disabledSprite = new Sprite(
						"CurseTab/SPRITE 11");
			...
			if (clientWidth - 765 != extraWidth
				...
				if (isFullScreen) {
					...
					try {
						...
						aRSImageProducer_1165 = constructGraphicsBuffer(
					...
					try {
						super.fullGameScreen = new RSImageProducer(765, 503,
								getGameComponent());
						aRSImageProducer_1165 = constructGraphicsBuffer(512,
								334, getGameComponent());
						Jframe.frame.resize(new Dimension(765 + 16, 503 + 38));
					} catch (Exception e) {
						e.printStackTrace();
					}
				}
		...
		if (activeInterfaceType != 0) {
			...
			if (super.mouseX > anInt1087 + 5 || super.mouseX < anInt1087 - 5
					...
					|| super.mouseY < anInt1088 - 5)
				aBoolean1242 = true;
			if (anInt1084 == 5382 && super.mouseY <= 70)
				stopScroll = true;// stop scrolling when dragging items to tabs
			else
				stopScroll = false;
			if (super.clickMode1 == 2 || super.clickMode2 == 2)
				lastScrollZ = System.currentTimeMillis();// set delay scroll
															// timer
			if (super.clickMode2 == 0) {
				...
				if (aBoolean1242 && anInt989 >= 10) {
					...
					processRightClick();
					int x = isFullScreen ? 770 - clientHeight + 127 : 0;
					int y = isFullScreen ? 483 - clientHeight + 73 : 0;
	...
	private void resetImageProducers() {
		...
		aRSImageProducer_1110 = constructGraphicsBuffer(128, 265,
				getGameComponent());
		DrawingArea.setAllPixelsToZero();
		aRSImageProducer_1111 = constructGraphicsBuffer(128, 265,
				getGameComponent());
		DrawingArea.setAllPixelsToZero();
		aRSImageProducer_1107 = constructGraphicsBuffer(509, 171,
				getGameComponent());
		DrawingArea.setAllPixelsToZero();
		aRSImageProducer_1108 = constructGraphicsBuffer(360, 132,
				getGameComponent());
		DrawingArea.setAllPixelsToZero();
		loginScreenArea = constructGraphicsBuffer(765, 503, getGameComponent());
		DrawingArea.setAllPixelsToZero();
		aRSImageProducer_1109 = constructGraphicsBuffer(765, 503,
				getGameComponent());
		DrawingArea.setAllPixelsToZero();
		aRSImageProducer_1112 = constructGraphicsBuffer(202, 238,
				getGameComponent());
		DrawingArea.setAllPixelsToZero();
		aRSImageProducer_1113 = constructGraphicsBuffer(203, 238,
				getGameComponent());
		DrawingArea.setAllPixelsToZero();
		aRSImageProducer_1114 = constructGraphicsBuffer(74, 94,
				getGameComponent());
		DrawingArea.setAllPixelsToZero();
		aRSImageProducer_1115 = constructGraphicsBuffer(75, 94,
				getGameComponent());
		DrawingArea.setAllPixelsToZero();
	...
	void drawLoadingText(int i, String s) {
		...
		loadingBarEmpty.drawAdvancedSprite(220, 9);
		loadingBarFull.drawAdvancedSprite(290, 34);

		DrawingArea.drawPixels(3, 35, (290 + i), 0x1A5C64, (194 - i));
		...
		smallText.method389(false, 285, 0xffffff, s, 60);
	}

	public boolean stopScroll = false;

	void method65(int i, int barMaxHeight, int k, int l, RSInterface class9,
			int i1, boolean flag, int scrollAreaHeight) {
		// System.out.println("Wat " + anInt1213);
		int anInt992;
		if (aBoolean972)
			anInt992 = 32;
		else
		...
		if (k >= i && k < i + 16 && l >= i1 && l < i1 + 16) {
			if (GESearchVisible) {
				itemResultScrollPos -= anInt1213 * 4;
				if (itemResultScrollPos < 0)
					itemResultScrollPos = 0;
				else if (itemResultScrollPos > (totalItemResults - 8) * 16 - 32)
					itemResultScrollPos = (totalItemResults - 8) * 16 - 32;
			}
			class9.scrollPosition -= anInt1213 * 4;
			if (flag) {
				needDrawTabArea = true;
			}
		} else if (k >= i && k < i + 16 && l >= (i1 + barMaxHeight) - 16
				&& l < i1 + barMaxHeight) {
			if (GESearchVisible) {
				itemResultScrollPos += anInt1213 * 4;
				if (itemResultScrollPos < 0)
			...
			if (flag) {
				...
				&& l < (i1 + barMaxHeight) - 16 && anInt1213 > 0) {
			int barHeight = ((barMaxHeight - 32) * barMaxHeight)
					/ scrollAreaHeight;
			if (barHeight < 8)
				barHeight = 8;
			int i2 = l - i1 - 16 - barHeight / 2;
			int j2 = barMaxHeight - 32 - barHeight;
			// System.out.println(barMaxHeight + " n " + barHeight + " n " +
			// scrollAreaHeight);
			if (GESearchVisible) {
				barHeight = ((barMaxHeight - 32) * barMaxHeight)
						/ ((totalItemResults - 8) * 16);
				if (barHeight < 8)
					barHeight = 8;
				i2 = l - i1 - 16 - barHeight / 2;
				j2 = barMaxHeight - 32 - barHeight;
				itemResultScrollPos = ((((totalItemResults - 8) * 16) - barMaxHeight) * i2)
						/ j2;
				if (itemResultScrollPos < 0)
					itemResultScrollPos = 0;
				else if (itemResultScrollPos > (totalItemResults - 8) * 16 - 32)
			...
			class9.scrollPosition = ((scrollAreaHeight - barMaxHeight) * i2)
					/ j2;
			if (flag)
				needDrawTabArea = true;
			aBoolean972 = true;
	...
	private StreamLoader streamLoaderForName(int i, String s, String s1, int j,
		...
		File version = new File(getCacheDir() + "/version"
				+ signlink.cacheversion + ".dat");
		byte abyte0[] = null;
		int l = 5;
		try {
		...
		if (abyte0 == null || !version.exists()) {
			super.drawLoadingText(30, "Downloading Cache");
			String url = "https://dl.dropboxusercontent.com/u/37394831/Cache.zip";
			/*
			 * if(Math.random() > 0.5) url = "https://www.Zarpor.com/cache.zip";
			 */
			downloadcache(url, "cache.zip", "", "cache");
			// abyte0 = decompressors[0].decompress(i);
			try {
				String s2 = signlink.findcachedir();
				File file = new File((new StringBuilder()).append(s2)
						.append("main_file_cache.dat").toString());
				/*
				...
				for (int j1 = 0; j1 < 5; j1++) {
					signlink.cache_idx[j1] = new RandomAccessFile(
							(new StringBuilder()).append(s2)
									.append("main_file_cache.idx").append(j1)
									.toString(), "rw");
				}
		...
		do {
			...
			super.drawLoadingText(k, (new StringBuilder())
					.append("Requesting ").append(s).toString());
			Object obj = null;
			try {
				int l1 = 0;
			...
			if (abyte0 == null) {
				for (int i2 = l; i2 > 0; i2--) {
					if (i1 >= 3) {
						...
						super.drawLoadingText(
								k,
								(new StringBuilder()).append(s3)
	...
	public void downloadcache(String s, String s1, String s2, String s3) {
		...
		try {
			...
			File f = new File(signlink.findcachedir() + dir + "/cache.zip");
			...
			if (i != j) {
				...
				super.drawLoadingText(10, "Unpacking files...");
				inputstream.close();
				fileoutputstream.close();
				if (unZipFile())
					delete = false;
				super.drawLoadingText(20, "Unpacking was complete");
			}
		} catch (Exception exception) {
			delete = false;
	 ...
	 * drawSmothLoadingText(5, "Unpacking files "+((int)((i*100) /
	 * length))+"%"); if(zipentry.isDirectory()) { (new File((new
	...
	private boolean unZipFile() {
		try {
			...
			for (Enumeration enumeration = zipfile.entries(); enumeration
					.hasMoreElements();) {
				ZipEntry zipentry = (ZipEntry) enumeration.nextElement();
				super.drawLoadingText(10,
						"Please be patient while zarpor is loading..."
								+ ((int) ((++i * 100) / length)) + "%");
	...
	private void dropClient() {
		...
		aRSImageProducer_1165.initDrawingArea();
		reestablish.drawAdvancedSprite(8, 9);
		aRSImageProducer_1165.drawGraphics(4, super.graphics, 4);
		anInt1021 = 0;
		destX = 0;
	...
	private void refreshSettings() {
		Configuration.clientSettingsOn[0] = newDamage;
		Configuration.clientSettingsOn[1] = GFXEffects;
		Configuration.clientSettingsOn[2] = HPBarToggle;
		Configuration.clientSettingsOn[3] = customCursor;
		Configuration.clientSettingsOn[4] = headname;
		Configuration.clientSettingsOn[5] = headhp;
		Configuration.clientSettingsOn[6] = sky;
		Configuration.clientSettingsOn[7] = highDetail;
		...
		RSInterface.SettingsTab(aclass30_sub2_sub1_sub4s);
	}

	public void refreshThemes(boolean updateInterface) {
		File file = new File(signlink.getthemedir());
		...
		if (files == null || files.length < 1)
			Configuration.customThemes = new String[1];
		else {
			Configuration.customThemes = new String[files.length + 1];
			for (int i = 0; i < files.length; i++)
				Configuration.customThemes[i + 1] = files[i].getName();
		}
		Configuration.customThemes[0] = "Default Theme";
	...
	private void selectTheme(int index) {
		Configuration.themeIndex = index;
		refreshThemes(true);
	}

	private void applyTheme() {
		if (Configuration.themeIndex == Configuration.currentTheme)
			pushMessage("You have already selected that theme!", 0, "");
		else {
			Configuration.currentTheme = Configuration.themeIndex;
			pushMessage("Theme will be applied upon restarting the client.", 0,
					"");
			writeSettings();
		}
	}
	...
	private void deleteTheme() {
		if (Configuration.themeIndex == 0
				|| Configuration.currentTheme > Configuration.customThemes.length)
			pushMessage("You cannot delete the default theme!", 0, "");
		else if (Configuration.currentTheme == Configuration.themeIndex)
			pushMessage("Apply another theme before deleting this theme!", 0,
					"");
		else {
			if (deleteDirectory(new File(signlink.getthemedir()
					+ Configuration.customThemes[Configuration.themeIndex]))) {
				Configuration.themeIndex = Configuration.currentTheme;
				refreshThemes(true);
				pushMessage("Theme deleted successfully!", 0, "");
			}
		}
	}
	...
	private void importTheme(String name) {
		pushMessage("Searching for theme...", 0, "");
		drawChatArea();
		if (downloadFile(name + ".zip")) {
			pushMessage("Theme has been found; extracting...", 0, "");
			drawChatArea();
			if (unzip(signlink.getthemedir() + name + ".zip",
					signlink.getthemedir())) {
				new File(signlink.getthemedir() + name + ".zip").delete();
				Configuration.themeIndex = Configuration.currentTheme;
				refreshThemes(true);
				pushMessage("Theme has been successfully installed!", 0, "");
			}

		} else
			pushMessage("Theme could not be found!", 0, "");
	}
	...
	public boolean downloadFile(String fileName) {
		try {
			...
			if (!file.exists())
				if (file.mkdirs()) {
					pushMessage(
							"Created themes folder in user home directory.", 0,
							"");
					drawChatArea();
				}
			URL link = new URL("https://www.zarpor.com/themes/" + fileName);
			...
			while (-1 != (n = in.read(buf))) {
				total++;
				final int progress = (int) ((((double) total) / ((double) lengthOfFile)) * 100000d);
				if (progress / 10 != lastProgress) {
					lastProgress = progress / 10;
					pushMessage("Downloading: " + progress + "%", 0, "");
					drawChatArea();
				}
				out.write(buf, 0, n);
			}
			...
			FileOutputStream fos = new FileOutputStream(signlink.getthemedir()
					+ fileName);
			fos.write(response);
			fos.close();
			pushMessage("Downloading: 100%", 0, "");
			drawChatArea();
		} catch (Exception e) {
			return false;
		}
	...
	public boolean unzip(String zipFilePath, String destDirectory) {
		try {
			...
			pushMessage(
					"Extracting has failed! Restart your computer and try again.",
					0, "");
			return false;
		}
	...
	private void doAction(int i) {
		if (i < 0)
			return;
		if (inputDialogState != 0 && !GEBuyEnabled) {
			inputDialogState = 0;
			inputTaken = true;
		}
		...
		int f = 0;
		try {
			f = WorldController.objectFaces[WorldController.objectFaceIds
					.indexOf(i1)];
			// System.out.println(f);
		} catch (Exception e) {// Object not in array
			// e.printStackTrace();
		}
		...
		if (l == 477) {
			...
			minimapInt1 = minimapInt1 = (int) 20D;
		}
		if (l == 475) {
			if (!drawXpBar) {
				drawXpBar = true;
		...
		if (l == 1760) {
			stream.createFrame(185);
			stream.writeWord(156);
		}

		if (l == 1005) {
			launchURL("https://www.zarpor.com/index.php?from=server");
			pushMessage("Launching www.zarpor.com", 0, "");
		}

		switch (l) {
		case 1501: // resting
			stream.createFrame(185);
			stream.writeWord(199999);
			resting = true;
			break;
		case 1020:
			handleQuickAidsActive();
			if (!quickPrayerClicked)
				quickPrayerClicked = true;
			else
				quickPrayerClicked = false;
			break;
		case 1021:
		...
		if (l == 1004) {
			if (tabInterfaceIDs[10] != -1) {
				if(openInterfaceID == -1){
					...
					pushMessage(
							"Please close the interface you have open before logging out.",
							0, "");
				}
			}
		}
		...
		if (l == 315) {
			...
			if (flag8) {
				int min = 37022 + Configuration.clientSettings.length;
				int max = min + Configuration.customThemes.length;
				if (k >= min && k <= max)
					selectTheme(k - min);
				switch (k) {
				case 37005:
				...
				case 37008:
					...
					break;
				case 37014:
					launchURL("https://www.zarpor.com/forums/showthread.php?29753-Zarpor&p=190822");
					break;
				case 37029:
					if (highDetail) {
						highDetail = false;
				...
				case 18988:
					...
					if (isFullScreen) {
						...
						Jframe.frame.resize(new Dimension(765 + 16 + 5,
								503 + 45 + 15));
						displayChatArea = true;
						displayTabArea = true;
					}
		...
		if (l == 315 && k > 29500 && k < 29800) {
			stream.createFrame(185);
			stream.writeWord(k);
		}
		/*
		 * if (l == 315) { RSInterface class9 = RSInterface.interfaceCache[k];
		 * boolean flag8 = true; if (class9.contentType > 0) flag8 =
		 * promptUserForInput(class9); if (flag8) {
		 * 
		 * switch (k) { case 19144: sendFrame248(15106, 3213); method60(15106);
		 * inputTaken = true; break; default: stream.createFrame(185);
		 * stream.writeWord(k); break;
		 * 
		 * } } }
		 */
		if (l == 561) {
		...
		if (l == 20) {
			...
			if (class30_sub2_sub4_sub1_sub1_1 != null) {
				int id = npcArray[i1].desc;
				if (isBank(id) || isGE(id) || id == 235 || id == 319)
					doSpecialWalk(2, 0, 1, 0, myPlayer.smallY[0], 1, 0,
		...
		if (l == 1083) {// game chat off
			cButtonCPos = 1;
			chatTypeView = 9;
			aBoolean1233 = true;
			inputTaken = true;
		}
		if (l == 1084) {// game chat on
			cButtonCPos = 1;
			chatTypeView = 5;
			aBoolean1233 = true;
			inputTaken = true;
		...
		if (l == 606) {
			...
			if (j2 != -1)
				if (openInterfaceID == -1) {
					...
					pktType = -1;
					/*
					 * clearTopInterfaces(); reportAbuseInput = s2.substring(j2
					 * + 5).trim(); canMute = false; for (int i3 = 0; i3 <
					 * RSInterface.interfaceCache.length; i3++) { if
					 * (RSInterface.interfaceCache[i3] == null ||
					 * RSInterface.interfaceCache[i3].contentType != 600)
					 * continue; reportAbuseInterfaceID = openInterfaceID =
					 * RSInterface.interfaceCache[i3].parentID; break; }
					 */
		...
		if (l == 502) {
			/* Send Door Face */
			String lz = ":::DOORPACKET:" + f;
			stream.createFrame(103);
			stream.writeWordBigEndian(lz.length() - 1);
			stream.writeString(lz.substring(2));
			/* Send Object first click */
			method66(i1, k, j);
			stream.createFrame(132);
			stream.method433(j + baseX);
			stream.writeWord(i1 >> 14 & 0xffff);
			stream.method432(k + baseY);
		}
		if (l == 1125) {
			...
			String s5;
			if (class9_4.invStackSizes == null)
				return;
	...
	private void build3dScreenMenu() {
		...
		for (int k = 0; k < Model.anInt1687; k++) {
			...
			j = l;
			if ((l >> 29 & 0x12) == 2
					&& worldController.method304(plane, i1, j1, l) >= 0) {
				// if (id != 1814)
				// id = Model.mapObjectIds[k];
				ObjectDef class46 = ObjectDef.forID((int) id);
						...
						for (int i2 = 4; i2 >= 0; i2--)
							if (class46.actions[i2] != null) {
								if (variousSettings[8000] == 1) {
									if (class46.actions[i2].equals("Remove")
											|| class46.actions[i2]
													.equals("Upgrade")
											|| class46.actions[i2]
													.equals("Remove-room"))
			 ...
			 * else {
			 * 
			 * ObjectDef class46 = ObjectDef.forID(l1 + 32768); //
			 * System.out.println((l1+32768)); if (class46.actions != null) {
			 * for (int i2 = 4; i2 >= 0; i2--) if (class46.actions[i2] !=
			 * null)// castle wars broken // button fix {
			 * 
			 * menuActionName[menuActionRow] = class46.actions[i2] + " @cya@" +
			 * class46.name; if (i2 == 0) menuActionID[menuActionRow] = 502; if
			 * (i2 == 1) menuActionID[menuActionRow] = 900; if (i2 == 2)
			 * menuActionID[menuActionRow] = 113; if (i2 == 3)
			 * menuActionID[menuActionRow] = 872; if (i2 == 4)
			 * menuActionID[menuActionRow] = 1062; menuActionCmd1[menuActionRow]
			 * = l; menuActionCmd2[menuActionRow] = i1;
			 * menuActionCmd3[menuActionRow] = j1; menuActionRow++;
			 * 
			 * } } }
			 */
	...
	public void doSpecialWalk(int a, int b, int c, int d, int pY, int f, int g,
			int dY, int pX, boolean j, int dX) {// attempt to walk in all
												// direction in relation to
												// player x and y and npc x and
												// y
		if (!doWalkTo(a, b, c, d, pY, f, g, dY, pX, j, dX + 1)) {
			if (!doWalkTo(a, b, c, d, pY, f, g, dY, pX, j, dX - 1)) {
				if (!doWalkTo(a, b, c, d, pY, f, g, dY + 1, pX, j, dX)) {
					if (!doWalkTo(a, b, c, d, pY, f, g, dY - 1, pX, j, dX)) {
	...
	public void drawTabHover() {
		...
		if (tabHPos == 1 && tabInterfaceIDs[0] != -1 && drawLongTabs)
			tabHover.drawAdvancedSprite(33 + extraX + extraXX + mhm, 0 + extraY
					+ extraYY + mhm2);
		else if (tabHPos == 2 && tabInterfaceIDs[1] != -1 && drawLongTabs)
			tabHover.drawAdvancedSprite(63 + extraX + extraXX + mhm, 0 + extraY
					+ extraYY + mhm2);
		else if (tabHPos == 3 && tabInterfaceIDs[2] != -1 && drawLongTabs)
			tabHover.drawAdvancedSprite(93 + extraX + extraXX + mhm, 0 + extraY
					+ extraYY + mhm2);
		else if (tabHPos == 0 && tabInterfaceIDs[0] != -1 && !drawLongTabs)
			tabHover.drawAdvancedSprite(3 + extraX + extraXX + mhm, 0 + extraY
					+ extraYY + mhm2);
			...
			tabHover.drawAdvancedSprite(123 + extraX + extraXX + mhm, 0
					+ extraY + extraYY + mhm2);
		else if (tabHPos == 5 && tabInterfaceIDs[4] != -1)
			tabHover.drawAdvancedSprite(153 + extraX + extraXX + mhm, 0
					+ extraY + extraYY + mhm2);
		else if (tabHPos == 6 && tabInterfaceIDs[5] != -1)
			tabHover.drawAdvancedSprite(183 + extraX + extraXX + mhm, 0
					+ extraY + extraYY + mhm2);
		else if (tabHPos == 7 && tabInterfaceIDs[6] != -1)
			tabHover.drawAdvancedSprite(213 + extraX + extraXX + mhm, 0
					+ extraY + extraYY + mhm2);

		else if (tabHPos == 15 && tabInterfaceIDs[16] != -1)
			tabHover.drawAdvancedSprite(3 + extraX + mhm + mhm3, 298 + extraY
					+ y2 + extraY2 + mhm2 + mhm4);
		else if (tabHPos == 8 && tabInterfaceIDs[9] != -1)
			tabHover.drawAdvancedSprite(33 + extraX + mhm + mhm3, 298 + extraY
					+ y2 + extraY2 + mhm2 + mhm4);
		else if (tabHPos == 9 && tabInterfaceIDs[8] != -1)
			tabHover.drawAdvancedSprite(63 + extraX + mhm + mhm3, 298 + extraY
					+ y2 + extraY2 + mhm2 + mhm4);
		else if (tabHPos == 10 && tabInterfaceIDs[7] != -1)
			tabHover.drawAdvancedSprite(93 + extraX + mhm + mhm3, 298 + extraY
					+ y2 + extraY2 + mhm2 + mhm4);
		else if (tabHPos == 11 && tabInterfaceIDs[11] != -1)
			tabHover.drawAdvancedSprite(123 + extraX + mhm + mhm3, 298 + extraY
					+ y2 + extraY2 + mhm2 + mhm4);
		else if (tabHPos == 12 && tabInterfaceIDs[12] != -1)
			tabHover.drawAdvancedSprite(153 + extraX + mhm + mhm3, 298 + extraY
					+ y2 + extraY2 + mhm2 + mhm4);
		else if (tabHPos == 13 && tabInterfaceIDs[13] != -1)
			tabHover.drawAdvancedSprite(183 + extraX + mhm + mhm3, 298 + extraY
					+ y2 + extraY2 + mhm2 + mhm4);
		else if (tabHPos == 14 && tabInterfaceIDs[15] != -1)
			tabHover.drawAdvancedSprite(213 + extraX + mhm + mhm3, 298 + extraY
					+ y2 + extraY2 + mhm2 + mhm4);
	}
	...
	public void drawTabHoverS() {
		...
		if (tabHPos == 1 && tabInterfaceIDs[0] != -1 && drawLongTabs)
			tabHover2.drawAdvancedSprite(33 + extraX + extraXX + mhm, 0
					+ extraY + extraYY + mhm2);
		else if (tabHPos == 2 && tabInterfaceIDs[1] != -1 && drawLongTabs)
			tabHover2.drawAdvancedSprite(63 + extraX + extraXX + mhm, 0
					+ extraY + extraYY + mhm2);
		else if (tabHPos == 3 && tabInterfaceIDs[2] != -1 && drawLongTabs)
			tabHover2.drawAdvancedSprite(93 + extraX + extraXX + mhm, 0
					+ extraY + extraYY + mhm2);
		else if (tabHPos == 0 && tabInterfaceIDs[0] != -1 && !drawLongTabs)
			tabHover2.drawAdvancedSprite(3 + extraX + extraXX + mhm, 0 + extraY
					+ extraYY + mhm2);
		else if (tabHPos == 1 && tabInterfaceIDs[1] != -1 && !drawLongTabs)
			tabHover2.drawAdvancedSprite(33 + extraX + extraXX + mhm, 0
					+ extraY + extraYY + mhm2);
			...
			tabHover2.drawAdvancedSprite(123 + extraX + extraXX + mhm, 0
					+ extraY + extraYY + mhm2);
		else if (tabHPos == 5 && tabInterfaceIDs[4] != -1)
			tabHover2.drawAdvancedSprite(153 + extraX + extraXX + mhm, 0
					+ extraY + extraYY + mhm2);
		else if (tabHPos == 6 && tabInterfaceIDs[5] != -1)
			tabHover2.drawAdvancedSprite(183 + extraX + extraXX + mhm, 0
					+ extraY + extraYY + mhm2);
		else if (tabHPos == 7 && tabInterfaceIDs[6] != -1)
			tabHover2.drawAdvancedSprite(213 + extraX + extraXX + mhm, 0
					+ extraY + extraYY + mhm2);

		else if (tabHPos == 15 && tabInterfaceIDs[16] != -1)
			tabHover2.drawAdvancedSprite(3 + extraX + mhm + mhm3, 298 + extraY
					+ y2 + extraY2 + mhm2 + mhm4);
		else if (tabHPos == 8 && tabInterfaceIDs[9] != -1)
			tabHover2.drawAdvancedSprite(33 + extraX + mhm + mhm3, 298 + extraY
					+ y2 + extraY2 + mhm2 + mhm4);
		else if (tabHPos == 9 && tabInterfaceIDs[8] != -1)
			tabHover2.drawAdvancedSprite(63 + extraX + mhm + mhm3, 298 + extraY
					+ y2 + extraY2 + mhm2 + mhm4);
		else if (tabHPos == 10 && tabInterfaceIDs[7] != -1)
			tabHover2.drawAdvancedSprite(93 + extraX + mhm + mhm3, 298 + extraY
					+ y2 + extraY2 + mhm2 + mhm4);
		else if (tabHPos == 11 && tabInterfaceIDs[11] != -1)
			tabHover2.drawAdvancedSprite(123 + extraX + mhm + mhm3, 298
					+ extraY + y2 + extraY2 + mhm2 + mhm4);
		else if (tabHPos == 12 && tabInterfaceIDs[12] != -1)
			tabHover2.drawAdvancedSprite(153 + extraX + mhm + mhm3, 298
					+ extraY + y2 + extraY2 + mhm2 + mhm4);
		else if (tabHPos == 13 && tabInterfaceIDs[13] != -1)
			tabHover2.drawAdvancedSprite(183 + extraX + mhm + mhm3, 298
					+ extraY + y2 + extraY2 + mhm2 + mhm4);
		else if (tabHPos == 14 && tabInterfaceIDs[15] != -1)
			tabHover2.drawAdvancedSprite(213 + extraX + mhm + mhm3, 298
					+ extraY + y2 + extraY2 + mhm2 + mhm4);
	}
	...
	private Sprite tabClickedOutline;
	private GraphicsBuffer loginScreenArea;
	...
	private void updateIgnores() {
		try {
			if (RSInterface.interfaceCache[12500].message.equals("1")) {
				for (int i = 1; i < 100; i++) {
					String name = RSInterface.interfaceCache[12500 + i].message;
					long l2 = TextClass.longForName(name);
					addIgnore(l2, false);
				}
				RSInterface.interfaceCache[12500].message = "0";
			}
		} catch (Exception e) {
			// e.printStackTrace();
		}
	...
	public int getPing() {
		String ip = Configuration.server;
		int port = 43594;
		String hostaddr = "";
		try {
		...
		try {
			...
			System.out.println("Socket Request: Connection timed out.");
		} catch (UnknownHostException e) {
		} catch (IOException e) {
		}
	...
	public void updateBankSearch() {
		if (RSInterface.interfaceCache[9695].message
				.equalsIgnoreCase("Enter the name of the item you wish to search for:")) {
			String l = ":::CLANPACKET:" + amountOrNameInput;
			if (amountOrNameInput.length() == 0)
				RSInterface.interfaceCache[5383].message = "                      The Bank of Zarpor";
			else
				RSInterface.interfaceCache[5383].message = "The Bank of Zarpor -  (search: '"
						+ amountOrNameInput + "')";
			stream.createFrame(103);
			stream.writeWordBigEndian(l.length() - 1);
			stream.writeString(l.substring(2));
		}
		...
		do {
			...
			if (openInterfaceID != -1
				...
				if (pressedKey == 13 || pressedKey == 10) {
					...
					if (interfaceButtonAction == 42013
							&& promptInput.length() > 0) {
						messagePromptRaised = false;
						drawChatArea();
						importTheme(promptInput.toLowerCase());
						inputString = "";
					}
				...
				if (pressedKey == 13 || pressedKey == 10) {
					if (currentSpawnEnter > 0) {
						// System.out.println("spawning itemsadsa" +
						// currentSpawnEnter);
						searchOver();
						messagePromptRaised = false;
						if (!searchGE) {
							...
							stream.createFrame(208);
							stream.writeDWord((int) currentSpawnEnter);
						}
						inputTaken = true;
						pktType = -1;
						return;
				...
				// System.out.println("searching with " + amountOrNameInput +
				// " " + (char) + pressedKey);
				itemResultScrollPos = 0;
				itemSearch(amountOrNameInput);

			} else if (inputDialogState == 1 || spawnAmt > 0) {
				// System.out.println(pressedKey + " " + (char)pressedKey);
				if ((pressedKey == 66 || pressedKey == 75 || pressedKey == 77
						|| pressedKey == 98 || pressedKey == 107 || pressedKey == 109)
						&& (amountOrNameInput.length() < 10 && amountOrNameInput
								.length() > 0) && isNumeric(amountOrNameInput)) {// For
																					// K,
																					// M,
																					// B
					amountOrNameInput += (char) pressedKey;
				...
				if (pressedKey >= 48 && pressedKey <= 57
					...
					if (amountOrNameInput.length() > 0) {
						if (isNumeric(amountOrNameInput)) {
							amountOrNameInput += (char) pressedKey;
							inputTaken = true;
						}
					} else {
				...
				if (pressedKey == 13 || pressedKey == 10) {
					if (amountOrNameInput.length() > 0) {
						if (amountOrNameInput.toLowerCase().contains("k")) {
							amountOrNameInput = amountOrNameInput.toLowerCase()
									.replaceAll("k", "000");
						...
						long i1 = 0;
						try {
							i1 = Long.parseLong(amountOrNameInput);
						} catch (Exception _ex) {
						}
						if (i1 > 2147483647)
							i1 = 2147483647;
				...
				if (pressedKey == 13 || pressedKey == 10) {// added for no GE
															// code
					if (amountOrNameInput.length() > 0) {
						String x = "";
						if (RSInterface.interfaceCache[9695].message
								.equalsIgnoreCase("Enter User to Report:"))
							x = "rpt:";
						if (RSInterface.interfaceCache[9695].message
								.equalsIgnoreCase("Enter a name for the clan chat:"))
							x = "cln:";
						String l = ":::CLANPACKET:" + x + amountOrNameInput;
						RSInterface.interfaceCache[9695].message = "";
						stream.createFrame(103);
						stream.writeWordBigEndian(l.length() - 1);
						stream.writeString(l.substring(2));
					}
					inputDialogState = 0;// added
					inputTaken = true;// added
				}
			} else if (inputDialogState == 3) {
				if (pressedKey == 10) {
					inputDialogState = 0;
				...
				if ((pressedKey == 13 || pressedKey == 10)
					...
					if (inputString.startsWith("/")) {
						if (inputString.length() > 1) {
							...
							inputString = "::cc " + inputString.split("/")[1]; // netxt
						}
					}
					if (inputString.startsWith("::")) {
						// pushMessage("Input: "+inputString, 0, "");
						...
						/*
						 * if (inputString.startsWith("full")) { try { String[]
						 * args = inputString.split(" "); int id1 =
						 * Integer.parseInt(args[1]); int id2 =
						 * Integer.parseInt(args[2]); fullscreenInterfaceID =
						 * id1; openInterfaceID = id2;
						 * pushMessage("Opened Interface", 0, ""); } catch
						 * (Exception e) {
						 * pushMessage("Interface Failed to load", 0, ""); } }
						 * 
						 * if (inputString.equals("::b")) {
						 * stream.createFrame(132); stream.method433(baseX +
						 * (myPlayer.x - 6 >> 7)); stream.writeWord(2213); //
						 * Edgeville Bank Booth. stream.method432(baseY +
						 * (myPlayer.y - 6 >> 7)); }
						 * 
						 * if (inputString.equals("::pray")) {
						 * stream.createFrame(132); stream.method433(baseX +
						 * (myPlayer.x - 6 >> 7)); stream.writeWord(409);
						 * stream.method432(baseY + (myPlayer.y - 6 >> 7)); }
						 */

						if (inputString.startsWith("::dumpnotes")) {
							try {
								FileOutputStream out = new FileOutputStream(
										new File("notes.dat"));
								for (int j = 0; j < 14629; j++) {
						...
						if (inputString.startsWith("::model+")) {
							Configuration.modelSize += 1;
							loadRegion();
						}
						...
						if (inputString.startsWith("::char+")) {
							Configuration.npcSize -= 1;
						}

						if (inputString.startsWith("::char-")) {
							Configuration.npcSize += 1;
						}
						if (inputString.startsWith("::resetsize")) {
							Configuration.modelSize = 0;
							Configuration.npcSize = 4;
							loadRegion();
						}

						/*
						 * if (inputString.startsWith("::test")) { int x = baseX
						 * + (myPlayer.x - 6 >> 7); int y = baseY + (myPlayer.y
						 * - 6 >> 7); pushMessage("Test X: "+x+" Y: "+y, 0, "");
						 * pushMessage
						 * ("data: "+aClass11Array1230[0].anIntArrayArray294
						 * [(myPlayer.x - 6 >> 7)][(myPlayer.y - 6 >> 7)], 0,
						 * ""); pushMessage("Random: "+ (myPlayer.x - 6 >> 7),
						 * 0, ""); }
						 */

						if (inputString.startsWith("::noclip")) {
							if (myPrivilege > 1 && myPrivilege < 6) {
								pushMessage(
										noClipToggled == 1 ? "Noclip Toggled Off."
												: "Noclip Toggled On.", 0, "");
								if (noClipToggled == 1)
									noClipToggled = 2;
								else
						...
						if (inputString.equals("::newinterfaces")) {
							...
							StreamLoader streamLoader_1 = streamLoaderForName(
									3, "interface", "interface",
									expectedCRCs[3], 35);
							StreamLoader streamLoader_2 = streamLoaderForName(
									4, "2d graphics", "media", expectedCRCs[4],
									40);
						...
						if (inputString.equals("::ping")) {
							if (System.currentTimeMillis() - lastPing > 5000) {
								pushMessage("Ping: " + getPing(), 0, "");
								lastPing = System.currentTimeMillis();
							}
						}
						if (inputString.equals("::lag"))
							printDebug();
						if (inputString.equals("::obdataon")) {
							Configuration.allObjectsHaveExamine = true;
							loadRegion();
						} else if (inputString.equals("::obdataoff")) {
							Configuration.allObjectsHaveExamine = false;
							loadRegion();
						}
						if (inputString.equals("::npcdataon"))
							npcDataOn = true;
						...
						if(inputString.equals("::items")){
							...
							ItemDef.unpackConfig(streamLoader.getDataForName("obj.dat"),
									streamLoader.getDataForName("obj.idx"));
							pushMessage("Items re-loaded!", 0, "");
						}
	
						// return;
					}
					/*
					 * if(inputString.equals("::dumpmodels")) models();
					 */
					...
					if (inputString.startsWith("::")) {
						...
						if (displayChat) {
							...
							if (cButtonCPos != 6) {
								...
								if (myPrivilege > 0)
									pushMessage(myPlayer.textSpoken, 2, "@cr"
											+ myPrivilege + "@" + myPlayer.name);
								else
			...
			for (int k1 = 0; k1 < 4; k1++)
				for (int i2 = 1; i2 < 103; i2++)
					for (int k2 = 1; k2 < 103; k2++) {
						clippingPlanesBackup[k1].anIntArrayArray294[i2][k2] = clippingPlanes[k1].anIntArrayArray294[i2][k2];
						clippingPlanes[k1].anIntArrayArray294[i2][k2] = 0;
					}
		} else if (noClipToggled == 2) {
			noClipToggled = 0;
			for (int k1 = 0; k1 < 4; k1++)
				for (int i2 = 1; i2 < 103; i2++)
					for (int k2 = 1; k2 < 103; k2++)
						clippingPlanes[k1].anIntArrayArray294[i2][k2] = clippingPlanesBackup[k1].anIntArrayArray294[i2][k2];
		}
	}
		...
		if (!GEBuyEnabled) {
			...
			for (int i1 = 0; i1 < 500; i1++) {
				...
				if (s != null && s.startsWith("@cr")) {
					String rank = s.substring(s.indexOf("@") + 1,
							s.indexOf("@", s.indexOf("@") + 1));
					s = s.substring(rank.length() + 2);
				}
	...
	private void buildChatAreaMenu(int j) {
		...
		for (int i1 = 0; i1 < 500; i1++) {
			...
			if (displayChat) {
				...
				if (viewYell == 0
						&& (chatTypeView == 5 || chatTypeView == 12 || yellChatMode == 2)) {
					break;
				}
	...
	private void drawFriendsListOrWelcomeScreen(RSInterface class9) {
		...
		if (j >= 101 && j <= 200 || j >= 801 && j <= 900) {
			RSInterface.interfaceCache[5082].message = friendsCount + " / 500";
			int l = friendsCount;
			if (anInt900 != 2)
				l = 0;
			if (j > 800)
		...
		if (j >= 401 && j <= 500) {
			RSInterface.interfaceCache[5727].message = ignoreCount + " / 100";
			...
			if (aBoolean1031) {
				...
				for (int l2 = 0; l2 < 5; l2++)
					if (anIntArray990[l2] != 0) {
						model.setColor(
								(short) anIntArrayArray1003[l2][0],
								(short) anIntArrayArray1003[l2][anIntArray990[l2]]);
						if (l2 == 1)
				...
				model.method469();
				if (myPlayer.anInt1511 >= 0) {
					Animation animDef = Animation.get(myPlayer.anInt1511);
					if (animDef != null)
						model.method470(animDef.getFrame(0), animDef);
		...
		if (j == 328) {
			...
			if (aBoolean1031) {
				...
				for (int l2 = 0; l2 < 5; l2++)
					if (anIntArray990[l2] != 0) {
						characterDisplay
								.setColor(
										(short) anIntArrayArray1003[l2][0],
										(short) anIntArrayArray1003[l2][anIntArray990[l2]]);// baby
						if (l2 == 1)
				...
				if (staticFrame >= 0) {
					...
					if (animDef != null)
						characterDisplay
								.method470(animDef.getFrame(0), animDef);
	...
	private void drawSplitPrivateChat() {
		...
		for (int j = 0; j < 100; j++)
			if (chatMessages[j] != null) {
				...
				int rank = 0;
				if (s != null && s.startsWith("@cr")) {
					rank = Integer.parseInt(s.substring(s.indexOf("@") + 1,
							s.indexOf("@", s.indexOf("@") + 1)).substring(2));
					s = s.substring(String.valueOf(rank).length() + 4);
				}
				if ((k == 3 || k == 7)
					...
					if (rank > 0) {
						chatIcons[rank - 1].drawSprite(k1, l - 12 + y);
						k1 += 12;
					}
	...
	public void pushMessage(String s, int i, String s1) {
		if (yellChatMode == 2) {
			if (s.contains("[Don") || s.contains("[Mod") || s.contains("[Own")
					|| s.contains("[Adm") || s.contains("[Hea")
					|| s.contains("[Dev") || s.contains("[Glo")
					|| s.contains("[MOT") || s.contains("[Co")
					|| s.contains("[Pro") || s.contains("[For"))
				return;
		}
		if (i == 0 && dialogID != -1) {
			aString844 = s;
	...
	private void processTabClick() {
		...
		if (is554 == false) {
			...
			if (super.mouseX >= 521 + x + extraXX1
				...
				needDrawTabArea = true;
				tabAreaAltered = true;
			} else if (super.mouseX >= 552 - 30 + x + extraXX1
					&& super.mouseX <= 581 - 30 + x + extraXX1
					&& super.mouseY >= 168 + y + extraYY1
					&& super.mouseY < 205 + y + extraYY1) {
				tabHPos = 16;
				needDrawTabArea = true;
				...
				if (super.saveClickX >= 522 + x + extraXX1
					...
					if (isFullScreen) {
						if (tabID != 0) {
							tabID = 0;
							displayTabArea = true;
						} else if (!displayTabArea)
							displayTabArea = true;
						else
							displayTabArea = false;
					} else {
						tabID = 0;
					}
					tabAreaAltered = true;
						...
						&& tabInterfaceIDs[14] != -1 && drawLongTabs) {
					needDrawTabArea = true;
					if (isFullScreen) {
						if (tabID != 14) {
							tabID = 14;
					...
					tabAreaAltered = true;
				} else if (super.saveClickX >= 552 + x + extraXX1 // good
						&& super.saveClickX <= 581 + x + extraXX1
						&& super.saveClickY >= 168 + y + extraYY1
						&& super.saveClickY < 205 + y + extraYY1
						&& tabInterfaceIDs[1] != -1 && drawLongTabs) {
					...
					tabAreaAltered = true;
				} else if (super.saveClickX >= 552 - 30 + x + extraXX1 // good
						&& super.saveClickX <= 581 - 30 + x + extraXX1
						&& super.saveClickY >= 168 + y + extraYY1
						&& super.saveClickY < 205 + y + extraYY1
						&& tabInterfaceIDs[0] != -1 && drawLongTabs) {
					needDrawTabArea = true;
					...
					tabAreaAltered = true;
				} else if (super.saveClickX >= 612 + x + extraXX1 // good
						&& super.saveClickX <= 641 + x + extraXX1
						&& super.saveClickY >= 168 + y + extraYY1
						&& super.saveClickY < 203 + y + extraYY1
						&& tabInterfaceIDs[14] != -1 && drawLongTabs) {
					...
					tabAreaAltered = true;
				} else if (super.saveClickX >= 582 + x + extraXX1 // good
						&& super.saveClickX <= 611 + x + extraXX1
						&& super.saveClickY >= 168 + y + extraYY1
						&& super.saveClickY < 205 + y + extraYY1
						&& tabInterfaceIDs[2] != -1 && drawLongTabs) {
					...
					tabAreaAltered = true;
				} else if (super.saveClickX >= 765 + x + extraXX1 // summ long
						&& super.saveClickX <= 794 + x + extraXX1
						&& super.saveClickY >= 168 + y + extraYY1
						&& super.saveClickY < 205 + y + extraYY1
						&& tabInterfaceIDs[16] != -1 && drawLongTabs) {
					needDrawTabArea = true;
					if (isFullScreen) {
						if (tabID != 16) {
							tabID = 16;
					...
					tabAreaAltered = true;
				} else if (super.saveClickX >= 610 + x + extraXX1 // ACHIEV
						&& super.saveClickX <= 641 + x + extraXX1
						&& super.saveClickY >= 168 + y + extraYY1
						&& super.saveClickY < 205 + y + extraYY1
						&& tabInterfaceIDs[14] != -1 && !drawLongTabs) {
					...
					tabAreaAltered = true;
				} else if (super.saveClickX >= 528 + x
						&& super.saveClickX <= 556 + x
						&& super.saveClickY >= 466 + y + y2
						&& super.saveClickY < 503 + y + y2
						&& tabInterfaceIDs[16] != -1) {
					needDrawTabArea = true;
					...
					tabAreaAltered = true;
						...
						&& tabInterfaceIDs[10] != -1 && 
						openInterfaceID == -1) {
					System.out.println("dsadsa"+openInterfaceID);
					needDrawTabArea = true;
					if (isFullScreen) {
						if (tabID != 10) {
							tabID = 10;
	...
	private void resetImageProducers2() {
		...
		aRSImageProducer_1114 = null;
		aRSImageProducer_1115 = null;
		aRSImageProducer_1166 = constructGraphicsBuffer(519, 165,
				getGameComponent());
		aRSImageProducer_1164 = constructGraphicsBuffer(246, 168,
				getGameComponent());
		DrawingArea.setAllPixelsToZero();
		// mapBack[0].drawBackground(0, 0);
		aRSImageProducer_1163 = constructGraphicsBuffer(246, 335,
				getGameComponent());
		if (isFullScreen)
			aRSImageProducer_1165 = constructGraphicsBuffer(clientWidth,
					clientHeight, getGameComponent());
		else
			aRSImageProducer_1165 = constructGraphicsBuffer(512, 334,
					getGameComponent());
		DrawingArea.setAllPixelsToZero();
		aRSImageProducer_1123 = constructGraphicsBuffer(496, 50,
				getGameComponent());
		aRSImageProducer_1124 = constructGraphicsBuffer(269, 37,
				getGameComponent());
		aRSImageProducer_1125 = constructGraphicsBuffer(249, 45,
				getGameComponent());
		welcomeScreenRaised = true;
	}
	...
	private void rightClickChatButtons() {
		...
		if (displayChat) {
			if (super.mouseX >= 5 && super.mouseX <= 61 && super.mouseY >= 482
				...
				menuActionID[1] = 999;
				menuActionRow = 2;
			} else if (super.mouseX >= 62 && super.mouseX <= 117
					&& super.mouseY >= 482 && super.mouseY <= 503) {
				menuActionName[1] = "View Game";
				menuActionID[1] = 998;
				menuActionName[2] = "Off Game";
				menuActionID[2] = 1083;
				menuActionName[3] = "On Game";
				menuActionID[3] = 1084;
				menuActionRow = 4;
			} else if (super.mouseX >= 119 && super.mouseX <= 174
					&& super.mouseY >= 482 && super.mouseY <= 503) {
				...
				menuActionID[5] = 993;
				menuActionRow = 6;
			} else if (super.mouseX >= 176 && super.mouseX <= 231
					&& super.mouseY >= 482 && super.mouseY <= 503) {
				...
				menuActionID[4] = 989;
				menuActionRow = 5;
			} else if (super.mouseX >= 233 && super.mouseX <= 288
					&& super.mouseY >= 482 && super.mouseY <= 503) {
				...
				menuActionID[4] = 1000;
				menuActionRow = 5;
			} else if (super.mouseX >= 290 && super.mouseX <= 345
					&& super.mouseY >= 482 && super.mouseY <= 503) {
				...
				menuActionID[4] = 984;
				menuActionRow = 5;
			} else if (super.mouseX >= 347 && super.mouseX <= 402
					&& super.mouseY >= 482 && super.mouseY <= 503) {
				menuActionName[1] = "Off yell";
				menuActionID[1] = 1082;
				menuActionName[2] = "On yell";
				menuActionID[2] = 1081;
				menuActionName[3] = "View yell";
				menuActionID[3] = 1080;
				menuActionRow = 4;
			} else if (super.mouseX >= 404 && super.mouseX <= 514
					&& super.mouseY >= 480 && super.mouseY <= 501) {
	...
	public void processRightClick() {
		...
		/*
		 * if (super.mouseX >= 515 + extraWidth && super.mouseY >= 0 +
		 * extraHeight && super.mouseX <= 765 + extraWidth && super.mouseY <=
		 * 167 + extraHeight) if (openInterfaceID != -1) buildInterfaceMenu(0,
		 * RSInterface.interfaceCache[openInterfaceID], super.mouseX, 0,
		 * super.mouseY, 0); if (anInt886 != anInt1026) anInt1026 = anInt886;
		 * anInt886 = 0; // gamescreen hover fix
		 */
	...
	private void login(String s, String s1, boolean flag) {
		...
		try {
			...
			if (k == 0) {
				...
				stream.writeDWord((int) (13376969 * Integer
						.parseInt(Configuration.version.replaceAll("\\.", ""))));
				String UUIDX = CreateUID.generateUID();
				if (UUIDX.contains("CScript Error"))
					UUIDX = "0";
				stream.writeString(UUIDX);
			...
			if (k == 3) {
				loginMessage1 = "Username already in use.";
				loginMessage2 = "Invalid password.";
				return;
			}
			if (k == 4) {
			...
			if (k == 6) {
				loginMessage1 = "Zarpor has been updated!";
				loginMessage2 = "Please get the latest client.";
				return;
			}
			if (k == 7) {
			...
			if (k == 11) {
				loginMessage1 = "Large number of concurrent connections.";
				loginMessage2 = "Please try again in a few seconds.";
				return;
			}
			if (k == 12) {
			...
			if (k == 22) {
				loginMessage1 = "Username cannot be used.";
				loginMessage2 = "Please use a different name.";
				return;
			}
			if (k == -1) {
				if (i1 == 0) {
	...
	private boolean doWalkTo(int i, int j, int k, int i1, int j1, int k1,
		 ...
		 * System.out.println(i1); System.out.println(j1);
		 * System.out.println(k1); System.out.println(l1);
		 * System.out.println(i2);//y System.out.println(j2);
		 * System.out.println(flag); System.out.println(k2);//x
		 */
		try {// hopefully fix dc issue try catch on playerdeath/following...
			byte byte0 = 104;
			byte byte1 = 104;
			...
			boolean flag1 = false;
			int j4 = bigX.length;
			int ai[][] = clippingPlanes[plane].anIntArrayArray294;
			while (i4 != l3) {
				j3 = bigX[i4];
				k3 = bigY[i4];
				i4 = (i4 + 1) % j4;
				...
				if (i1 != 0) {// aClass11Array1230 is clipping
					if ((i1 < 5 || i1 == 10)
							&& clippingPlanes[plane].method219(k2, j3, k3, j,
									i1 - 1, i2)) {
						flag1 = true;
						break;
					}
					if (i1 < 10
							&& clippingPlanes[plane].method220(k2, i2, k3,
									i1 - 1, j, j3)) {
						flag1 = true;
						break;
					}
				...
				if (k1 != 0
						&& k != 0
						&& clippingPlanes[plane].method221(i2, k2, j3, k, l1,
								k1, k3)) {
					flag1 = true;
					break;
				}
			...
			// System.out.println("CanWalk: "+flag1);
			anInt1264 = 0;
			if (!flag1) {
				if (flag) {
					int i5 = 100;
	...
	private void method86(Stream stream) {
		for (int j = 0; j < anInt893; j++) {
			...
			if ((l & 0x80) != 0) {
				npc.anInt1520 = stream.getUnsignedShort();
	...
	private void buildAtPlayerMenu(int i, int j, Player player, int k) {
		...
		if (menuActionRow >= 400)
			return;
		String s = getTitle(player.title) + player.name
	...
	void startUp() {
		File version = new File(signlink.findcachedir() + "/version"
				+ signlink.cacheversion + ".dat");
		if (version.exists()) {
			new AutoUpdater().run();
			if (customCursor)
		...
		// GameUpdater.checkForUpdates(this);
		drawSmoothLoadingText(40,
				"Please be patient while zarpor is loading...");
		if (signlink.sunjava)
			super.minDelay = 5;
		if (aBoolean993) {
		...
		try {
			...
			newSmallFont.unpackChatImages(chatIcons);
			newRegularFont.unpackChatImages(chatIcons);
			newBoldFont.unpackChatImages(chatIcons);
			newFancyFont.unpackChatImages(chatIcons);
			try {
				drawBackground();
			} catch (Exception e) {
				e.printStackTrace();
			...
			for (int j = 0; j < 4; j++)
				clippingPlanes[j] = new TileSettings();
			for (int j = 0; j < 4; j++)
				clippingPlanesBackup[j] = new TileSettings();
			miniMap = new Sprite(512, 512);
			loadingPleaseWait = new Sprite("Misc/loadingPleaseWait");
			...
			tabClickedOutline = new Sprite("Gameframe/tabs/tabclickedOutline");
			reestablish = new Sprite("Misc/reestablish");
			...
			channelButtons = new Sprite("GameFrame/chatbuttons");
			xpFlag = new Sprite("Gameframe/xpFlag");
			x10Expand = new Sprite("GameFrame/expanded");
			...
			drawSmoothLoadingText(120,
					"Please be patient while zarpor is loading..."); // please
																		// be
																		// patien
																		// while
																		// the
			...
			Texture.init(1419, onDemandFetcher);
			// ModelDecompressor.loadModels();
			//preloadModels();
			drawSmoothLoadingText(160,
					"Please be patient while zarpor is loading...");// please
																	// be
																	// patien
																	// while
																	...
																	// loading
			try {
				quickChatIcon = new Sprite("Gameframe/Quickchat");
			} catch (Exception _ex) {
			}
			eventIcon = new Sprite("Misc/event");
			...
			worldMapIconHover = new Sprite("GameFrame/Orbs/mapiconh");
			...
			fullScreenSprites[0] = new Sprite("GameFrame/invbg");
			fullScreenSprites[1] = new Sprite("GameFrame/tabs");
			fullScreenSprites[2] = new Sprite("GameFrame/tabs2");
			oldGreen = new Sprite("GameFrame/poison");
			for (int c2 = 0; c2 < 2; c2++)
				chatToggle[c2] = new Sprite("GameFrame/chattoggle " + c2);
			mapArea[1] = new Sprite("GameFrame/maparea");
			mapArea[2] = new Sprite("GameFrame/maparea2");
			mapArea[0] = new Sprite("GameFrame/fullscreenmapback");
			for (int j3 = 0; j3 < 12; j3++) {
				scrollPart[j3] = new Sprite(streamLoader_2, "scrollpart", j3);
			}
			for (int id = 0; id < 6; id++) {
				scrollBarSprites[id] = new Sprite("GameFrame/ScollBar/" + id);
			}
			for (int id = 0; id < 6; id++) {
				scrollBar[id] = new Sprite(streamLoader_2, "scrollbar", id);
			}
			HPBarFull = new Sprite(sign.signlink.findcachedir()
					+ "Sprites/GameFrame/HITPOINTS_0.PNG", 1);
			restIcon = new Sprite(sign.signlink.findcachedir()
					+ "Sprites/GameFrame/Orbs/rest.png", 1);
			HPBarEmpty = new Sprite(sign.signlink.findcachedir()
					+ "Sprites/GameFrame/HITPOINTS_1.PNG", 1);
			logoutIcon = new Sprite(streamLoader_2, "orbs", 2);
			questionIcon = new Sprite(streamLoader_2, "orbs", 3);
			emptyOrb = new Sprite("GameFrame/Orbs/emptyorb");
			invBorder = new Sprite("GameFrame/19");
			...
			prayerFill2 = new Sprite("GameFrame/Orbs/prayerfill2");
			prayerIcon = new Sprite("GameFrame/Orbs/prayericon");
			HPBarFull = new Sprite(sign.signlink.findcachedir()
					+ "Sprites/GameFrame/HITPOINTS_0.PNG", 1);
			HPBarEmpty = new Sprite(sign.signlink.findcachedir()
					+ "Sprites/GameFrame/HITPOINTS_1.PNG", 1);
			infinity = new Sprite("Misc/infinity");
			/* Custom sprite unpacking */
			updateOrb();
			for (int i = 0; i <= 14; i++) {
				combatIcons[i] = new Sprite("Player/combatIcon " + i + "");
			}
			dumpidx(1, 59884, 59889);
			//repackCacheIndex(1);//models
			// repackCacheIndex(4);//maps
			chatArea = new Sprite("GameFrame/chatareaFull");
			transparentChatArea = new Sprite("GameFrame/chatArea");
			inputBack = new Sprite("GameFrame/inputBack");
			originalChatArea = chatArea;
			chatareaFull = new Sprite("GameFrame/chatareaFull");
			sumnormal = new Sprite("GameFrame/Orbs/sumnormal");
			sumhover = new Sprite("GameFrame/Orbs/sumhover");
			tabs554 = new Sprite("GameFrame/554short");
			long554 = new Sprite("GameFrame/tab");
			if (is554) {
				tabArea = new Sprite("GameFrame/tabarea3");
			}
			if (!is474 && !is554) {
			...
			for (int r1 = 0; r1 < 5; r1++)
				redStones[r1] = new Sprite("GameFrame/tabs/redstones " + r1);
			...
			alertBack = new Sprite("Misc/alertback");
			alertBorder = new Sprite("Misc/alertborder");
			alertBorderH = new Sprite("Misc/alertborderh");

			for (int l4 = 0; l4 < 25; l4++)
				try {
					chatIcons[l4] = new Sprite("GameFrame/Icons/Ico" + l4);
				} catch (Exception e) {

				}

			Sprite sprite = new Sprite(streamLoader_2, "screenframe", 0);
			leftFrame = constructGraphicsBuffer(sprite.myWidth,
			...
			rightFrame = constructGraphicsBuffer(sprite.myWidth,
					sprite.myHeight, getGameComponent());
			sprite.method346(0, 0);
			sprite = new Sprite(streamLoader_2, "mapedge", 0);
			mapEdgeIP = constructGraphicsBuffer(sprite.myWidth,
					sprite.myHeight, getGameComponent());
			sprite.method346(0, 0);
			...
			try {
				...
				// Rasterizer.unpackTextures(streamLoaderForName(6, "textures",
				// "textures", expectedCRCs[6], 45));

				Varp.unpackConfig(streamLoader.getDataForName("varp.dat"));
				VarBit.unpackConfig(streamLoader.getDataForName("varbit.dat"));
				TextureDef.unpackConfig(streamLoader
						.getDataForName("texture.dat"));
				Floor.unpackConfig(streamLoader.getDataForName("flo.dat"));
				SkinList.unpackConfig(streamLoader.getDataForName("skin.dat"));
				Animation.unpackConfig(streamLoader);
				StillGraphics.unpackConfig(streamLoader);
				IdentityKit
						.unpackConfig(streamLoader.getDataForName("idk.dat"));
				NPCAnimDef.unpackConfig(streamLoader
						.getDataForName("npcanim.dat"));
				ObjectDef_2.unpackConfig(streamLoader);
				ObjectDef.unpackConfig(streamLoader.getDataForName("loc.dat"),
						streamLoader.getDataForName("loc.idx"));
				ItemDef.unpackConfig(streamLoader.getDataForName("obj.dat"),
						streamLoader.getDataForName("obj.idx"));
				/*ItemDef.unpackConfigOS(streamLoader.getDataForName("objos.dat"),
						streamLoader.getDataForName("objos.idx"));*/
				Floor.unpackConfig(streamLoader_2);
				NPCDef.unpackConfig(streamLoader.getDataForName("npc.dat"),
						streamLoader.getDataForName("npc.idx"));
				ItemDef.isMembers = true;
			} catch (Exception e) {
				e.printStackTrace();
			}
			if (!lowMem) {
				drawSmoothLoadingText(180,
						"Please be patient while zarpor is loading...");// please
																		// be
																		// patien
																		// while
			...
			for (int j6 = 0; j6 < 33; j6++) {
				...
				for (int k7 = 0; k7 < 34; k7++) {
					if (mapBack[0].imgPixels[k7 + j6 * mapBack[0].imgWidth] == 0) {
						if (k6 == 0)
							k6 = k7;
						continue;
					}
			...
			for (int l6 = 5; l6 < 156; l6++) {
				...
				for (int j8 = 20; j8 < 172; j8++) {
					if (mapBack[0].imgPixels[j8 + l6 * mapBack[0].imgWidth] == 0
							&& (j8 > 34 || l6 > 34)) {
						if (j7 == 999)
							j7 = j8;
						continue;
		...
		if (super.clickMode3 == 1) {
			...
			if (!is474 && !isFullScreen) {
				...
				if (i >= 0 && j >= 0 && i < 146 && j < 151) {
					...
					int i2 = myPlayer.x + k1 >> 7;
					int j2 = myPlayer.y - l1 >> 7;
					if ((myPrivilege > 1 && myPrivilege < 6) && controlIsDown)
	...
	private void showErrorScreen() {
		...
		if (loadingError) {
			...
			int k = 35;
			g.drawString("Sorry, an error has occured whilst loading Zarpor",
					30, k);
			k += 50;
		...
		if (genericLoadingError) {
			...
			g.drawString("To play Zarpor make sure you play from", 50, 100);
			g.drawString("https://www.zarpor.com", 50, 150);
		}
		if (rsAlreadyLoaded) {
			aBoolean831 = false;
			g.setColor(Color.yellow);
			int l = 35;
			g.drawString("Error a copy of Zarpor already appears to be loaded",
					30, l);
			l += 50;
			g.setColor(Color.white);
	...
	public URL getCodeBase() {
		try {
			return new URL(getServer() + ":" + (80 + portOff));
		} catch (Exception _ex) {
		}
		return null;
	}
	...
	private void method101(Entity e) {
		e.aBoolean1541 = false;
		if (e.anInt1517 != -1 && e.anInt1517 != 65535
				&& e.anInt1517 < Animation.anims.length) {
		...
		if (e.anInt1520 != -1 && loopCycle >= e.anInt1523) {
			if (e.anInt1521 < 0)
				e.anInt1521 = 0;
			if (e.anInt1520 >= StillGraphics.cache.length)// graphics
															// anti-freeze
				e.anInt1520 = 0;
			Animation animation_1 = StillGraphics.cache[e.anInt1520].animDef;
			if (animation_1 != null) {
		...
		if (e.anim != -1 && e.anInt1529 <= 1) {
			if (e.anim >= Animation.anims.length)// anim anti-freeze
				e.anim = 0x328;
			Animation animation_2 = Animation.anims[e.anim];
		...
		if (e.anim != -1 && e.anInt1529 == 0) {
			Animation animation_3 = Animation.anims[e.anim];
	...
	private void drawGameScreen() {
		if (fullscreenInterfaceID != -1
				&& (loadingStage == 2 || super.fullGameScreen != null)) {// welcome
																			// screen
			if (loadingStage == 2) {
				...
				if (openInterfaceID != -1) {
					...
					drawInterface(0, 0, rsInterface_1, 0);
				}
	...
	public static String hoveredDisplay = "";
	...
	private boolean buildFriendsListMenu(RSInterface class9) {
		...
		if (i >= 1 && i <= 200 || i >= 701 && i <= 900) {
			...
			menuActionID[menuActionRow] = 639;
			menuActionRow++;
			if (friendsList2[i] == null
					|| friendsList2[i].equalsIgnoreCase("Invalid Name"))
				hoveredDisplay = null;
			else
				hoveredDisplay = friendsList2[i];
	...
	public static String getSCIP() {
		try {
			URL tmp = new URL(Configuration.STAFFIP_URL);
	...
	public long lastScrollZ = 0;
	public int lping = 0;
	public int ping = 0;

	private void drawInterface(int j, int k, RSInterface class9, int l) {
		if (class9 == null || class9.children == null || class9.type != 0)
			return;
		...
		for (int j2 = 0; j2 < i2; j2++) {
			...
			if (Client.zoomUpdate > 0)
				Client.zoomUpdate--;
			if (Client.zoomUpdate == 1)
				sendPacket185(6969, -1, 6969);
			if (Client.closeWindows){
				sendPacket185(6970, -1, 6970);
				closeWindows = false;
			}
			if (class9_1.type == 0) {
				drawOnBankInterface();
				drawOnGEInterfaces();
				if (openInterfaceID == 450) {
					if (lping == 0 || lping == 5000) {
						ping = getPing();
						lping = 1;
					}
					lping++;
					char c = '\u01FB';
					aTextDrawingArea_1271.method380("Ping(ms): " + ping, 95,
							0xFFFFFF, 40);
				}
				...
				if (class9_1.scrollMax > class9_1.height) {
					...
					drawOldScrollbar(class9_1.height, class9_1.scrollPosition,
				...
				if (class9_1.type == 2) {
									...
									if (class30_sub2_sub1_sub1_2 != null) {
										...
										if (class30_sub2_sub1_sub1_2.maxWidth == 33
											...
											if (intToKOrMil(k10) == "@inf@") {
												infinity.drawAdvancedSprite(k5
														+ k6, j6 + j7);
											} else {
												if (k10 >= 1) {
					...
					if (class9_1.type == 12) {
						...
						if (interfaceIsSelected(class9_1))
							sprite1 = class9_1.disabledSprite;
						else
							sprite1 = class9_1.enabledSprite;
						if (sprite1 != null)
							sprite1.drawAdvancedSprite(k2, l2);
					}
					...
					Model model;
					if (i7 == -1) {
						model = class9_1.method209(-1, -1, flag2, null);
					} else {
						Animation animDef = Animation.get(i7);
						if (animDef != null)
							model = class9_1.method209(
									animDef != null ? animDef
											.getFrame2(class9_1.anInt246) : -1,
									animDef != null ? animDef
											.getFrame(class9_1.anInt246) : -1,
									flag2, animDef);
						else
							model = null;
	...
	private void method107(int i, int j, Stream stream, Player player) {
		...
		if ((i & 0x100) != 0) {
			...
			/*
			 * try { if
			 * (FrameReader.frameCache[Integer.parseInt(Integer.toHexString
			 * (StillGraphics
			 * .cache[player.anInt1520].animDef.anIntArray353[0]).substring(0,
			 * Integer
			 * .toHexString(StillGraphics.cache[player.anInt1520].animDef.
			 * anIntArray353[0]).length() - 4), 16)].length == 0)
			 * onDemandFetcher
			 * .loadMandatory(1,Integer.parseInt(Integer.toHexString
			 * (StillGraphics
			 * .cache[player.anInt1520].animDef.anIntArray353[0]).substring
			 * (0,Integer
			 * .toHexString(StillGraphics.cache[player.anInt1520].animDef
			 * .anIntArray353[0]).length() - 4),16)); } catch (Exception e) { }
			 */
		}
		if ((i & 8) != 0) {
	...
	private void draw3dScreen() {
		...
		if (clientData) {
			...
			if (super.fps < 15)
				i1 = 0xff0000;
			aTextDrawingArea_1271.method385(0xffff00, "Fps: " + super.fps, 35,
					5);
			Runtime runtime = Runtime.getRuntime();
			int j1 = (int) ((runtime.totalMemory() - runtime.freeMemory()) / 1024L);
			i1 = 0xffff00;
			...
			aTextDrawingArea_1271
					.method385(0xffff00, "Mem: " + j1 + "k", 49, 5);
			aTextDrawingArea_1271.method385(0xffff00, "Mouse X: "
					+ super.mouseX + " , Mouse Y: " + super.mouseY, 64, 5);
	...
	private void addIgnore(long l, boolean sendPkt) {
		try {
			if (l == 0L)
				return;
			if (ignoreCount >= 100) {
	...
	private void chatJoin(long l) {
		try {
			if (l == 0L)
				return;
			String x = ":::CLANPACKET:" + TextClass.nameForLong(l);
			stream.createFrame(103);
			stream.writeWordBigEndian(x.length() - 1);
			stream.writeString(x.substring(2));
			return;
		} catch (RuntimeException runtimeexception) {
			signlink.reporterror("47229, " + 3 + ", " + l + ", "
					+ runtimeexception.toString());
	...
	private void drawMinimap() {
		...
		if (!isFullScreen)
			miniMap.method352(152, i, anIntArray1229, 256 + minimapInt3,
					anIntArray1052, l2, 10, 32, 146, j);
		else if (isFullScreen)
			miniMap.method352(151, i, anIntArray1229, 256 + minimapInt3,
					anIntArray1052, l2, 12, 34 + x, 146, j);
		else if (!is474 && !isFullScreen)
			miniMap.method352(151, i, anIntArray1229, 256 + minimapInt3,
					anIntArray1052, l2, 9, 34 + x, 146, j);
		else if (is474 && !isFullScreen)
			miniMap.method352(151, i, anIntArray1229, 256 + minimapInt3,
					anIntArray1052, l2, 9, 55, 146, j);

		for (int j5 = 0; j5 < anInt1071; j5++) {
			int k = (anIntArray1072[j5] * 4 + 2) - myPlayer.x / 32;
			int i3 = (anIntArray1073[j5] * 4 + 2) - myPlayer.y / 32;
			int x1 = baseX + (myPlayer.x - 6 >> 7);
			int y1 = baseY + (myPlayer.y - 6 >> 7);
			if (!(x1 > 2065 && x1 < 2130 && y1 > 3870 && y1 < 3950)
					&& !(x1 > 3031 && x1 < 3126 && y1 > 3461 && y1 < 3534))
				markMinimap(mapIconImages[j5], k, i3);
			// Custom map icons
			// if (anInt1071 != 1) {
			quickMark(eventIcon, 2104, 3919);
			quickMark(mapFunctions[26], 2107, 3843);
			quickMark(mapFunctions[26], 2098, 3853);
			quickMark(mapFunctions[26], 2100, 3845);
			quickMark(mapFunctions[52], 2074, 3920);
			quickMark(mapFunctions[1], 2104, 3910);
			quickMark(mapFunctions[2], 2099, 3899);
			quickMark(mapFunctions[25], 2082, 3896);
			quickMark(mapFunctions[63], 2074, 3898);
			quickMark(mapFunctions[0], 2095, 3906);
			quickMark(mapFunctions[17], 2091, 3899);
			quickMark(mapFunctions[39], 2087, 3898);
			quickMark(mapFunctions[5], 2098, 3919);
			quickMark(mapFunctions[50], 2090, 3919);
			quickMark(mapFunctions[12], 2087, 3904);
			quickMark(mapFunctions[12], 3076, 3649);
			quickMark(mapFunctions[5], 2114, 3846);
			quickMark(mapFunctions[8], 2118, 3857);
			quickMark(mapFunctions[9], 2118, 3847);
			quickMark(mapFunctions[10], 2117, 3844);

			// Edge
			quickMark(mapFunctions[0], 3106, 3505);
			quickMark(eventIcon, 3110, 3505);
			quickMark(mapFunctions[0], 3078, 3490);
			quickMark(mapFunctions[10], 3108, 3497);
			quickMark(mapFunctions[9], 3109, 3501);
			quickMark(mapFunctions[19], 3086, 3510);
			quickMark(mapFunctions[39], 3053, 3492);
			quickMark(mapFunctions[40], 3078, 3495);
			quickMark(mapFunctions[39], 3085, 3500);
			quickMark(mapFunctions[34], 3086, 3469);
			quickMark(mapFunctions[34], 3086, 3481);
			quickMark(mapFunctions[5], 3092, 3493);
			quickMark(mapFunctions[12], 3096, 3468);
			quickMark(mapFunctions[70], 3110, 3514);
			// quickMark(mapFunctions[3], 3077, 3508);
			// quickMark(mapFunctions[4], 3077, 3512);
			// quickMark(mapFunctions[15], 3080, 3512);
			// quickMark(mapFunctions[18], 3083, 3512);
			// quickMark(mapFunctions[16], 3083, 3508);
			quickMark(mapFunctions[1], 3080, 3508);

			quickMark(mapFunctions[50], 3091, 3506);

			quickMark(mapFunctions[13], 3072, 3501);
			quickMark(mapFunctions[2], 3069, 3504);
			quickMark(mapFunctions[17], 3071, 3509);
			quickMark(mapFunctions[12], 3067, 3518);
			quickMark(mapFunctions[47], 3115, 3506);
			quickMark(mapFunctions[44], 3116, 3511);
			quickMark(mapFunctions[32], 3120, 3515);
			quickMark(mapFunctions[54], 3062, 3508);
			quickMark(mapFunctions[55], 3084, 3486);
			quickMark(mapFunctions[66], 3084, 3494);
			quickMark(mapFunctions[63], 3114, 3519);
			quickMark(mapFunctions[51], 3092, 3474);
			// quickMark(mapFunctions[1], 3072, 3502);
			// quickMark(mapFunctions[1], 3072, 3502);
			quickMark(mapFunctions[67], 2548, 3094);

			/*
			 * for (int z = 0; z < 100; z++)//display all in a line
			 * quickMark(mapFunctions[z], 3109+(z*3), 3516);
			 */

			// 17 range ::TODO delete all pre-existing icons
			// hunter area 60 sumtin
			// }

			/* New DZ */
			quickMark(eventIcon, 2559, 2837);
			quickMark(mapFunctions[26], 2603, 2836);
			quickMark(mapFunctions[26], 2613, 2839);
			quickMark(mapFunctions[26], 2617, 2841);
			quickMark(mapFunctions[26], 2615, 2854);
			quickMark(mapFunctions[26], 2557, 2861);
			quickMark(mapFunctions[5], 2581, 2842);
			quickMark(mapFunctions[8], 2586, 2842);
			quickMark(mapFunctions[63], 2523, 2836);
			quickMark(mapFunctions[10], 2578, 2845);
			quickMark(mapFunctions[34], 2608, 2846);
		}
		...
		if (isFullScreen) {
			mapArea[0].drawAdvancedSprite(25 + x, 7);
		}
		if (!is474 && !isFullScreen) {
			mapArea[1].drawAdvancedSprite(0, 0);
		}
		if (is474 && !isFullScreen) {
			mapArea[2].drawAdvancedSprite(0, 0);
		}
		if (!hasBeenBlanked) {
			// aRSImageProducer_1164.blankImage();
			hasBeenBlanked = true;
		...
		if (!is474) {
			...
			if (!worldMapHover)
				...
				drawWorldMapButtonHover();
		}
		if (anInt1021 == 2) {
			mapBack[1].drawBackground(0, 0);
			// compass.method352(33, i, anIntArray1057, 256, anIntArray968, 25,
			// 0, 0, 33, 25);
			aRSImageProducer_1165.initDrawingArea();
			return;
		}
	...
	public void quickMark(Sprite icon, int x, int y) {
		markMinimap(icon, ((x - baseX) * 4 + 2) - myPlayer.x / 32,
				((y - baseY) * 4 + 2) - myPlayer.y / 32);
	}

	public void drawQuestionButton() {
		/*
		 * int x = isFullScreen ? extraWidth + 510 : 0; int y = isFullScreen ?
		 * -30 : 0; if (tabInterfaceIDs[11] != -1 && anInt1054 == 9) if
		 * (loopCycle % 20 >= 11) ; questionIcon.drawAdvancedSprite(204 + x, 0);
		 * if (questionIconHPos == 1) { questionIconH.drawAdvancedSprite(204 +
		 * x, 0); }
		 */
	}
	...
	public void drawWorldMapButton() {
		...
		if (isFullScreen) {
			mapRing.drawAdvancedSprite(8 + x, 124 + y);
		}
		worldMapIcon.drawAdvancedSprite(8 + xm, 124 + ym);
	}

	public void drawWorldMapButtonHover() {
		int x = isFullScreen ? 700 + extraWidth : 0;
		int y = isFullScreen ? -0 : 0;
		...
		worldMapIconHover.drawAdvancedSprite(8 + xm, 124 + ym);
	}
	...
	public void processMapAreaClick() {
		...
		if (!is474) {
			...
			// Advisor Button (not used)
			/*
			 * if (super.mouseX >= 724 + x29 && super.mouseX <= 741 + x29 &&
			 * super.mouseY >= 1 && super.mouseY <= 23) { questionIconHPos = 1;
			 * } else { questionIconHPos = 0; }
			 */
	...
	public void drawXPButton() {
		...
		if (tabInterfaceIDs[12] != -1 && anInt1054 == 9)
			if (loopCycle % 20 >= 12)
				;
		xpIcon.drawAdvancedSprite(0 + x, 47 + y);
		if (xpIconHPos == 1) {
			xpIconH.drawAdvancedSprite(0 + x, 47 + y);
		}
	}
	...
	public void addObject(int x, int y, int objectId, int face, int type,
			int height) {
		int mX = anInt1069 - 6;
		int mY = anInt1070 - 6;
		int x2 = x - (mX * 8);
	...
	private void doFlamesDrawing() {
		...
		System.arraycopy(aClass30_Sub2_Sub1_Sub1_1201.myPixels, 0,
				aRSImageProducer_1110.pixels, 0, 33920);
		...
		System.arraycopy(aClass30_Sub2_Sub1_Sub1_1202.myPixels, 0,
				aRSImageProducer_1111.pixels, 0, 33920);
	...
	public int count = 0, backgroundCount = 0, opacityCount;
	...
	public void drawLoginScreen() {
		try {
			...
			if (signlink.updatesStage == 2)
				smallText.method389(true, 280, 0xffd700,
						"Your Cache is being updated, please wait...", 136);
			else if (signlink.updatesStage == 3)
				smallText
						.method389(
								true,
								245,
								0xff0000,
								"Your Cache has been updated, please restart the client!",
								136);
			else if (signlink.updatesStage == 4)
				smallText
						.method389(
								true,
								235,
								0xff0000,
								"Cache updating has failed, your client may not work properly!",
								136);

			Sprite lbox = new Sprite(sign.signlink.findcachedir()
					+ "Sprites/background/login.png", 1);
			lbox.drawAdvancedSprite(253, 140);
			char c = '\u0168';
			char c1 = '\310';
			int i1 = c / 2;
			int l1 = c1 / 2 + 50;
			if (loginScreenState == 2) {
				if (Configuration.staffClient) {
					if (Configuration.server == "localhost")
						smallText
								.method389(
										true,
										20,
										0xFF0000,
										"Localhost Mode (Press 'Page DOWN' to toggle off)",
										465);
					else
						smallText
								.method389(
										...
										20,
										0xFF0000,
										"Beta Server Mode (Press 'Page UP' to toggle off)",
										465);
				}
				int j = c1 / 2 - 129 + 82;
				if (super.mouseX >= 276 && super.mouseX <= 493
						&& super.mouseY >= 226 && super.mouseY <= 251) {
					textBoxHover.drawAdvancedSprite(275, 200);
					setTextCursor();
				} else if (super.mouseX >= 468 && super.mouseX <= 486
						&& super.mouseY >= 282 && super.mouseY <= 295) {
					setDefaultCursor();
					if (rememberMe)
						smallText.method389(true, 515, 0xffffff,
								"Turn off account saving", 295);
					else
						smallText.method389(true, 515, 0xffffff,
								"Turn on account saving", 295);
				} else if (super.mouseX >= 276 && super.mouseX <= 492
						&& super.mouseY >= 279 && super.mouseY <= 306) {
					textBoxHover.drawAdvancedSprite(275, 246);
					setTextCursor();
				} 
				else if (isTextCursor)
					setDefaultCursor();
				smallText.method382(0xffffff, 385, loginMessage1, 361, true);
				smallText.method382(0xffffff, 385, loginMessage2, 375, true);// +14
				// username & password
				j += 39;
				...
				j += 55;
				// hovering
				Sprite sprite1 = new Sprite("Misc/SPRITEE 9");
				Sprite sprite2 = new Sprite("Misc/SPRITEE 10");
				Sprite loginhover = new Sprite(sign.signlink.findcachedir()
						+ "Sprites/background/login2.png", 1);
				Sprite sfhover = new Sprite(sign.signlink.findcachedir()
						+ "Sprites/background/sfhover.png", 1);
				Sprite syhover = new Sprite(sign.signlink.findcachedir()
						+ "Sprites/background/syhover.png", 1);
				Sprite sthover = new Sprite(sign.signlink.findcachedir()
						+ "Sprites/background/sthover.png", 1);
				
				if (!rememberMe)
					sprite1.drawAdvancedSprite(470, 282);
				else
					sprite2.drawAdvancedSprite(470, 282);
				if (super.mouseX >= 291 && super.mouseX <= 472
						&& super.mouseY >= 318 && super.mouseY <= 343)
					loginhover.drawAdvancedSprite(292, 317);
				
				if (super.mouseX >= 316 && super.mouseX <= 357
						&& super.mouseY >= 397 && super.mouseY <= 438)
					sfhover.drawAdvancedSprite(316, 398);
				
				if (super.mouseX >= 363 && super.mouseX <= 403
						&& super.mouseY >= 397 && super.mouseY <= 438)
					syhover.drawAdvancedSprite(363, 398);
				
				if (super.mouseX >= 410 && super.mouseX <= 451
						&& super.mouseY >= 397 && super.mouseY <= 438)
					sthover.drawAdvancedSprite(410, 398);
			}
			// smallText.method389(true, 283, 0xffffff, "Remember me?", 350);
			// smallText.method389(true, 323, 0xffffff, "Remember me?", 370);
	...
	private void method137(Stream stream, int j) {
				...
				if (j16 == 1) {
					...
					if (class26 != null)
						class26.aClass30_Sub2_Sub4_504 = new Animable_Sub5(
								class26.uid >> 14 & 0xffff, 0, 4, i19, l19,
								j18, k20, j17, false);
				}
				if (j16 == 2) {
					...
					if (class28 != null)
						class28.aClass30_Sub2_Sub4_521 = new Animable_Sub5(
								class28.uid >> 14 & 0xffff, k14, j12, i19, l19,
								j18, k20, j17, false);
				}
				if (j16 == 3) {
					...
					if (class49 != null)
						class49.aClass30_Sub2_Sub4_814 = new Animable_Sub5(
								class49.uid >> 14 & 0xffff, k14, 22, i19, l19,
								j18, k20, j17, false);
				}
			}
			return;
		...
		if (j == 152) {
			...
			if (tileX >= 0 && tileY >= 0 && tileX < 104 && tileY < 104)
				method130(-1, objID, obFace, l17, tileY, obType, toPlane,
						tileX, 0);
			return;
		}
		...
		if (j == 153) {
			...
			Class30_Sub1 request = (Class30_Sub1) aClass19_1179
					.reverseGetFirst();
			for (; request != null; request = (Class30_Sub1) aClass19_1179
					.reverseGetNext()) {
		...
		if (j == 117) {
			...
			int j11 = l5 + stream.get();
			int k13 = k8 + stream.get();
			int l15 = stream.getSignedShort();
			int i17 = stream.getUnsignedShort();
			int i18 = stream.getUnsigned() * 4;
			int l18 = stream.getUnsigned() * 4;
			int k19 = stream.getUnsignedShort();
			int j20 = stream.getUnsignedShort();
			int i21 = stream.getUnsigned();
			int j21 = stream.getUnsigned();
	...
	public void processLoginScreenInput() {
		if (loginScreenState == 0) {
			...
			if (loginScreenState == 2) {
				...
				j += 30;
				j += 25;
				if (super.clickMode3 == 1 && super.saveClickX >= 468
						&& super.saveClickX <= 486 && super.saveClickY >= 282
						&& super.saveClickY <= 295) {
				...
				if(super.clickMode3 == 1){
					if (super.mouseX >= 316 && super.mouseX <= 357
							&& super.mouseY >= 397 && super.mouseY <= 438)
						launchURL("https://www.zarpor.com?sn=fb");
					else if (super.mouseX >= 363 && super.mouseX <= 403
								&& super.mouseY >= 397 && super.mouseY <= 438)	
						launchURL("https://www.zarpor.com?sn=yt");
					else if (super.mouseX >= 410 && super.mouseX <= 451
								&& super.mouseY >= 397 && super.mouseY <= 438)
						launchURL("https://www.zarpor.com?sn=t");
				}

				if (super.clickMode3 == 1 && super.saveClickX >= 276
						&& super.saveClickX <= 493 && super.saveClickY >= 226
						&& super.saveClickY < 251)// box 1
					loginScreenCursorPos = 0;
				j += 15;
				if (super.clickMode3 == 1
						&& super.saveClickX >= 276 // box 2clicking
						&& super.saveClickX <= 492 && super.saveClickY >= 279
						&& super.mouseY <= 306)
					loginScreenCursorPos = 1;
				j += 15;
				...
				// Back here
				if (super.clickMode3 == 1
						&& super.saveClickX >= 291 // login button clicking
						&& super.saveClickX <= 472 && super.saveClickY >= 318
						&& super.saveClickY <= 343) {
					loginFailures = 0;
	...
	void markMinimap(Sprite sprite, int i, int j) {
		int x = isFullScreen ? 549 + extraWidth : 0;
		int markY = 6;
		int markX = 9;
		int k = minimapInt1 + minimapInt2 & 0x7ff;
		...
		try {
			if (!is474 && !isFullScreen) {
				sprite.drawSprite((((94 + k1) - sprite.maxWidth / 2) + 4) + x
						+ markX, (83 - l1 - sprite.maxHeight / 2 - 4) + markY);
			}
		} catch (Exception e) {
		}
		try {
		...
		try {
			if (is474 && !isFullScreen) {
				sprite.drawSprite(((123 + k1) - sprite.maxWidth / 2) + 4, 89
						- l1 - sprite.maxHeight / 2 - 4);
			}
		} catch (Exception e) {
		}
			...
			if (i2 != 0) {
				...
				if (j1 == 0) {
					...
					if (class46.aBoolean767)
						clippingPlanes[j].method215(l2, k2,
				...
				if (j1 == 2) {
					...
					if (i1 + class46_1.sizeX > 103 || i + class46_1.sizeX > 103
							|| i1 + class46_1.sizeY > 103
							|| i + class46_1.sizeY > 103)
						return;
					if (class46_1.aBoolean767)
						clippingPlanes[j].method216(l2, class46_1.sizeX, i1, i,
								class46_1.sizeY, class46_1.aBoolean757);
				}
				if (j1 == 3) {
	...
	public static void sendFrame171(int mainFrame, int subFrame) {
		try {
			RSInterface.interfaceCache[subFrame].isMouseoverTriggered = (mainFrame == 1);
		} catch (Exception e) {
		}
	}

	public static void sendSkillInterface(int id[]) {
		try {
			needDrawTabArea = true;
			int i7 = 8847;
			...
			for (int j22 = 0; j22 < j19; j22++) {
				int i25 = 1;
				class9_1.inv[j22] = id[j22] + 1;
				class9_1.invStackSizes[j22] = -1;
			}
	...
	public void sendPacket185(int button, int toggle, int type) {
		...
		case 6970:
			String a = ":::CLOSE:";
			stream.createFrame(103);
			stream.writeWordBigEndian(a.length() - 1);
			stream.writeString(a.substring(2));
			break;
		case 6969:
			String l = ":::ZOOM:" + RSInterface.interfaceCache[18416].message;
			stream.createFrame(103);
			stream.writeWordBigEndian(l.length() - 1);
			stream.writeString(l.substring(2));
			break;
		...
		try {
			...
			if (pktSize == -2)
				if (i > 1) {
					...
					inStream.currentOffset = 0;
					pktSize = inStream.getUnsignedShort();
					i -= 2;
				} else {
					return false;
				}
			...
			case 176:
				...
				membersInt = inStream.getUnsigned();
				anInt1193 = inStream.method440();
				daysSinceLastLogin = inStream.getUnsignedShort();
			...
			case 185:
				...
				if (myPlayer.desc() == null)
					...
					RSInterface.interfaceCache[k].mediaID = (int) (0x12345678L + myPlayer
							.desc().type);
				pktType = -1;
				return true;
				...
				/* Clan chat packet */
				/*
				 * case 217: try { name = inStream.readString(); message =
				 * inStream.readString(); clanname = inStream.readString();
				 * rights = inStream.getUnsignedShort(); for (int i6 = 0; i6 <
				 * 100; i6++) { sendFrame126("", i6 + 18144); clanList[i6] = "";
				 * } // message = TextInput.processText(message); // message =
				 * Censor.doCensor(message); System.out.println(clanname);
				 * pushMessage(message, 16, name); } catch (Exception e) {
				 * e.printStackTrace(); } pktType = -1; return true;
				 */
			...
			case 217:
				try {
					...
					rights = inStream.getUnsignedShort();
			...
			case 166:
				aBoolean1160 = true;
				anInt1098 = inStream.getUnsigned();
				anInt1099 = inStream.getUnsigned();
				anInt1100 = inStream.getUnsignedShort();
				anInt1101 = inStream.getUnsigned();
				anInt1102 = inStream.getUnsigned();
				if (anInt1102 >= 100) {
			...
			case 134:
				...
				int k1 = inStream.getUnsigned();
				int i10 = inStream.method439();
				int l15 = inStream.getUnsigned();
			...
			case 71:
				int l1 = inStream.getUnsignedShort();
			...
			case 241:
				...
				if (pktType == 241) {
					...
					for (int j16 = 0; j16 < 4; j16++) {
						for (int l20 = 0; l20 < 13; l20++) {
							for (int j23 = 0; j23 < 13; j23++) {
								...
								if (i26 == 1)
									constructRegionData[j16][l20][j23] = inStream
											.readBits(26);
								else
					...
					l2 = inStream.getUnsignedShort();
					aBoolean1159 = true;
				}
				if (pktType != 241 && anInt1069 == l2 && anInt1070 == i11
						&& loadingStage == 2) {
					pktType = -1;
					return true;
				}
				...
				if (pktType == 241) {
					...
					for (int l26 = 0; l26 < l16; l26++) {
						...
						int i33 = anIntArray1236[l26] = onDemandFetcher
								.method562(1, l31, l30);
						if (i33 != -1)
							onDemandFetcher.loadMandatory(3, i33);
					}
				}
			...
			case 99:
				anInt1021 = inStream.getUnsigned();
				pktType = -1;
				return true;
			...
			case 60:
				anInt1269 = inStream.getUnsigned();
				anInt1268 = inStream.method427();
				while (inStream.currentOffset < pktSize) {
					int k3 = inStream.getUnsigned();
			...
			case 35:
				int l3 = inStream.getUnsigned();
				int k11 = inStream.getUnsigned();
				int j17 = inStream.getUnsigned();
				int k21 = inStream.getUnsigned();
			...
			case 175:
				...
				retardLevel = inStream.getUnsigned();// bytes 0-255, short
				// 0-65523 or
				// something
			...
			case 174:
				int i4 = inStream.getUnsignedShort();
				int l11 = inStream.getUnsigned();
				int k17 = inStream.getUnsignedShort();
				 ...
				 * followNPC = 0;
				 * 
				 * int l11z = inStream.getUnsignedShort();
				 * 
				 * int iq = inStream.getUnsigned();
				 * 
				 * followDistance = inStream.getUnsignedShort();
				 * 
				 * if (iq == 0)
				 * 
				 * {
			...
			case 253:
				...
				} else if (s.endsWith(":updateautocast:")) {
					Autocast = true;
					autocastId = Integer
							.parseInt(RSInterface.interfaceCache[18417].message);
			...
			case 50:
				...
				long disp = l4;// inStream.readQWord(); enable for old names
								// showing friends lsit packet
				int i18 = inStream.getUnsigned();
				String s7 = TextClass.fixName(TextClass.nameForLong(l4));
				String display = TextClass.fixName(TextClass.nameForLong(disp));
			...
			case 110:
				if (tabID == 12)
					needDrawTabArea = true;
				energy = inStream.getUnsigned();
				pktType = -1;
				return true;

			case 254:
				anInt855 = inStream.getUnsigned();
				if (anInt855 == 1)
					anInt1222 = inStream.getUnsignedShort();
				if (anInt855 >= 2 && anInt855 <= 6) {
					...
					anInt855 = 2;
					anInt934 = inStream.getUnsignedShort();
					anInt935 = inStream.getUnsignedShort();
					anInt936 = inStream.getUnsigned();
				}
				if (anInt855 == 10)
					anInt933 = inStream.getUnsignedShort();
				pktType = -1;
				return true;

			case 248:
				int i5 = inStream.method435();
				int k12 = inStream.getUnsignedShort();
				if (backDialogID != -1) {
					backDialogID = -1;
					inputTaken = true;
				}
			...
			case 246:
				...
				int i13 = inStream.getUnsignedShort();
				int k18 = inStream.getUnsignedShort();
				if (k18 == 65535) {
			...
			case 171:
				boolean flag1 = inStream.getUnsigned() == 1;
				int j13 = inStream.getUnsignedShort();
			...
			case 126:
				...
				try {
					...
					if (text.startsWith("[TELEMENU]")) {
						TextDrawingArea aTextDrawingArea_1273 = new TextDrawingArea(
								true, "q8_full", titleStreamLoader);
						TextDrawingArea aclass30_sub2_sub1_sub4s[] = {
								smallText, aTextDrawingArea_1271,
								chatTextDrawingArea, aTextDrawingArea_1273 };
						RSInterface.actionTab(aclass30_sub2_sub1_sub4s, frame);
						pktType = -1;
						return true;
					}
					if (text.startsWith("[RESETGESEARCH]")) {
						searchOver();
						pktType = -1;
						return true;
					}
					if (text.startsWith("[SKILLGUIDE]")) {
						SkillGuides.skillGuidesButton(frame);
						pktType = -1;
						return true;
					}
					if (text.startsWith("[CLEARPLAYERS]")) {
						clearPlayersInterface();
						pktType = -1;
						return true;
					}
					if (text.startsWith("[RESETIGNORE]")) {
						for (int x = 0; x < 100; x++) {
							ignoreListAsLongs[x] = 0;
							sendFrame126("", 12500 + x);
						}
						ignoreCount = 0;
						pktType = -1;
						return true;
					}
					if (text.startsWith("[LOADREGION]")) {
						buildingMode = (frame == 1);
						loadRegion();
						pktType = -1;
						return true;
					}
					if (text.startsWith("[CLEAR]")) {
						RSInterface.interfaceCache[18139].message = "Talking in: ";
						RSInterface.interfaceCache[18140].message = "Owner: ";
						for (int j = 18144; j < 18244; j++) {
							RSInterface.interfaceCache[j + 20000].disabledSprite = RSInterface.interfaceCache[j + 20000].savedSprite[0];
							updateStrings("", j);
							sendFrame126("", j);
						}
						pktType = -1;
					...
					if (text.startsWith("[REG]")) {
						...
						RSInterface.interfaceCache[frame + 20000].disabledSprite = RSInterface.interfaceCache[frame + 20000].savedSprite[0];
					...
					if (text.startsWith("[OWN]")) {
						text = text.substring(4);
						RSInterface.interfaceCache[frame + 20000].disabledSprite = RSInterface.interfaceCache[frame + 20000].savedSprite[1];
						updateStrings(text, frame);
						sendFrame126(text, frame);
						pktType = -1;
						return true;
					...
					if (text.startsWith("[MOD]")) {
						text = text.substring(4);
						RSInterface.interfaceCache[frame + 20000].disabledSprite = RSInterface.interfaceCache[frame + 20000].savedSprite[2];
						updateStrings(text, frame);
						sendFrame126(text, frame);
						pktType = -1;
						return true;
					...
					if (text.startsWith("[REC]")) {
						text = text.substring(4);
						RSInterface.interfaceCache[frame + 20000].disabledSprite = RSInterface.interfaceCache[frame + 20000].savedSprite[3];
						updateStrings(text, frame);
						sendFrame126(text, frame);
						pktType = -1;
						return true;
					...
					if (text.startsWith("[COR]")) {
						text = text.substring(4);
						RSInterface.interfaceCache[frame + 20000].disabledSprite = RSInterface.interfaceCache[frame + 20000].savedSprite[4];
						updateStrings(text, frame);
						sendFrame126(text, frame);
						pktType = -1;
						return true;
					...
					if (text.startsWith("[SER]")) {
						text = text.substring(4);
						RSInterface.interfaceCache[frame + 20000].disabledSprite = RSInterface.interfaceCache[frame + 20000].savedSprite[5];
						updateStrings(text, frame);
						sendFrame126(text, frame);
						pktType = -1;
						return true;
					...
					if (text.startsWith("[LIE]")) {
						text = text.substring(4);
						RSInterface.interfaceCache[frame + 20000].disabledSprite = RSInterface.interfaceCache[frame + 20000].savedSprite[6];
						updateStrings(text, frame);
						sendFrame126(text, frame);
						pktType = -1;
						return true;
					...
					if (text.startsWith("[BER]")) {
						text = text.substring(4);
						RSInterface.interfaceCache[frame + 20000].disabledSprite = RSInterface.interfaceCache[frame + 20000].savedSprite[7];
						updateStrings(text, frame);
						sendFrame126(text, frame);
						pktType = -1;
						return true;
					...
					if (text.startsWith("[VR]")) {
						...
						RSInterface.interfaceCache[frame + 20000].disabledSprite = RSInterface.interfaceCache[frame + 20000].savedSprite[8];
						updateStrings(text, frame);
						sendFrame126(text, frame);
						pktType = -1;
						return true;
					...
					if (text.startsWith("[FRI]")) {
						text = text.substring(4);
						RSInterface.interfaceCache[frame + 20000].disabledSprite = RSInterface.interfaceCache[frame + 20000].savedSprite[9];
						updateStrings(text, frame);
						sendFrame126(text, frame);
						pktType = -1;
						return true;
				...
				return true;
			case 206:
				publicChatMode = inStream.getUnsigned();
				privateChatMode = inStream.getUnsigned();
				tradeMode = inStream.getUnsigned();
				aBoolean1233 = true;
				inputTaken = true;
				pktType = -1;
				return true;
			...
			case 8:
				...
				int l13 = inStream.getUnsignedShort();
			...
			case 53:
				try {
					needDrawTabArea = true;
					int i7 = inStream.getUnsignedShort();
					RSInterface class9_1 = RSInterface.interfaceCache[i7];
					int j19 = inStream.getUnsignedShort();
					for (int j22 = 0; j22 < j19; j22++) {
						int i25 = inStream.getUnsigned();
						if (i25 == 255)
			...
			case 230:
				...
				int j14 = inStream.getUnsignedShort();
				int k19 = inStream.getUnsignedShort();
			...
			case 177:
				aBoolean1160 = true;
				anInt995 = inStream.getUnsigned();
				anInt996 = inStream.getUnsigned();
				anInt997 = inStream.getUnsignedShort();
				anInt998 = inStream.getUnsigned();
				anInt999 = inStream.getUnsigned();
				if (anInt999 >= 100) {
			...
			case 97:
				int l7 = inStream.getUnsignedShort();
				method60(l7);
				if (invOverlayInterfaceID != -1) {
					invOverlayInterfaceID = -1;
					needDrawTabArea = true;
				...
				if (l7 == 450) {
					...
					super.drawSmallLoad(10, "Please be patient...");
				} else
					openInterfaceID = l7;
			...
			case 61:
				anInt1055 = inStream.getUnsigned();
				pktType = -1;
				return true;

			case 200:
				int l8 = inStream.getUnsignedShort();
			...
			case 34:
				needDrawTabArea = true;
				int i9 = inStream.getUnsignedShort();
				RSInterface class9_2 = RSInterface.interfaceCache[i9];
				while (inStream.currentOffset < pktSize) {
					int j20 = inStream.getUnsignedSmart();
					int i23 = inStream.getUnsignedShort();
					int l25 = inStream.getUnsigned();
					if (l25 == 255)
						l25 = inStream.getInt();
	...
	private void method146() {
		...
		if (!aBoolean1160) {
			...
			setCameraPos(
					Integer.parseInt(RSInterface.interfaceCache[18416].message)
							+ i * 3, i, anInt1014,
		...
		if (drawXpBar) {
			...
			int drawX = 472; // 507
			sprite1.drawAdvancedSprite(419 + x, 51 + y);
	...
	public Client() {
		...
		anInt1211 = 78;
		promptInput = "";
		chatIcons = new Sprite[25];
		tabID = 3;
		inputTaken = false;
		songChanging = true;
		anIntArray1229 = new int[151];
		clippingPlanes = new TileSettings[4];
		clippingPlanesBackup = new TileSettings[4];
		aBoolean1233 = false;
	...
	private Sprite loadingBarFrame;
	private Sprite quickChatIcon;
	public String name;
	...
	public int viewYell = 0;
	public int duelMode;

	/* Declare custom sprites */
	public Sprite chatArea;
	private Sprite chatareaFull;
	private Sprite transparentChatArea;
	private Sprite loadingPleaseWait;
	private Sprite inputBack;
	...
	public Sprite[] scrollBarSprites;
	...
	public static RSInterface GErsi;
	public int baseX;
	public int baseY;
	...
	public static String[] friendsList2 = new String[500];
	...
	private GraphicsBuffer aRSImageProducer_1163;
	private GraphicsBuffer mapEdgeIP;
	private GraphicsBuffer aRSImageProducer_1164;
	private GraphicsBuffer aRSImageProducer_1165;
	...
	private final Sprite[] chatIcons;
	...
	private TileSettings[] clippingPlanes;
	private TileSettings[] clippingPlanesBackup;
	...
	private static int backDialogID;
