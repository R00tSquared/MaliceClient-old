...
public class ItemDef_2 extends ItemDef {
  ...
  if(i == 14365) {
		...
		itemDef.modelRotation2 = 264;
		itemDef.modelRotation1 = 1913;
		itemDef.modelOffset2 = 7;
		itemDef.modelOffset1 = 58;
		itemDef.groundActions = new String[] { null, null, "Take", null, null };
		itemDef.actions = new String[] { null, "Wield", null, null, "Drop" };
		itemDef.modelID = 70128;
		itemDef.maleEquip1 = 70672;
		itemDef.femaleEquip1 = 70672;
  }
  if(i == 12494) {
  ...
  if(i == 12482) {
	...
	if (i == 15243) {
	  ...
	  itemDef.modelRotation1 = 64;
	  itemDef.modelOffset1 = 0;
	  itemDef.modelOffset2 = 0;
	  itemDef.stackable = true;
	  itemDef.name = "Hand Cannon Shot";
	  itemDef.description = "The bag contains shot and powder for the hand cannon.";
	}
