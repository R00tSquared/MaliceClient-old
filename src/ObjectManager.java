...
final class ObjectManager {
   ...
   /*public final void method171(Class11 aclass11[], WorldController worldController) {
								...
								if (l18 > 0 || i19 > 0) {
									...
									if (i19 == 0) {
										...
										if (i23 >= 0) {
											...
											j23 = -1;
										} else if (overlay.anInt390 == 0xff00ff) {//pink
											k23 = 0;
											j23 = -2;
											i23 = -1;
										} else if(overlay.anInt390 == 0x333333) {//green
											k23 = Texture.anIntArray1482[method185(overlay.anInt399, 96)];                                
											j23 = -2;
											i23 = -1;
										} else {
											j23 = method177(overlay.anInt394, overlay.anInt395, overlay.anInt396);
											k23 = Texture.anIntArray1482[method185(overlay.anInt399, 96)];
										}
										if(floorId == 111) {											//Water
											...
											j23 = -1;
											i23 = 1;
										} else if(floorId == 54) {										//Grand exchange
											k23 = overlay.anInt390;
											j23 = -2;
											i23 = -1;
										} else if(floorId == 53) {										//Blue at duel arena
											k23 = overlay.anInt390 = 0xAA9166;
											//j23 = -2;
											i23 = -1;
										} else if(floorId == 52) {										//Green in duel arena
											k23 = overlay.anInt390 = 0x736836;
											//j23 = -2;
											i23 = -1;
	...
	public final void method171(TileSettings aclass11[],
		...
		if (anInt133 > 16)
			anInt133 = 16;
		for (int x = 0; x < 4; x++) {
			byte abyte0[][] = aByteArrayArrayArray134[x];
			byte byte0 = 96;
			char c = '\u0300';
			byte byte1 = -50;
			byte byte2 = -10;
		...
		for (int j4 = 1; j4 < anInt147 - 1; j4++) {
			for (int j5 = 1; j5 < anInt146 - 1; j5++) {
				int k6 = heightMap[x][j5 + 1][j4]
				                                            - heightMap[x][j5 - 1][j4];
				int l7 = heightMap[x][j5][j4 + 1]
				                                        - heightMap[x][j5][j4 - 1];
		...
		for (int y = -5; y < anInt146 + 5; y++) {
			for (int i8 = 0; i8 < anInt147; i8++) {
				int k9 = y + 5;
				if (k9 >= 0 && k9 < anInt146) {
					int l12 = underLay[x][k9][i8] & 0xff;
					if (l12 > 0) {
				...
				int i13 = y - 5;
				if (i13 >= 0 && i13 < anInt146) {
					int i14 = underLay[x][i13][i8] & 0xff;
					if (i14 > 0) {
			...
			if (y >= 1 && y < anInt146 - 1) {
				...
				for (int z = -5; z < anInt147 + 5; z++) {
					...
					if (z >= 1
							&& z < anInt147 - 1
							&& (!lowMem
									|| (tileSettings[0][y][z] & 2) != 0 || (tileSettings[x][y][z] & 0x10) == 0
									&& method182(z, x, y) == anInt131)) {//HANDLES FLOORS FOR SECOND LAYER
						if (x < anInt145)
							anInt145 = x;
						int l18 = underLay[x][y][z] & 0xff;
						int i19 = overLay[x][y][z] & 0xff;
						if (l18 > 0 || i19 > 0) {
							int j19 = heightMap[x][y][z];
							int k19 = heightMap[x][y + 1][z];
							int l19 = heightMap[x][y + 1][z + 1];
							int i20 = heightMap[x][y][z + 1];
							int j20 = anIntArrayArray139[y][z];
							int k20 = anIntArrayArray139[y + 1][z];
							int l20 = anIntArrayArray139[y + 1][z + 1];
							int i21 = anIntArrayArray139[y][z + 1];
							int j21 = -1;
							int k21 = -1;
							if (l18 > 0) {
								if(k15 == 0)
							...
							if (x > 0) {
								boolean flag = true;
								if (l18 == 0
										&& overlayClippingPaths[x][y][z] != 0)
									flag = false;
								if (i19 > 0)//&& !Floor.overLays[i19 - 1].aBoolean393//BROKE THE SHIT HARDDDDDD
									flag = false;
								if (flag && j19 == k19 && j19 == l19
										&& j19 == i20)
									anIntArrayArrayArray135[x][y][z] |= 0x924;
							}
							int i22 = 0;
							if (j21 != -1)
								i22 = Rasterizer.hsl2rgb[method187(k21,
										96)];
							if (i19 == 0) {
								worldController.method279(x, y, z, 0, 0,
								...
								int k22 = overlayClippingPaths[x][y][z] + 1;
								byte byte4 = overlayClippingPathRotations[x][y][z];
								if (i19 - 1 >= Floor.overLays.length)
									i19 = 1;

								Floor floorOverlay = Floor.overLays[i19 - 1];// idk :o
								int overlayTexture = floorOverlay.anInt3640;
								int overlayHSL;
								int overlayRGB;
								int overlayColor = 0;
								if (floorOverlay.anInt3629 != -1)
									overlayColor = (Rasterizer.hsl2rgb[floorOverlay.anInt3629] != 1) ? Rasterizer.hsl2rgb[floorOverlay.anInt3629]
											: 0;
								//i23 = (int) (Math.random() * (double) Texture.getTotal());
								int color = -1;
								//if(overlayTexture >= 50) 
								//	overlayTexture = -1;
								//System.out.println("int3631:"+floorOverlay.anInt3631);
								//System.out.println("overlaytexture:"+overlayTexture);
								if (overlayTexture >= 0)
								{
									overlayHSL = -1;
									if (floorOverlay.anInt3631 != 0xff00ff)
									{
										...
										overlayRGB = Rasterizer.hsl2rgb[overlayHSL];
										color = method185(floorOverlay.anInt3631, 96);
									}
									else
									{
										overlayRGB = 0;
								...
								else
								{
									color = method185(floorOverlay.anInt3631, 96);
									overlayHSL = floorOverlay.anInt3631;
									overlayRGB = Rasterizer.hsl2rgb[color];
								}
								//System.out.println("Overlay: (HSL: "+ j23+"), (Texture: "+i23 +"), (RGB: " +k23 + "), Floor: "+floorId);
								worldController.method279(x, y, z, k22, byte4, overlayTexture, j19, k19, l19, i20, 
								
								method187(j21, j20), method187(j21, k20),
								method187(j21, l20),method187(j21, i21),
								
								method185(overlayHSL,j20), method185(overlayHSL, k20),
								method185(overlayHSL, l20), method185(overlayHSL,i21),

								i22, overlayRGB, color);
							}
						}
					}
				}
		...
		for (int j8 = 1; j8 < anInt147 - 1; j8++) {
			for (int i10 = 1; i10 < anInt146 - 1; i10++)
				worldController
				.method278(x, i10, j8, method182(j8, x, i10));
	...
	public void method175(int i, WorldController worldController,
			TileSettings class11, int j, int k, int l, int i1, int j1) { //RenderObject // some type of add object method
		...
		if (j == 22) {
			...
			if (class46.anInt781 == -1 && class46.childrenIDs == null)
				obj = class46.method578(22, j1, k1, l1, i2, j2, -1, null);
			else
		...
		if (j == 10 || j == 11) {
			Object obj1;
			if (class46.anInt781 == -1 && class46.childrenIDs == null)
				obj1 = class46.method578(10, j1, k1, l1, i2, j2, -1, null);
			else
			...
			if (obj1 != null) {
				...
				if (worldController.method284(l2, byte0, k2, l4,
					...
					if (obj1 instanceof Model)
						...
						model = class46.method578(10, j1, k1, l1, i2, j2, -1, null);
					if (model != null) {
			...
			if (class46.aBoolean767 && class11 != null)
				class11.method212(class46.aBoolean757, class46.sizeX,
						class46.sizeY, l, i, j1);
			return;
		}
		if (j >= 12) {
			Object obj2;
			if (class46.anInt781 == -1 && class46.childrenIDs == null)
				obj2 = class46.method578(j, j1, k1, l1, i2, j2, -1, null);
			else
		...
		if (j == 0) {
			Object obj3;
			if (class46.anInt781 == -1 && class46.childrenIDs == null)
				obj3 = class46.method578(0, j1, k1, l1, i2, j2, -1, null);
			else
		...
		if (j == 1) {
			Object obj4;
			if (class46.anInt781 == -1 && class46.childrenIDs == null)
				obj4 = class46.method578(1, j1, k1, l1, i2, j2, -1, null);
			else
		...
		if (j == 2) {
			...
			Object obj12;
			if (class46.anInt781 == -1 && class46.childrenIDs == null) {
				obj11 = class46.method578(2, 4 + j1, k1, l1, i2, j2, -1, null);
				obj12 = class46.method578(2, i3, k1, l1, i2, j2, -1, null);
			} else {
		...
		if (j == 3) {
			Object obj5;
			if (class46.anInt781 == -1 && class46.childrenIDs == null)
				obj5 = class46.method578(3, j1, k1, l1, i2, j2, -1, null);
			else
		...
		if (j == 9) {
			Object obj6;
			if (class46.anInt781 == -1 && class46.childrenIDs == null)
				obj6 = class46.method578(j, j1, k1, l1, i2, j2, -1, null);
			else
		...
		if (j == 4) {
			Object obj7;
			if (class46.anInt781 == -1 && class46.childrenIDs == null)
				obj7 = class46.method578(4, 0, k1, l1, i2, j2, -1, null);
			else
		...
		if (j == 5) {
			...
			Object obj13;
			if (class46.anInt781 == -1 && class46.childrenIDs == null)
				obj13 = class46.method578(4, 0, k1, l1, i2, j2, -1, null);
			else
		...
		if (j == 6) {
			Object obj8;
			if (class46.anInt781 == -1 && class46.childrenIDs == null)
				obj8 = class46.method578(4, 0, k1, l1, i2, j2, -1, null);
			else
		...
		if (j == 7) {
			Object obj9;
			if (class46.anInt781 == -1 && class46.childrenIDs == null)
				obj9 = class46.method578(4, 0, k1, l1, i2, j2, -1, null);
			else
		...
		if (j == 8) {
			Object obj10;
			if (class46.anInt781 == -1 && class46.childrenIDs == null)
				obj10 = class46.method578(4, 0, k1, l1, i2, j2, -1, null);
			else
	...
	public final void loadMapChunk(int i, int j, TileSettings aclass11[], int l,
			...
			for (int i3 = 0; i3 < 64; i3++) {
				for (int j3 = 0; j3 < 64; j3++)
					if (l2 == i && i3 >= i1 && i3 < i1 + 8 && j3 >= j1
							&& j3 < j1 + 8)
						method181(l1 + MapUtility.method156(j3 & 7, j, i3 & 7), 0,
								stream,
								l + MapUtility.method155(j, j3 & 7, i3 & 7), k1, j,
								0);
					else
	...
	public void method181(int tileY, int j, Stream stream, int tileX, int tilePlane, int rotation,
			int k1) {
		try {
		if (tileX >= 0 && tileX < 104 && tileY >= 0 && tileY < 104) {
			tileSettings[tilePlane][tileX][tileY] = 0;
			do {
				int tileType = stream.getUnsigned();
				if (tileType == 0)
					if (tilePlane == 0) {
						heightMap[0][tileX][tileY] = -method172(0xe3b7b
								+ tileX + k1, 0x87cce + tileY + j) * 8;
						return;
					} else {
				...
				if (tileType == 1) {
					...
					if (tilePlane == 0) {
						...
						heightMap[tilePlane][tileX][tileY] = heightMap[tilePlane - 1][tileX][tileY]
						                                                                     - j2 * 8;
						return;
					}
				}
				if (tileType <= 49) {
					overLay[tilePlane][tileX][tileY] = stream.get();
	...
	public final void readObjectMap(TileSettings clippingPlanes[],
			WorldController worldController, int myPLane, int baseXTile, int baseYTileShifted, int reqPlane,
			byte mapData[], int baseXTileShifted, int rotation, int baseYTile) {
		label0: {
		...
		do {
			...
			int j2 = 0;
			do {
				int k2 = stream.getUnsignedSmart();
				if (k2 == 0)
					break;
				j2 += k2 - 1;
				int objectTileY = j2 & 0x3f;
				int objectTileX = j2 >> 6 & 0x3f;
				int j3 = j2 >> 12;
		int k3 = stream.getUnsigned();
		int type = k3 >> 2;
		int objectRotation = k3 & 3;
		if (j3 == myPLane && objectTileX >= baseXTileShifted && objectTileX < baseXTileShifted + 8 && objectTileY >= baseYTileShifted
				&& objectTileY < baseYTileShifted + 8) {
			...
			if (finalXTile > 0 && finalYTile > 0 && finalXTile < 103 && finalYTile < 103) {
				...
				if ((tileSettings[1][finalXTile][finalYTile] & 2) == 2)
					l4--;
				TileSettings class11 = null;
				if (l4 >= 0)
					class11 = clippingPlanes[l4];
				method175(finalYTile, worldController, class11, type, reqPlane, finalXTile,
	...
	public static void method188(WorldController worldController, int i, int j,
			int k, int l, TileSettings class11, int ai[][][], int i1, int j1, int k1) {
		int l1 = ai[l][i1][j];
		int i2 = ai[l][i1 + 1][j];
		...
		if (k == 22) {
			Object obj;
			if (class46.anInt781 == -1 && class46.childrenIDs == null)
				obj = class46.method578(22, i, l1, i2, j2, k2, -1, null);
			else
		...
		if (k == 10 || k == 11) {
			Object obj1;
			if (class46.anInt781 == -1 && class46.childrenIDs == null)
				obj1 = class46.method578(10, i, l1, i2, j2, k2, -1, null);
			else
			...
			if (class46.aBoolean767)
				class11.method212(class46.aBoolean757, class46.sizeX,
						class46.sizeY, i1, j, i);
			return;
		}
		if (k >= 12) {
			Object obj2;
			if (class46.anInt781 == -1 && class46.childrenIDs == null)
				obj2 = class46.method578(k, i, l1, i2, j2, k2, -1, null);
			else
		...
		if (k == 0) {
			Object obj3;
			if (class46.anInt781 == -1 && class46.childrenIDs == null)
				obj3 = class46.method578(0, i, l1, i2, j2, k2, -1, null);
			else
		...
		if (k == 1) {
			Object obj4;
			if (class46.anInt781 == -1 && class46.childrenIDs == null)
				obj4 = class46.method578(1, i, l1, i2, j2, k2, -1, null);
			else
		...
		if (k == 2) {
			...
			Object obj12;
			if (class46.anInt781 == -1 && class46.childrenIDs == null) {
				obj11 = class46.method578(2, 4 + i, l1, i2, j2, k2, -1, null);
				obj12 = class46.method578(2, j3, l1, i2, j2, k2, -1, null);
			} else {
		...
		if (k == 3) {
			Object obj5;
			if (class46.anInt781 == -1 && class46.childrenIDs == null)
				obj5 = class46.method578(3, i, l1, i2, j2, k2, -1, null);
			else
		...
		if (k == 9) {
			Object obj6;
			if (class46.anInt781 == -1 && class46.childrenIDs == null)
				obj6 = class46.method578(k, i, l1, i2, j2, k2, -1, null);
			else
		...
		if (k == 4) {
			Object obj7;
			if (class46.anInt781 == -1 && class46.childrenIDs == null)
				obj7 = class46.method578(4, 0, l1, i2, j2, k2, -1, null);
			else
		...
		if (k == 5) {
			...
			Object obj13;
			if (class46.anInt781 == -1 && class46.childrenIDs == null)
				obj13 = class46.method578(4, 0, l1, i2, j2, k2, -1, null);
			else
		...
		if (k == 6) {
			Object obj8;
			if (class46.anInt781 == -1 && class46.childrenIDs == null)
				obj8 = class46.method578(4, 0, l1, i2, j2, k2, -1, null);
			else
		...
		if (k == 7) {
			Object obj9;
			if (class46.anInt781 == -1 && class46.childrenIDs == null)
				obj9 = class46.method578(4, 0, l1, i2, j2, k2, -1, null);
			else
		...
		if (k == 8) {
			Object obj10;
			if (class46.anInt781 == -1 && class46.childrenIDs == null)
				obj10 = class46.method578(4, 0, l1, i2, j2, k2, -1, null);
			else
	...
	// with JODE
	{
		try {
			...
			int i_252_ = -1;
			for (;;) {
				int i_253_ = stream.getUnsignedSmart();
				if (i_253_ == 0)
					break;
				i_252_ += i_253_;
				int i_254_ = 0;
				...
				for (;;) {
					if (bool_255_) {
						int i_256_ = stream.getUnsignedSmart();
						if (i_256_ == 0)
							break;
						stream.getUnsigned();
					} else {
						int i_257_ = stream.getUnsignedSmart();
						if (i_257_ == 0)
							break;
						i_254_ += i_257_ - 1;
						int i_258_ = i_254_ & 0x3f;
						int i_259_ = i_254_ >> 6 & 0x3f;
			int i_260_ = stream.getUnsigned() >> 2;
			int i_261_ = i_259_ + i;
	...
	public final void method190(int i, TileSettings aclass11[], int j,
		...
		int l = -1;
		do {
			int i1 = stream.getUnsignedSmart();
			if (i1 == 0)
				break label0;
			l += i1;
			int j1 = 0;
			do {
				int k1 = stream.getUnsignedSmart();
				if (k1 == 0)
					break;
				j1 += k1 - 1;
				int l1 = j1 & 0x3f;
	...
	public final byte[][][] tileSettings;
